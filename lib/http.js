...
export const FIELD_TYPES = ['text', 'email', 'password', 'tel', 'number', 'url', 'textarea'];
export const FIELD_MAXLEN = { url: 300, email: 120, tel: 20, number: 60, textarea: 2000, text: 100, password: 100 };
