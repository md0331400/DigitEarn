 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function pi(n){var e;const t=n.auth,r=await n.getIdToken(),i=await nr(n,Ul(t,{idToken:r}));x(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const a=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?$l(s.providerUserInfo):[],l=bp(n.providerData,a),h=n.isAnonymous,d=!(n.email&&s.passwordHash)&&!(l!=null&&l.length),f=h?d:!1,y={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:l,metadata:new Ms(s.createdAt,s.lastLoginAt),isAnonymous:f};Object.assign(n,y)}async function Ap(n){const e=ue(n);await pi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function bp(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function $l(n){return n.map(e=>{var{providerId:t}=e,r=oo(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zr(n,e,t){return`firebase:${n}:${e}:${t}`}class sn{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=Zr(this.userKey,i.apiKey,s),this.fullPersistenceKey=Zr("persistence",i.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?Je._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new sn(Ye(yc),e,r);const i=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let s=i[0]||Ye(yc);const a=Zr(r,e.config.apiKey,e.name);let l=null;for(const d of t)try{const f=await d._get(a);if(f){const y=Je._fromJSON(e,f);d!==s&&(l=y),s=d;break}}catch{}const h=i.filter(d=>d._shouldAllowMigration);return!s._shouldAllowMigration||!h.length?new sn(s,e,r):(s=h[0],l&&await s._set(a,l.toJSON()),await Promise.all(t.map(async d=>{if(d!==s)try{await d._remove(a)}catch{}})),new sn(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kp{constructor(e){this.auth=e,this.queue=[]}pushCallback(e,t){const r=s=>new Promise((a,l)=>{try{const h=e(s);a(h)}catch(h){l(h)}});r.onAbort=t,this.queue.push(r);const i=this.queue.length-1;return()=>{this.queue[i]=()=>Promise.resolve()}}async runMiddleware(e){if(this.auth.currentUser===e)return;const t=[];try{for(const r of this.queue)await r(e),r.onAbort&&t.push(r.onAbort)}catch(r){t.reverse();for(const i of t)try{i()}catch{}throw this.auth._errorFactory.create("login-blocked",{originalMessage:r==null?void 0:r.message})}}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jp(n,e){const t=so(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(hi(s,e!=null?e:{}))return i;Me(i,"already-initialized")}return t.initialize({options:e})}function qp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Ye);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Hp(n,e,t){const r=yn(n);x(r._canInitEmulator,r,"emulator-config-failed"),x(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=Xl(e),{host:a,port:l}=Wp(e),h=l===null?"":`:${l}`;r.config.emulator={url:`${s}//${a}${h}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:l,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),zp()}function Xl(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Wp(n){const e=Xl(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:Ic(r.substr(s.length+1))}}else{const[s,a]=r.split(":");return{host:s,port:Ic(a)}}}function Ic(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function zp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console!="undefined"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window!="undefined"&&typeof document!="undefined"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xp(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Zp(n){const e=Hn(Wn(n)).link,t=e?Hn(Wn(e)).deep_link_id:null,r=Hn(Wn(n)).deep_link_id;return(r?Hn(Wn(r)).link:null)||r||t||e||n}class fo{constructor(e){var t,r,i,s,a,l;const h=Hn(Wn(e)),d=(t=h.apiKey)!==null&&t!==void 0?t:null,f=(r=h.oobCode)!==null&&r!==void 0?r:null,y=Xp((i=h.mode)!==null&&i!==void 0?i:null);x(d&&f&&y,"argument-error"),this.apiKey=d,this.operation=y,this.code=f,this.continueUrl=(s=h.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(a=h.languageCode)!==null&&a!==void 0?a:null,this.tenantId=(l=h.tenantId)!==null&&l!==void 0?l:null}static parseLink(e){const t=Zp(e);try{return new fo(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class hu{constructor(e,t,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:i,tenantId:s,error:a,type:l}=e;if(a){this.reject(a);return}const h={auth:this.auth,requestUri:t,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(l)(h))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Am;case"linkViaPopup":case"linkViaRedirect":return Rm;case"reauthViaPopup":case"reauthViaRedirect":return bm;default:Me(this.auth,"internal-error")}}resolve(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Lt,fu;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(E,m){function _(){}_.prototype=m.prototype,E.D=m.prototype,E.prototype=new _,E.prototype.constructor=E,E.C=function(v,w,A){for(var g=Array(arguments.length-2),We=2;We<arguments.length;We++)g[We-2]=arguments[We];return m.prototype[w].apply(v,g)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(E,m,_){_||(_=0);var v=Array(16);if(typeof m=="string")for(var w=0;16>w;++w)v[w]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(w=0;16>w;++w)v[w]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=E.g[0],_=E.g[1],w=E.g[2];var A=E.g[3],g=m+(A^_&(w^A))+v[0]+3614090360&4294967295;m=_+(g<<7&4294967295|g>>>25),g=A+(w^m&(_^w))+v[1]+3905402710&4294967295,A=m+(g<<12&4294967295|g>>>20),g=w+(_^A&(m^_))+v[2]+606105819&4294967295,w=A+(g<<17&4294967295|g>>>15),g=_+(m^w&(A^m))+v[3]+3250441966&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(A^_&(w^A))+v[4]+4118548399&4294967295,m=_+(g<<7&4294967295|g>>>25),g=A+(w^m&(_^w))+v[5]+1200080426&4294967295,A=m+(g<<12&4294967295|g>>>20),g=w+(_^A&(m^_))+v[6]+2821735955&4294967295,w=A+(g<<17&4294967295|g>>>15),g=_+(m^w&(A^m))+v[7]+4249261313&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(A^_&(w^A))+v[8]+1770035416&4294967295,m=_+(g<<7&4294967295|g>>>25),g=A+(w^m&(_^w))+v[9]+2336552879&4294967295,A=m+(g<<12&4294967295|g>>>20),g=w+(_^A&(m^_))+v[10]+4294925233&4294967295,w=A+(g<<17&4294967295|g>>>15),g=_+(m^w&(A^m))+v[11]+2304563134&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(A^_&(w^A))+v[12]+1804603682&4294967295,m=_+(g<<7&4294967295|g>>>25),g=A+(w^m&(_^w))+v[13]+4254626195&4294967295,A=m+(g<<12&4294967295|g>>>20),g=w+(_^A&(m^_))+v[14]+2792965006&4294967295,w=A+(g<<17&4294967295|g>>>15),g=_+(m^w&(A^m))+v[15]+1236535329&4294967295,_=w+(g<<22&4294967295|g>>>10),g=m+(w^A&(_^w))+v[1]+4129170786&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^w&(m^_))+v[6]+3225465664&4294967295,A=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(A^m))+v[11]+643717713&4294967295,w=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(w^A))+v[0]+3921069994&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^A&(_^w))+v[5]+3593408605&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^w&(m^_))+v[10]+38016083&4294967295,A=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(A^m))+v[15]+3634488961&4294967295,w=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(w^A))+v[4]+3889429448&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^A&(_^w))+v[9]+568446438&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^w&(m^_))+v[14]+3275163606&4294967295,A=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(A^m))+v[3]+4107603335&4294967295,w=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(w^A))+v[8]+1163531501&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(w^A&(_^w))+v[13]+2850285829&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^w&(m^_))+v[2]+4243563512&4294967295,A=m+(g<<9&4294967295|g>>>23),g=w+(m^_&(A^m))+v[7]+1735328473&4294967295,w=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(w^A))+v[12]+2368359562&4294967295,_=w+(g<<20&4294967295|g>>>12),g=m+(_^w^A)+v[5]+4294588738&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^w)+v[8]+2272392833&4294967295,A=m+(g<<11&4294967295|g>>>21),g=w+(A^m^_)+v[11]+1839030562&4294967295,w=A+(g<<16&4294967295|g>>>16),g=_+(w^A^m)+v[14]+4259657740&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^A)+v[1]+2763975236&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^w)+v[4]+1272893353&4294967295,A=m+(g<<11&4294967295|g>>>21),g=w+(A^m^_)+v[7]+4139469664&4294967295,w=A+(g<<16&4294967295|g>>>16),g=_+(w^A^m)+v[10]+3200236656&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^A)+v[13]+681279174&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^w)+v[0]+3936430074&4294967295,A=m+(g<<11&4294967295|g>>>21),g=w+(A^m^_)+v[3]+3572445317&4294967295,w=A+(g<<16&4294967295|g>>>16),g=_+(w^A^m)+v[6]+76029189&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(_^w^A)+v[9]+3654602809&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^w)+v[12]+3873151461&4294967295,A=m+(g<<11&4294967295|g>>>21),g=w+(A^m^_)+v[15]+530742520&4294967295,w=A+(g<<16&4294967295|g>>>16),g=_+(w^A^m)+v[2]+3299628645&4294967295,_=w+(g<<23&4294967295|g>>>9),g=m+(w^(_|~A))+v[0]+4096336452&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~w))+v[7]+1126891415&4294967295,A=m+(g<<10&4294967295|g>>>22),g=w+(m^(A|~_))+v[14]+2878612391&4294967295,w=A+(g<<15&4294967295|g>>>17),g=_+(A^(w|~m))+v[5]+4237533241&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~A))+v[12]+1700485571&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~w))+v[3]+2399980690&4294967295,A=m+(g<<10&4294967295|g>>>22),g=w+(m^(A|~_))+v[10]+4293915773&4294967295,w=A+(g<<15&4294967295|g>>>17),g=_+(A^(w|~m))+v[1]+2240044497&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~A))+v[8]+1873313359&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~w))+v[15]+4264355552&4294967295,A=m+(g<<10&4294967295|g>>>22),g=w+(m^(A|~_))+v[6]+2734768916&4294967295,w=A+(g<<15&4294967295|g>>>17),g=_+(A^(w|~m))+v[13]+1309151649&4294967295,_=w+(g<<21&4294967295|g>>>11),g=m+(w^(_|~A))+v[4]+4149444226&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~w))+v[11]+3174756917&4294967295,A=m+(g<<10&4294967295|g>>>22),g=w+(m^(A|~_))+v[2]+718787259&4294967295,w=A+(g<<15&4294967295|g>>>17),g=_+(A^(w|~m))+v[9]+3951481745&4294967295,E.g[0]=E.g[0]+m&4294967295,E.g[1]=E.g[1]+(w+(g<<21&4294967295|g>>>11))&4294967295,E.g[2]=E.g[2]+w&4294967295,E.g[3]=E.g[3]+A&4294967295}r.prototype.u=function(E,m){m===void 0&&(m=E.length);for(var _=m-this.blockSize,v=this.B,w=this.h,A=0;A<m;){if(w==0)for(;A<=_;)i(this,E,A),A+=this.blockSize;if(typeof E=="string"){for(;A<m;)if(v[w++]=E.charCodeAt(A++),w==this.blockSize){i(this,v),w=0;break}}else for(;A<m;)if(v[w++]=E[A++],w==this.blockSize){i(this,v),w=0;break}}this.h=w,this.o+=m},r.prototype.v=function(){var E=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);E[0]=128;for(var m=1;m<E.length-8;++m)E[m]=0;var _=8*this.o;for(m=E.length-8;m<E.length;++m)E[m]=_&255,_/=256;for(this.u(E),E=Array(16),m=_=0;4>m;++m)for(var v=0;32>v;v+=8)E[_++]=this.g[m]>>>v&255;return E};function s(E,m){var _=l;return Object.prototype.hasOwnProperty.call(_,E)?_[E]:_[E]=m(E)}function a(E,m){this.h=m;for(var _=[],v=!0,w=E.length-1;0<=w;w--){var A=E[w]|0;v&&A==m||(_[w]=A,v=!1)}this.g=_}var l={};function h(E){return-128<=E&&128>E?s(E,function(m){return new a([m|0],0>m?-1:0)}):new a([E|0],0>E?-1:0)}function d(E){if(isNaN(E)||!isFinite(E))return y;if(0>E)return D(d(-E));for(var m=[],_=1,v=0;E>=_;v++)m[v]=E/_|0,_*=4294967296;return new a(m,0)}function f(E,m){if(E.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(E.charAt(0)=="-")return D(f(E.substring(1),m));if(0<=E.indexOf("-"))throw Error('number format error: interior "-" character');for(var _=d(Math.pow(m,8)),v=y,w=0;w<E.length;w+=8){var A=Math.min(8,E.length-w),g=parseInt(E.substring(w,w+A),m);8>A?(A=d(Math.pow(m,A)),v=v.j(A).add(d(g))):(v=v.j(_),v=v.add(d(g)))}return v}var y=h(0),T=h(1),R=h(16777216);n=a.prototype,n.m=function(){if(L(this))return-D(this).m();for(var E=0,m=1,_=0;_<this.g.length;_++){var v=this.i(_);E+=(0<=v?v:4294967296+v)*m,m*=4294967296}return E},n.toString=function(E){if(E=E||10,2>E||36<E)throw Error("radix out of range: "+E);if(k(this))return"0";if(L(this))return"-"+D(this).toString(E);for(var m=d(Math.pow(E,6)),_=this,v="";;){var w=ne(_,m).g;_=G(_,w.j(m));var A=((0<_.g.length?_.g[0]:_.h)>>>0).toString(E);if(_=w,k(_))return A+v;for(;6>A.length;)A="0"+A;v=A+v}},n.i=function(E){return 0>E?0:E<this.g.length?this.g[E]:this.h};function k(E){if(E.h!=0)return!1;for(var m=0;m<E.g.length;m++)if(E.g[m]!=0)return!1;return!0}function L(E){return E.h==-1}n.l=function(E){return E=G(this,E),L(E)?-1:k(E)?0:1};function D(E){for(var m=E.g.length,_=[],v=0;v<m;v++)_[v]=~E.g[v];return new a(_,~E.h).add(T)}n.abs=function(){return L(this)?D(this):this},n.add=function(E){for(var m=Math.max(this.g.length,E.g.length),_=[],v=0,w=0;w<=m;w++){var A=v+(this.i(w)&65535)+(E.i(w)&65535),g=(A>>>16)+(this.i(w)>>>16)+(E.i(w)>>>16);v=g>>>16,A&=65535,g&=65535,_[w]=g<<16|A}return new a(_,_[_.length-1]&-2147483648?-1:0)};function G(E,m){return E.add(D(m))}n.j=function(E){if(k(this)||k(E))return y;if(L(this))return L(E)?D(this).j(D(E)):D(D(this).j(E));if(L(E))return D(this.j(D(E)));if(0>this.l(R)&&0>E.l(R))return d(this.m()*E.m());for(var m=this.g.length+E.g.length,_=[],v=0;v<2*m;v++)_[v]=0;for(v=0;v<this.g.length;v++)for(var w=0;w<E.g.length;w++){var A=this.i(v)>>>16,g=this.i(v)&65535,We=E.i(w)>>>16,Rn=E.i(w)&65535;_[2*v+2*w]+=g*Rn,K(_,2*v+2*w),_[2*v+2*w+1]+=A*Rn,K(_,2*v+2*w+1),_[2*v+2*w+1]+=g*We,K(_,2*v+2*w+1),_[2*v+2*w+2]+=A*We,K(_,2*v+2*w+2)}for(v=0;v<m;v++)_[v]=_[2*v+1]<<16|_[2*v];for(v=m;v<2*m;v++)_[v]=0;return new a(_,0)};function K(E,m){for(;(E[m]&65535)!=E[m];)E[m+1]+=E[m]>>>16,E[m]&=65535,m++}function Q(E,m){this.g=E,this.h=m}function ne(E,m){if(k(m))throw Error("division by zero");if(k(E))return new Q(y,y);if(L(E))return m=ne(D(E),m),new Q(D(m.g),D(m.h));if(L(m))return m=ne(E,D(m)),new Q(D(m.g),m.h);if(30<E.g.length){if(L(E)||L(m))throw Error("slowDivide_ only works with positive integers.");for(var _=T,v=m;0>=v.l(E);)_=De(_),v=De(v);var w=re(_,1),A=re(v,1);for(v=re(v,2),_=re(_,2);!k(v);){var g=A.add(v);0>=g.l(E)&&(w=w.add(_),A=g),v=re(v,1),_=re(_,1)}return m=G(E,w.j(m)),new Q(w,m)}for(w=y;0<=E.l(m);){for(_=Math.max(1,Math.floor(E.m()/m.m())),v=Math.ceil(Math.log(_)/Math.LN2),v=48>=v?1:Math.pow(2,v-48),A=d(_),g=A.j(m);L(g)||0<g.l(E);)_-=v,A=d(_),g=A.j(m);k(A)&&(A=T),w=w.add(A),E=G(E,g)}return new Q(w,E)}n.A=function(E){return ne(this,E).h},n.and=function(E){for(var m=Math.max(this.g.length,E.g.length),_=[],v=0;v<m;v++)_[v]=this.i(v)&E.i(v);return new a(_,this.h&E.h)},n.or=function(E){for(var m=Math.max(this.g.length,E.g.length),_=[],v=0;v<m;v++)_[v]=this.i(v)|E.i(v);return new a(_,this.h|E.h)},n.xor=function(E){for(var m=Math.max(this.g.length,E.g.length),_=[],v=0;v<m;v++)_[v]=this.i(v)^E.i(v);return new a(_,this.h^E.h)};function De(E){for(var m=E.g.length+1,_=[],v=0;v<m;v++)_[v]=E.i(v)<<1|E.i(v-1)>>>31;return new a(_,E.h)}function re(E,m){var _=m>>5;m%=32;for(var v=E.g.length-_,w=[],A=0;A<v;A++)w[A]=0<m?E.i(A+_)>>>m|E.i(A+_+1)<<32-m:E.i(A+_);return new a(w,E.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,fu=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=f,Lt=a}).apply(typeof Oc!="undefined"?Oc:typeof self!="undefined"?self:typeof window!="undefined"?window:{});var Wr=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var pu,zn,mu,ni,Fs,gu,_u,yu;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,c,u){return o==Array.prototype||o==Object.prototype||(o[c]=u.value),o};function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof Wr=="object"&&Wr];for(var c=0;c<o.length;++c){var u=o[c];if(u&&u.Math==Math)return u}throw Error("Cannot find global object")}var r=t(this);function i(o,c){if(c)e:{var u=r;o=o.split(".");for(var p=0;p<o.length-1;p++){var I=o[p];if(!(I in u))break e;u=u[I]}o=o[o.length-1],p=u[o],c=c(p),c!=p&&c!=null&&e(u,o,{configurable:!0,writable:!0,value:c})}}function s(o,c){o instanceof String&&(o+="");var u=0,p=!1,I={next:function(){if(!p&&u<o.length){var b=u++;return{value:c(b,o[b]),done:!1}}return p=!0,{done:!0,value:void 0}}};return I[Symbol.iterator]=function(){return I},I}i("Array.prototype.values",function(o){return o||function(){return s(this,function(c,u){return u})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},l=this||self;function h(o){var c=typeof o;return c=c!="object"?c:o?Array.isArray(o)?"array":c:"null",c=="array"||c=="object"&&typeof o.length=="number"}function d(o){var c=typeof o;return c=="object"&&o!=null||c=="function"}function f(o,c,u){return o.call.apply(o.bind,arguments)}function y(o,c,u){if(!o)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var I=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(I,p),o.apply(c,I)}}return function(){return o.apply(c,arguments)}}function T(o,c,u){return T=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:y,T.apply(null,arguments)}function R(o,c){var u=Array.prototype.slice.call(arguments,1);return function(){var p=u.slice();return p.push.apply(p,arguments),o.apply(this,p)}}function k(o,c){function u(){}u.prototype=c.prototype,o.aa=c.prototype,o.prototype=new u,o.prototype.constructor=o,o.Qb=function(p,I,b){for(var C=Array(arguments.length-2),Y=2;Y<arguments.length;Y++)C[Y-2]=arguments[Y];return c.prototype[I].apply(p,C)}}function L(o){const c=o.length;if(0<c){const u=Array(c);for(let p=0;p<c;p++)u[p]=o[p];return u}return[]}function D(o,c){for(let u=1;u<arguments.length;u++){const p=arguments[u];if(h(p)){const I=o.length||0,b=p.length||0;o.length=I+b;for(let C=0;C<b;C++)o[I+C]=p[C]}else o.push(p)}}class G{constructor(c,u){this.i=c,this.j=u,this.h=0,this.g=null}get(){let c;return 0<this.h?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function K(o){return/^[\s\xa0]*$/.test(o)}function Q(){var o=l.navigator;return o&&(o=o.userAgent)?o:""}function ne(o){return ne[" "](o),o}ne[" "]=function(){};var De=Q().indexOf("Gecko")!=-1&&!(Q().toLowerCase().indexOf("webkit")!=-1&&Q().indexOf("Edge")==-1)&&!(Q().indexOf("Trident")!=-1||Q().indexOf("MSIE")!=-1)&&Q().indexOf("Edge")==-1;function re(o,c,u){for(const p in o)c.call(u,o[p],p,o)}function E(o,c){for(const u in o)c.call(void 0,o[u],u,o)}function m(o){const c={};for(const u in o)c[u]=o[u];return c}const _="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function v(o,c){let u,p;for(let I=1;I<arguments.length;I++){p=arguments[I];for(u in p)o[u]=p[u];for(let b=0;b<_.length;b++)u=_[b],Object.prototype.hasOwnProperty.call(p,u)&&(o[u]=p[u])}}function w(o){var c=1;o=o.split(":");const u=[];for(;0<c&&o.length;)u.push(o.shift()),c--;return o.length&&u.push(o.join(":")),u}function A(o){l.setTimeout(()=>{throw o},0)}function g(){var o=Ki;let c=null;return o.g&&(c=o.g,o.g=o.g.next,o.g||(o.h=null),c.next=null),c}class We{constructor(){this.h=this.g=null}add(c,u){const p=Rn.get();p.set(c,u),this.h?this.h.next=p:this.g=p,this.h=p}}var Rn=new G(()=>new zh,o=>o.reset());class zh{constructor(){this.next=this.g=this.h=null}set(c,u){this.h=c,this.g=u,this.next=null}reset(){this.next=this.g=this.h=null}}let Sn,Pn=!1,Ki=new We,ia=()=>{const o=l.Promise.resolve(void 0);Sn=()=>{o.then(Gh)}};var Gh=()=>{for(var o;o=g();){try{o.h.call(o.g)}catch(u){A(u)}var c=Rn;c.j(o),100>c.h&&(c.h++,o.next=c.g,c.g=o)}Pn=!1};function ot(){this.s=this.s,this.C=this.C}ot.prototype.s=!1,ot.prototype.ma=function(){this.s||(this.s=!0,this.N())},ot.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ge(o,c){this.type=o,this.g=this.target=c,this.defaultPrevented=!1}ge.prototype.h=function(){this.defaultPrevented=!0};var Kh=function(){if(!l.addEventListener||!Object.defineProperty)return!1;var o=!1,c=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const u=()=>{};l.addEventListener("test",u,c),l.removeEventListener("test",u,c)}catch{}return o}();function Cn(o,c){if(ge.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o){var u=this.type=o.type,p=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;if(this.target=o.target||o.srcElement,this.g=c,c=o.relatedTarget){if(De){e:{try{ne(c.nodeName);var I=!0;break e}catch{}I=!1}I||(c=null)}}else u=="mouseover"?c=o.fromElement:u=="mouseout"&&(c=o.toElement);this.relatedTarget=c,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=typeof o.pointerType=="string"?o.pointerType:Qh[o.pointerType]||"",this.state=o.state,this.i=o,o.defaultPrevented&&Cn.aa.h.call(this)}}k(Cn,ge);var Qh={2:"touch",3:"pen",4:"mouse"};Cn.prototype.h=function(){Cn.aa.h.call(this);var o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var br="closure_listenable_"+(1e6*Math.random()|0),Jh=0;function Yh(o,c,u,p,I){this.listener=o,this.proxy=null,this.src=c,this.type=u,this.capture=!!p,this.ha=I,this.key=++Jh,this.da=this.fa=!1}function Rr(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function Sr(o){this.src=o,this.g={},this.h=0}Sr.prototype.add=function(o,c,u,p,I){var b=o.toString();o=this.g[b],o||(o=this.g[b]=[],this.h++);var C=Ji(o,c,p,I);return-1<C?(c=o[C],u||(c.fa=!1)):(c=new Yh(c,this.src,b,!!p,I),c.fa=u,o.push(c)),c};function Qi(o,c){var u=c.type;if(u in o.g){var p=o.g[u],I=Array.prototype.indexOf.call(p,c,void 0),b;(b=0<=I)&&Array.prototype.splice.call(p,I,1),b&&(Rr(c),o.g[u].length==0&&(delete o.g[u],o.h--))}}function Ji(o,c,u,p){for(var I=0;I<o.length;++I){var b=o[I];if(!b.da&&b.listener==c&&b.capture==!!u&&b.ha==p)return I}return-1}var Yi="closure_lm_"+(1e6*Math.random()|0),Xi={};function sa(o,c,u,p,I){if(Array.isArray(c)){for(var b=0;b<c.length;b++)sa(o,c[b],u,p,I);return null}return u=ca(u),o&&o[br]?o.K(c,u,d(p)?!!p.capture:!1,I):Xh(o,c,u,!1,p,I)}function Xh(o,c,u,p,I,b){if(!c)throw Error("Invalid event type");var C=d(I)?!!I.capture:!!I,Y=es(o);if(Y||(o[Yi]=Y=new Sr(o)),u=Y.add(c,u,p,C,b),u.proxy)return u;if(p=Zh(),u.proxy=p,p.src=o,p.listener=u,o.addEventListener)Kh||(I=C),I===void 0&&(I=!1),o.addEventListener(c.toString(),p,I);else if(o.attachEvent)o.attachEvent(aa(c.toString()),p);else if(o.addListener&&o.removeListener)o.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return u}function Zh(){function o(u){return c.call(o.src,o.listener,u)}const c=ed;return o}function oa(o,c,u,p,I){if(Array.isArray(c))for(var b=0;b<c.length;b++)oa(o,c[b],u,p,I);else p=d(p)?!!p.capture:!!p,u=ca(u),o&&o[br]?(o=o.i,c=String(c).toString(),c in o.g&&(b=o.g[c],u=Ji(b,u,p,I),-1<u&&(Rr(b[u]),Array.prototype.splice.call(b,u,1),b.length==0&&(delete o.g[c],o.h--)))):o&&(o=es(o))&&(c=o.g[c.toString()],o=-1,c&&(o=Ji(c,u,p,I)),(u=-1<o?c[o]:null)&&Zi(u))}function Zi(o){if(typeof o!="number"&&o&&!o.da){var c=o.src;if(c&&c[br])Qi(c.i,o);else{var u=o.type,p=o.proxy;c.removeEventListener?c.removeEventListener(u,p,o.capture):c.detachEvent?c.detachEvent(aa(u),p):c.addListener&&c.removeListener&&c.removeListener(p),(u=es(c))?(Qi(u,o),u.h==0&&(u.src=null,c[Yi]=null)):Rr(o)}}}function aa(o){return o in Xi?Xi[o]:Xi[o]="on"+o}function ed(o,c){if(o.da)o=!0;else{c=new Cn(c,this);var u=o.listener,p=o.ha||o.src;o.fa&&Zi(o),o=u.call(p,c)}return o}function es(o){return o=o[Yi],o instanceof Sr?o:null}var ts="__closure_events_fn_"+(1e9*Math.random()>>>0);function ca(o){return typeof o=="function"?o:(o[ts]||(o[ts]=function(c){return o.handleEvent(c)}),o[ts])}function _e(){ot.call(this),this.i=new Sr(this),this.M=this,this.F=null}k(_e,ot),_e.prototype[br]=!0,_e.prototype.removeEventListener=function(o,c,u,p){oa(this,o,c,u,p)};function Ae(o,c){var u,p=o.F;if(p)for(u=[];p;p=p.F)u.push(p);if(o=o.M,p=c.type||c,typeof c=="string")c=new ge(c,o);else if(c instanceof ge)c.target=c.target||o;else{var I=c;c=new ge(p,o),v(c,I)}if(I=!0,u)for(var b=u.length-1;0<=b;b--){var C=c.g=u[b];I=Pr(C,p,!0,c)&&I}if(C=c.g=o,I=Pr(C,p,!0,c)&&I,I=Pr(C,p,!1,c)&&I,u)for(b=0;b<u.length;b++)C=c.g=u[b],I=Pr(C,p,!1,c)&&I}_e.prototype.N=function(){if(_e.aa.N.call(this),this.i){var o=this.i,c;for(c in o.g){for(var u=o.g[c],p=0;p<u.length;p++)Rr(u[p]);delete o.g[c],o.h--}}this.F=null},_e.prototype.K=function(o,c,u,p){return this.i.add(String(o),c,!1,u,p)},_e.prototype.L=function(o,c,u,p){return this.i.add(String(o),c,!0,u,p)};function Pr(o,c,u,p){if(c=o.i.g[String(c)],!c)return!0;c=c.concat();for(var I=!0,b=0;b<c.length;++b){var C=c[b];if(C&&!C.da&&C.capture==u){var Y=C.listener,he=C.ha||C.src;C.fa&&Qi(o.i,C),I=Y.call(he,p)!==!1&&I}}return I&&!p.defaultPrevented}function la(o,c,u){if(typeof o=="function")u&&(o=T(o,u));else if(o&&typeof o.handleEvent=="function")o=T(o.handleEvent,o);else throw Error("Invalid listener argument");return 2147483647<Number(c)?-1:l.setTimeout(o,c||0)}function ua(o){o.g=la(()=>{o.g=null,o.i&&(o.i=!1,ua(o))},o.l);const c=o.h;o.h=null,o.m.apply(null,c)}class td extends ot{constructor(c,u){super(),this.m=c,this.l=u,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:ua(this)}N(){super.N(),this.g&&(l.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function kn(o){ot.call(this),this.h=o,this.g={}}k(kn,ot);var ha=[];function da(o){re(o.g,function(c,u){this.g.hasOwnProperty(u)&&Zi(c)},o),o.g={}}kn.prototype.N=function(){kn.aa.N.call(this),da(this)},kn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ns=l.JSON.stringify,nd=l.JSON.parse,rd=class{stringify(o){return l.JSON.stringify(o,void 0)}parse(o){return l.JSON.parse(o,void 0)}};function rs(){}rs.prototype.h=null;function fa(o){return o.h||(o.h=o.i())}function pa(){}var Dn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function is(){ge.call(this,"d")}k(is,ge);function ss(){ge.call(this,"c")}k(ss,ge);var Ct={},ma=null;function Cr(){return ma=ma||new _e}Ct.La="serverreachability";function ga(o){ge.call(this,Ct.La,o)}k(ga,ge);function Nn(o){const c=Cr();Ae(c,new ga(c))}Ct.STAT_EVENT="statevent";function _a(o,c){ge.call(this,Ct.STAT_EVENT,o),this.stat=c}k(_a,ge);function be(o){const c=Cr();Ae(c,new _a(c,o))}Ct.Ma="timingevent";function ya(o,c){ge.call(this,Ct.Ma,o),this.size=c}k(ya,ge);function Vn(o,c){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return l.setTimeout(function(){o()},c)}function On(){this.g=!0}On.prototype.xa=function(){this.g=!1};function id(o,c,u,p,I,b){o.info(function(){if(o.g)if(b)for(var C="",Y=b.split("&"),he=0;he<Y.length;he++){var W=Y[he].split("=");if(1<W.length){var ye=W[0];W=W[1];var ve=ye.split("_");C=2<=ve.length&&ve[1]=="type"?C+(ye+"="+W+"&"):C+(ye+"=redacted&")}}else C=null;else C=b;return"XMLHTTP REQ ("+p+") [attempt "+I+"]: "+c+`
`+u+`
`+C})}function sd(o,c,u,p,I,b,C){o.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+I+"]: "+c+`
`+u+`
`+b+" "+C})}function Wt(o,c,u,p){o.info(function(){return"XMLHTTP TEXT ("+c+"): "+ad(o,u)+(p?" "+p:"")})}function od(o,c){o.info(function(){return"TIMEOUT: "+c})}On.prototype.info=function(){};function ad(o,c){if(!o.g)return c;if(!c)return null;try{var u=JSON.parse(c);if(u){for(o=0;o<u.length;o++)if(Array.isArray(u[o])){var p=u[o];if(!(2>p.length)){var I=p[1];if(Array.isArray(I)&&!(1>I.length)){var b=I[0];if(b!="noop"&&b!="stop"&&b!="close")for(var C=1;C<I.length;C++)I[C]=""}}}}return ns(u)}catch{return c}}var kr={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},va={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},os;function Dr(){}k(Dr,rs),Dr.prototype.g=function(){return new XMLHttpRequest},Dr.prototype.i=function(){return{}},os=new Dr;function at(o,c,u,p){this.j=o,this.i=c,this.l=u,this.R=p||1,this.U=new kn(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new Ea}function Ea(){this.i=null,this.g="",this.h=!1}var wa={},as={};function cs(o,c,u){o.L=1,o.v=Lr(ze(c)),o.m=u,o.P=!0,Ta(o,null)}function Ta(o,c){o.F=Date.now(),Nr(o),o.A=ze(o.v);var u=o.A,p=o.R;Array.isArray(p)||(p=[String(p)]),Ma(u.i,"t",p),o.C=0,u=o.j.J,o.h=new Ea,o.g=ec(o.j,u?c:null,!o.m),0<o.O&&(o.M=new td(T(o.Y,o,o.g),o.O)),c=o.U,u=o.g,p=o.ca;var I="readystatechange";Array.isArray(I)||(I&&(ha[0]=I.toString()),I=ha);for(var b=0;b<I.length;b++){var C=sa(u,I[b],p||c.handleEvent,!1,c.h||c);if(!C)break;c.g[C.key]=C}c=o.H?m(o.H):{},o.m?(o.u||(o.u="POST"),c["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.A,o.u,o.m,c)):(o.u="GET",o.g.ea(o.A,o.u,null,c)),Nn(),id(o.i,o.u,o.A,o.l,o.R,o.m)}at.prototype.ca=function(o){o=o.target;const c=this.M;c&&Ge(o)==3?c.j():this.Y(o)},at.prototype.Y=function(o){try{if(o==this.g)e:{const ve=Ge(this.g);var c=this.g.Ba();const Kt=this.g.Z();if(!(3>ve)&&(ve!=3||this.g&&(this.h.h||this.g.oa()||qa(this.g)))){this.J||ve!=4||c==7||(c==8||0>=Kt?Nn(3):Nn(2)),ls(this);var u=this.g.Z();this.X=u;t:if(Ia(this)){var p=qa(this.g);o="";var I=p.length,b=Ge(this.g)==4;if(!this.h.i){if(typeof TextDecoder=="undefined"){kt(this),Ln(this);var C="";break t}this.h.i=new l.TextDecoder}for(c=0;c<I;c++)this.h.h=!0,o+=this.h.i.decode(p[c],{stream:!(b&&c==I-1)});p.length=0,this.h.g+=o,this.C=0,C=this.h.g}else C=this.g.oa();if(this.o=u==200,sd(this.i,this.u,this.A,this.l,this.R,ve,u),this.o){if(this.T&&!this.K){t:{if(this.g){var Y,he=this.g;if((Y=he.g?he.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!K(Y)){var W=Y;break t}}W=null}if(u=W)Wt(this.i,this.l,u,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,us(this,u);else{this.o=!1,this.s=3,be(12),kt(this),Ln(this);break e}}if(this.P){u=!0;let Ve;for(;!this.J&&this.C<C.length;)if(Ve=cd(this,C),Ve==as){ve==4&&(this.s=4,be(14),u=!1),Wt(this.i,this.l,null,"[Incomplete Response]");break}else if(Ve==wa){this.s=4,be(15),Wt(this.i,this.l,C,"[Invalid Chunk]"),u=!1;break}else Wt(this.i,this.l,Ve,null),us(this,Ve);if(Ia(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ve!=4||C.length!=0||this.h.h||(this.s=1,be(16),u=!1),this.o=this.o&&u,!u)Wt(this.i,this.l,C,"[Invalid Chunked Response]"),kt(this),Ln(this);else if(0<C.length&&!this.W){this.W=!0;var ye=this.j;ye.g==this&&ye.ba&&!ye.M&&(ye.j.info("Great, no buffering proxy detected. Bytes received: "+C.length),gs(ye),ye.M=!0,be(11))}}else Wt(this.i,this.l,C,null),us(this,C);ve==4&&kt(this),this.o&&!this.J&&(ve==4?Ja(this.j,this):(this.o=!1,Nr(this)))}else bd(this.g),u==400&&0<C.indexOf("Unknown SID")?(this.s=3,be(12)):(this.s=0,be(13)),kt(this),Ln(this)}}}catch{}finally{}};function Ia(o){return o.g?o.u=="GET"&&o.L!=2&&o.j.Ca:!1}function cd(o,c){var u=o.C,p=c.indexOf(`
`,u);return p==-1?as:(u=Number(c.substring(u,p)),isNaN(u)?wa:(p+=1,p+u>c.length?as:(c=c.slice(p,p+u),o.C=p+u,c)))}at.prototype.cancel=function(){this.J=!0,kt(this)};function Nr(o){o.S=Date.now()+o.I,Aa(o,o.I)}function Aa(o,c){if(o.B!=null)throw Error("WatchDog timer not null");o.B=Vn(T(o.ba,o),c)}function ls(o){o.B&&(l.clearTimeout(o.B),o.B=null)}at.prototype.ba=function(){this.B=null;const o=Date.now();0<=o-this.S?(od(this.i,this.A),this.L!=2&&(Nn(),be(17)),kt(this),this.s=2,Ln(this)):Aa(this,this.S-o)};function Ln(o){o.j.G==0||o.J||Ja(o.j,o)}function kt(o){ls(o);var c=o.M;c&&typeof c.ma=="function"&&c.ma(),o.M=null,da(o.U),o.g&&(c=o.g,o.g=null,c.abort(),c.ma())}function us(o,c){try{var u=o.j;if(u.G!=0&&(u.g==o||hs(u.h,o))){if(!o.K&&hs(u.h,o)&&u.G==3){try{var p=u.Da.g.parse(c)}catch{p=null}if(Array.isArray(p)&&p.length==3){var I=p;if(I[0]==0){e:if(!u.u){if(u.g)if(u.g.F+3e3<o.F)Br(u),Ur(u);else break e;ms(u),be(18)}}else u.za=I[1],0<u.za-u.T&&37500>I[2]&&u.F&&u.v==0&&!u.C&&(u.C=Vn(T(u.Za,u),6e3));if(1>=Sa(u.h)&&u.ca){try{u.ca()}catch{}u.ca=void 0}}else Nt(u,11)}else if((o.K||u.g==o)&&Br(u),!K(c))for(I=u.Da.g.parse(c),c=0;c<I.length;c++){let W=I[c];if(u.T=W[0],W=W[1],u.G==2)if(W[0]=="c"){u.K=W[1],u.ia=W[2];const ye=W[3];ye!=null&&(u.la=ye,u.j.info("VER="+u.la));const ve=W[4];ve!=null&&(u.Aa=ve,u.j.info("SVER="+u.Aa));const Kt=W[5];Kt!=null&&typeof Kt=="number"&&0<Kt&&(p=1.5*Kt,u.L=p,u.j.info("backChannelRequestTimeoutMs_="+p)),p=u;const Ve=o.g;if(Ve){const qr=Ve.g?Ve.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(qr){var b=p.h;b.g||qr.indexOf("spdy")==-1&&qr.indexOf("quic")==-1&&qr.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(ds(b,b.h),b.h=null))}if(p.D){const _s=Ve.g?Ve.g.getResponseHeader("X-HTTP-Session-Id"):null;_s&&(p.ya=_s,X(p.I,p.D,_s))}}u.G=3,u.l&&u.l.ua(),u.ba&&(u.R=Date.now()-o.F,u.j.info("Handshake RTT: "+u.R+"ms")),p=u;var C=o;if(p.qa=Za(p,p.J?p.ia:null,p.W),C.K){Pa(p.h,C);var Y=C,he=p.L;he&&(Y.I=he),Y.B&&(ls(Y),Nr(Y)),p.g=C}else Ka(p);0<u.i.length&&$r(u)}else W[0]!="stop"&&W[0]!="close"||Nt(u,7);else u.G==3&&(W[0]=="stop"||W[0]=="close"?W[0]=="stop"?Nt(u,7):ps(u):W[0]!="noop"&&u.l&&u.l.ta(W),u.v=0)}}Nn(4)}catch{}}var ld=class{constructor(o,c){this.g=o,this.map=c}};function ba(o){this.l=o||10,l.PerformanceNavigationTiming?(o=l.performance.getEntriesByType("navigation"),o=0<o.length&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(l.chrome&&l.chrome.loadTimes&&l.chrome.loadTimes()&&l.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Ra(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function Sa(o){return o.h?1:o.g?o.g.size:0}function hs(o,c){return o.h?o.h==c:o.g?o.g.has(c):!1}function ds(o,c){o.g?o.g.add(c):o.h=c}function Pa(o,c){o.h&&o.h==c?o.h=null:o.g&&o.g.has(c)&&o.g.delete(c)}ba.prototype.cancel=function(){if(this.i=Ca(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function Ca(o){if(o.h!=null)return o.i.concat(o.h.D);if(o.g!=null&&o.g.size!==0){let c=o.i;for(const u of o.g.values())c=c.concat(u.D);return c}return L(o.i)}function ud(o){if(o.V&&typeof o.V=="function")return o.V();if(typeof Map!="undefined"&&o instanceof Map||typeof Set!="undefined"&&o instanceof Set)return Array.from(o.values());if(typeof o=="string")return o.split("");if(h(o)){for(var c=[],u=o.length,p=0;p<u;p++)c.push(o[p]);return c}c=[],u=0;for(p in o)c[u++]=o[p];return c}function hd(o){if(o.na&&typeof o.na=="function")return o.na();if(!o.V||typeof o.V!="function"){if(typeof Map!="undefined"&&o instanceof Map)return Array.from(o.keys());if(!(typeof Set!="undefined"&&o instanceof Set)){if(h(o)||typeof o=="string"){var c=[];o=o.length;for(var u=0;u<o;u++)c.push(u);return c}c=[],u=0;for(const p in o)c[u++]=p;return c}}}function ka(o,c){if(o.forEach&&typeof o.forEach=="function")o.forEach(c,void 0);else if(h(o)||typeof o=="string")Array.prototype.forEach.call(o,c,void 0);else for(var u=hd(o),p=ud(o),I=p.length,b=0;b<I;b++)c.call(void 0,p[b],u&&u[b],o)}var Da=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function dd(o,c){if(o){o=o.split("&");for(var u=0;u<o.length;u++){var p=o[u].indexOf("="),I=null;if(0<=p){var b=o[u].substring(0,p);I=o[u].substring(p+1)}else b=o[u];c(b,I?decodeURIComponent(I.replace(/\+/g," ")):"")}}}function Dt(o){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,o instanceof Dt){this.h=o.h,Vr(this,o.j),this.o=o.o,this.g=o.g,Or(this,o.s),this.l=o.l;var c=o.i,u=new Fn;u.i=c.i,c.g&&(u.g=new Map(c.g),u.h=c.h),Na(this,u),this.m=o.m}else o&&(c=String(o).match(Da))?(this.h=!1,Vr(this,c[1]||"",!0),this.o=Mn(c[2]||""),this.g=Mn(c[3]||"",!0),Or(this,c[4]),this.l=Mn(c[5]||"",!0),Na(this,c[6]||"",!0),this.m=Mn(c[7]||"")):(this.h=!1,this.i=new Fn(null,this.h))}Dt.prototype.toString=function(){var o=[],c=this.j;c&&o.push(xn(c,Va,!0),":");var u=this.g;return(u||c=="file")&&(o.push("//"),(c=this.o)&&o.push(xn(c,Va,!0),"@"),o.push(encodeURIComponent(String(u)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),u=this.s,u!=null&&o.push(":",String(u))),(u=this.l)&&(this.g&&u.charAt(0)!="/"&&o.push("/"),o.push(xn(u,u.charAt(0)=="/"?md:pd,!0))),(u=this.i.toString())&&o.push("?",u),(u=this.m)&&o.push("#",xn(u,_d)),o.join("")};function ze(o){return new Dt(o)}function Vr(o,c,u){o.j=u?Mn(c,!0):c,o.j&&(o.j=o.j.replace(/:$/,""))}function Or(o,c){if(c){if(c=Number(c),isNaN(c)||0>c)throw Error("Bad port number "+c);o.s=c}else o.s=null}function Na(o,c,u){c instanceof Fn?(o.i=c,yd(o.i,o.h)):(u||(c=xn(c,gd)),o.i=new Fn(c,o.h))}function X(o,c,u){o.i.set(c,u)}function Lr(o){return X(o,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),o}function Mn(o,c){return o?c?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function xn(o,c,u){return typeof o=="string"?(o=encodeURI(o).replace(c,fd),u&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function fd(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var Va=/[#\/\?@]/g,pd=/[#\?:]/g,md=/[#\?]/g,gd=/[#\?@]/g,_d=/#/g;function Fn(o,c){this.h=this.g=null,this.i=o||null,this.j=!!c}function ct(o){o.g||(o.g=new Map,o.h=0,o.i&&dd(o.i,function(c,u){o.add(decodeURIComponent(c.replace(/\+/g," ")),u)}))}n=Fn.prototype,n.add=function(o,c){ct(this),this.i=null,o=zt(this,o);var u=this.g.get(o);return u||this.g.set(o,u=[]),u.push(c),this.h+=1,this};function Oa(o,c){ct(o),c=zt(o,c),o.g.has(c)&&(o.i=null,o.h-=o.g.get(c).length,o.g.delete(c))}function La(o,c){return ct(o),c=zt(o,c),o.g.has(c)}n.forEach=function(o,c){ct(this),this.g.forEach(function(u,p){u.forEach(function(I){o.call(c,I,p,this)},this)},this)},n.na=function(){ct(this);const o=Array.from(this.g.values()),c=Array.from(this.g.keys()),u=[];for(let p=0;p<c.length;p++){const I=o[p];for(let b=0;b<I.length;b++)u.push(c[p])}return u},n.V=function(o){ct(this);let c=[];if(typeof o=="string")La(this,o)&&(c=c.concat(this.g.get(zt(this,o))));else{o=Array.from(this.g.values());for(let u=0;u<o.length;u++)c=c.concat(o[u])}return c},n.set=function(o,c){return ct(this),this.i=null,o=zt(this,o),La(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[c]),this.h+=1,this},n.get=function(o,c){return o?(o=this.V(o),0<o.length?String(o[0]):c):c};function Ma(o,c,u){Oa(o,c),0<u.length&&(o.i=null,o.g.set(zt(o,c),L(u)),o.h+=u.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],c=Array.from(this.g.keys());for(var u=0;u<c.length;u++){var p=c[u];const b=encodeURIComponent(String(p)),C=this.V(p);for(p=0;p<C.length;p++){var I=b;C[p]!==""&&(I+="="+encodeURIComponent(String(C[p]))),o.push(I)}}return this.i=o.join("&")};function zt(o,c){return c=String(c),o.j&&(c=c.toLowerCase()),c}function yd(o,c){c&&!o.j&&(ct(o),o.i=null,o.g.forEach(function(u,p){var I=p.toLowerCase();p!=I&&(Oa(this,p),Ma(this,I,u))},o)),o.j=c}function vd(o,c){const u=new On;if(l.Image){const p=new Image;p.onload=R(lt,u,"TestLoadImage: loaded",!0,c,p),p.onerror=R(lt,u,"TestLoadImage: error",!1,c,p),p.onabort=R(lt,u,"TestLoadImage: abort",!1,c,p),p.ontimeout=R(lt,u,"TestLoadImage: timeout",!1,c,p),l.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=o}else c(!1)}function Ed(o,c){const u=new On,p=new AbortController,I=setTimeout(()=>{p.abort(),lt(u,"TestPingServer: timeout",!1,c)},1e4);fetch(o,{signal:p.signal}).then(b=>{clearTimeout(I),b.ok?lt(u,"TestPingServer: ok",!0,c):lt(u,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(I),lt(u,"TestPingServer: error",!1,c)})}function lt(o,c,u,p,I){try{I&&(I.onload=null,I.onerror=null,I.onabort=null,I.ontimeout=null),p(u)}catch{}}function wd(){this.g=new rd}function Td(o,c,u){const p=u||"";try{ka(o,function(I,b){let C=I;d(I)&&(C=ns(I)),c.push(p+b+"="+encodeURIComponent(C))})}catch(I){throw c.push(p+"type="+encodeURIComponent("_badmap")),I}}function Mr(o){this.l=o.Ub||null,this.j=o.eb||!1}k(Mr,rs),Mr.prototype.g=function(){return new xr(this.l,this.j)},Mr.prototype.i=function(o){return function(){return o}}({});function xr(o,c){_e.call(this),this.D=o,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}k(xr,_e),n=xr.prototype,n.open=function(o,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=o,this.A=c,this.readyState=1,$n(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const c={headers:this.u,method:this.B,credentials:this.m,cache:void 0};o&&(c.body=o),(this.D||l).fetch(new Request(this.A,c)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Un(this)),this.readyState=0},n.Sa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,$n(this)),this.g&&(this.readyState=3,$n(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof l.ReadableStream!="undefined"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;xa(this)}else o.text().then(this.Ra.bind(this),this.ga.bind(this))};function xa(o){o.j.read().then(o.Pa.bind(o)).catch(o.ga.bind(o))}n.Pa=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var c=o.value?o.value:new Uint8Array(0);(c=this.v.decode(c,{stream:!o.done}))&&(this.response=this.responseText+=c)}o.done?Un(this):$n(this),this.readyState==3&&xa(this)}},n.Ra=function(o){this.g&&(this.response=this.responseText=o,Un(this))},n.Qa=function(o){this.g&&(this.response=o,Un(this))},n.ga=function(){this.g&&Un(this)};function Un(o){o.readyState=4,o.l=null,o.j=null,o.v=null,$n(o)}n.setRequestHeader=function(o,c){this.u.append(o,c)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],c=this.h.entries();for(var u=c.next();!u.done;)u=u.value,o.push(u[0]+": "+u[1]),u=c.next();return o.join(`\r
`)};function $n(o){o.onreadystatechange&&o.onreadystatechange.call(o)}Object.defineProperty(xr.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(o){this.m=o?"include":"same-origin"}});function Fa(o){let c="";return re(o,function(u,p){c+=p,c+=":",c+=u,c+=`\r
`}),c}function fs(o,c,u){e:{for(p in u){var p=!1;break e}p=!0}p||(u=Fa(u),typeof o=="string"?u!=null&&encodeURIComponent(String(u)):X(o,c,u))}function te(o){_e.call(this),this.headers=new Map,this.o=o||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}k(te,_e);var Id=/^https?$/i,Ad=["POST","PUT"];n=te.prototype,n.Ha=function(o){this.J=o},n.ea=function(o,c,u,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);c=c?c.toUpperCase():"GET",this.D=o,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():os.g(),this.v=this.o?fa(this.o):fa(os),this.g.onreadystatechange=T(this.Ea,this);try{this.B=!0,this.g.open(c,String(o),!0),this.B=!1}catch(b){Ua(this,b);return}if(o=u||"",u=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var I in p)u.set(I,p[I]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const b of p.keys())u.set(b,p.get(b));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(u.keys()).find(b=>b.toLowerCase()=="content-type"),I=l.FormData&&o instanceof l.FormData,!(0<=Array.prototype.indexOf.call(Ad,c,void 0))||p||I||u.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,C]of u)this.g.setRequestHeader(b,C);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{ja(this),this.u=!0,this.g.send(o),this.u=!1}catch(b){Ua(this,b)}};function Ua(o,c){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=c,o.m=5,$a(o),Fr(o)}function $a(o){o.A||(o.A=!0,Ae(o,"complete"),Ae(o,"error"))}n.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=o||7,Ae(this,"complete"),Ae(this,"abort"),Fr(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Fr(this,!0)),te.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Ba(this):this.bb())},n.bb=function(){Ba(this)};function Ba(o){if(o.h&&typeof a!="undefined"&&(!o.v[1]||Ge(o)!=4||o.Z()!=2)){if(o.u&&Ge(o)==4)la(o.Ea,0,o);else if(Ae(o,"readystatechange"),Ge(o)==4){o.h=!1;try{const C=o.Z();e:switch(C){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var c=!0;break e;default:c=!1}var u;if(!(u=c)){var p;if(p=C===0){var I=String(o.D).match(Da)[1]||null;!I&&l.self&&l.self.location&&(I=l.self.location.protocol.slice(0,-1)),p=!Id.test(I?I.toLowerCase():"")}u=p}if(u)Ae(o,"complete"),Ae(o,"success");else{o.m=6;try{var b=2<Ge(o)?o.g.statusText:""}catch{b=""}o.l=b+" ["+o.Z()+"]",$a(o)}}finally{Fr(o)}}}}function Fr(o,c){if(o.g){ja(o);const u=o.g,p=o.v[0]?()=>{}:null;o.g=null,o.v=null,c||Ae(o,"ready");try{u.onreadystatechange=p}catch{}}}function ja(o){o.I&&(l.clearTimeout(o.I),o.I=null)}n.isActive=function(){return!!this.g};function Ge(o){return o.g?o.g.readyState:0}n.Z=function(){try{return 2<Ge(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(o){if(this.g){var c=this.g.responseText;return o&&c.indexOf(o)==0&&(c=c.substring(o.length)),nd(c)}};function qa(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.H){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function bd(o){const c={};o=(o.g&&2<=Ge(o)&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<o.length;p++){if(K(o[p]))continue;var u=w(o[p]);const I=u[0];if(u=u[1],typeof u!="string")continue;u=u.trim();const b=c[I]||[];c[I]=b,b.push(u)}E(c,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Bn(o,c,u){return u&&u.internalChannelParams&&u.internalChannelParams[o]||c}function Ha(o){this.Aa=0,this.i=[],this.j=new On,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Bn("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Bn("baseRetryDelayMs",5e3,o),this.cb=Bn("retryDelaySeedMs",1e4,o),this.Wa=Bn("forwardChannelMaxRetries",2,o),this.wa=Bn("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new ba(o&&o.concurrentRequestLimit),this.Da=new wd,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Ha.prototype,n.la=8,n.G=1,n.connect=function(o,c,u,p){be(0),this.W=o,this.H=c||{},u&&p!==void 0&&(this.H.OSID=u,this.H.OAID=p),this.F=this.X,this.I=Za(this,null,this.W),$r(this)};function ps(o){if(Wa(o),o.G==3){var c=o.U++,u=ze(o.I);if(X(u,"SID",o.K),X(u,"RID",c),X(u,"TYPE","terminate"),jn(o,u),c=new at(o,o.j,c),c.L=2,c.v=Lr(ze(u)),u=!1,l.navigator&&l.navigator.sendBeacon)try{u=l.navigator.sendBeacon(c.v.toString(),"")}catch{}!u&&l.Image&&(new Image().src=c.v,u=!0),u||(c.g=ec(c.j,null),c.g.ea(c.v)),c.F=Date.now(),Nr(c)}Xa(o)}function Ur(o){o.g&&(gs(o),o.g.cancel(),o.g=null)}function Wa(o){Ur(o),o.u&&(l.clearTimeout(o.u),o.u=null),Br(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&l.clearTimeout(o.s),o.s=null)}function $r(o){if(!Ra(o.h)&&!o.s){o.s=!0;var c=o.Ga;Sn||ia(),Pn||(Sn(),Pn=!0),Ki.add(c,o),o.B=0}}function Rd(o,c){return Sa(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=c.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=Vn(T(o.Ga,o,c),Ya(o,o.B)),o.B++,!0)}n.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const I=new at(this,this.j,o);let b=this.o;if(this.S&&(b?(b=m(b),v(b,this.S)):b=this.S),this.m!==null||this.O||(I.H=b,b=null),this.P)e:{for(var c=0,u=0;u<this.i.length;u++){t:{var p=this.i[u];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(c+=p,4096<c){c=u;break e}if(c===4096||u===this.i.length-1){c=u+1;break e}}c=1e3}else c=1e3;c=Ga(this,I,c),u=ze(this.I),X(u,"RID",o),X(u,"CVER",22),this.D&&X(u,"X-HTTP-Session-Id",this.D),jn(this,u),b&&(this.O?c="headers="+encodeURIComponent(String(Fa(b)))+"&"+c:this.m&&fs(u,this.m,b)),ds(this.h,I),this.Ua&&X(u,"TYPE","init"),this.P?(X(u,"$req",c),X(u,"SID","null"),I.T=!0,cs(I,u,null)):cs(I,u,c),this.G=2}}else this.G==3&&(o?za(this,o):this.i.length==0||Ra(this.h)||za(this))};function za(o,c){var u;c?u=c.l:u=o.U++;const p=ze(o.I);X(p,"SID",o.K),X(p,"RID",u),X(p,"AID",o.T),jn(o,p),o.m&&o.o&&fs(p,o.m,o.o),u=new at(o,o.j,u,o.B+1),o.m===null&&(u.H=o.o),c&&(o.i=c.D.concat(o.i)),c=Ga(o,u,1e3),u.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),ds(o.h,u),cs(u,p,c)}function jn(o,c){o.H&&re(o.H,function(u,p){X(c,p,u)}),o.l&&ka({},function(u,p){X(c,p,u)})}function Ga(o,c,u){u=Math.min(o.i.length,u);var p=o.l?T(o.l.Na,o.l,o):null;e:{var I=o.i;let b=-1;for(;;){const C=["count="+u];b==-1?0<u?(b=I[0].g,C.push("ofs="+b)):b=0:C.push("ofs="+b);let Y=!0;for(let he=0;he<u;he++){let W=I[he].g;const ye=I[he].map;if(W-=b,0>W)b=Math.max(0,I[he].g-100),Y=!1;else try{Td(ye,C,"req"+W+"_")}catch{p&&p(ye)}}if(Y){p=C.join("&");break e}}}return o=o.i.splice(0,u),c.D=o,p}function Ka(o){if(!o.g&&!o.u){o.Y=1;var c=o.Fa;Sn||ia(),Pn||(Sn(),Pn=!0),Ki.add(c,o),o.v=0}}function ms(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=Vn(T(o.Fa,o),Ya(o,o.v)),o.v++,!0)}n.Fa=function(){if(this.u=null,Qa(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=Vn(T(this.ab,this),o)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,be(10),Ur(this),Qa(this))};function gs(o){o.A!=null&&(l.clearTimeout(o.A),o.A=null)}function Qa(o){o.g=new at(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var c=ze(o.qa);X(c,"RID","rpc"),X(c,"SID",o.K),X(c,"AID",o.T),X(c,"CI",o.F?"0":"1"),!o.F&&o.ja&&X(c,"TO",o.ja),X(c,"TYPE","xmlhttp"),jn(o,c),o.m&&o.o&&fs(c,o.m,o.o),o.L&&(o.g.I=o.L);var u=o.g;o=o.ia,u.L=1,u.v=Lr(ze(c)),u.m=null,u.P=!0,Ta(u,o)}n.Za=function(){this.C!=null&&(this.C=null,Ur(this),ms(this),be(19))};function Br(o){o.C!=null&&(l.clearTimeout(o.C),o.C=null)}function Ja(o,c){var u=null;if(o.g==c){Br(o),gs(o),o.g=null;var p=2}else if(hs(o.h,c))u=c.D,Pa(o.h,c),p=1;else return;if(o.G!=0){if(c.o)if(p==1){u=c.m?c.m.length:0,c=Date.now()-c.F;var I=o.B;p=Cr(),Ae(p,new ya(p,u)),$r(o)}else Ka(o);else if(I=c.s,I==3||I==0&&0<c.X||!(p==1&&Rd(o,c)||p==2&&ms(o)))switch(u&&0<u.length&&(c=o.h,c.i=c.i.concat(u)),I){case 1:Nt(o,5);break;case 4:Nt(o,10);break;case 3:Nt(o,6);break;default:Nt(o,2)}}}function Ya(o,c){let u=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(u*=2),u*c}function Nt(o,c){if(o.j.info("Error code "+c),c==2){var u=T(o.fb,o),p=o.Xa;const I=!p;p=new Dt(p||"//www.google.com/images/cleardot.gif"),l.location&&l.location.protocol=="http"||Vr(p,"https"),Lr(p),I?vd(p.toString(),u):Ed(p.toString(),u)}else be(2);o.G=0,o.l&&o.l.sa(c),Xa(o),Wa(o)}n.fb=function(o){o?(this.j.info("Successfully pinged google.com"),be(2)):(this.j.info("Failed to ping google.com"),be(1))};function Xa(o){if(o.G=0,o.ka=[],o.l){const c=Ca(o.h);(c.length!=0||o.i.length!=0)&&(D(o.ka,c),D(o.ka,o.i),o.h.i.length=0,L(o.i),o.i.length=0),o.l.ra()}}function Za(o,c,u){var p=u instanceof Dt?ze(u):new Dt(u);if(p.g!="")c&&(p.g=c+"."+p.g),Or(p,p.s);else{var I=l.location;p=I.protocol,c=c?c+"."+I.hostname:I.hostname,I=+I.port;var b=new Dt(null);p&&Vr(b,p),c&&(b.g=c),I&&Or(b,I),u&&(b.l=u),p=b}return u=o.D,c=o.ya,u&&c&&X(p,u,c),X(p,"VER",o.la),jn(o,p),p}function ec(o,c,u){if(c&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return c=o.Ca&&!o.pa?new te(new Mr({eb:u})):new te(o.pa),c.Ha(o.J),c}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function tc(){}n=tc.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function jr(){}jr.prototype.g=function(o,c){return new Pe(o,c)};function Pe(o,c){_e.call(this),this.g=new Ha(c),this.l=o,this.h=c&&c.messageUrlParams||null,o=c&&c.messageHeaders||null,c&&c.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=c&&c.initMessageHeaders||null,c&&c.messageContentType&&(o?o["X-WebChannel-Content-Type"]=c.messageContentType:o={"X-WebChannel-Content-Type":c.messageContentType}),c&&c.va&&(o?o["X-WebChannel-Client-Profile"]=c.va:o={"X-WebChannel-Client-Profile":c.va}),this.g.S=o,(o=c&&c.Sb)&&!K(o)&&(this.g.m=o),this.v=c&&c.supportsCrossDomainXhr||!1,this.u=c&&c.sendRawJson||!1,(c=c&&c.httpSessionIdParam)&&!K(c)&&(this.g.D=c,o=this.h,o!==null&&c in o&&(o=this.h,c in o&&delete o[c])),this.j=new Gt(this)}k(Pe,_e),Pe.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Pe.prototype.close=function(){ps(this.g)},Pe.prototype.o=function(o){var c=this.g;if(typeof o=="string"){var u={};u.__data__=o,o=u}else this.u&&(u={},u.__data__=ns(o),o=u);c.i.push(new ld(c.Ya++,o)),c.G==3&&$r(c)},Pe.prototype.N=function(){this.g.l=null,delete this.j,ps(this.g),delete this.g,Pe.aa.N.call(this)};function nc(o){is.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var c=o.__sm__;if(c){e:{for(const u in c){o=u;break e}o=void 0}(this.i=o)&&(o=this.i,c=c!==null&&o in c?c[o]:void 0),this.data=c}else this.data=o}k(nc,is);function rc(){ss.call(this),this.status=1}k(rc,ss);function Gt(o){this.g=o}k(Gt,tc),Gt.prototype.ua=function(){Ae(this.g,"a")},Gt.prototype.ta=function(o){Ae(this.g,new nc(o))},Gt.prototype.sa=function(o){Ae(this.g,new rc)},Gt.prototype.ra=function(){Ae(this.g,"b")},jr.prototype.createWebChannel=jr.prototype.g,Pe.prototype.send=Pe.prototype.o,Pe.prototype.open=Pe.prototype.m,Pe.prototype.close=Pe.prototype.close,yu=function(){return new jr},_u=function(){return Cr()},gu=Ct,Fs={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},kr.NO_ERROR=0,kr.TIMEOUT=8,kr.HTTP_ERROR=6,ni=kr,va.COMPLETE="complete",mu=va,pa.EventType=Dn,Dn.OPEN="a",Dn.CLOSE="b",Dn.ERROR="c",Dn.MESSAGE="d",_e.prototype.listen=_e.prototype.K,zn=pa,te.prototype.listenOnce=te.prototype.L,te.prototype.getLastError=te.prototype.Ka,te.prototype.getLastErrorCode=te.prototype.Ba,te.prototype.getStatus=te.prototype.Z,te.prototype.getResponseJson=te.prototype.Oa,te.prototype.getResponseText=te.prototype.oa,te.prototype.send=te.prototype.ea,te.prototype.setWithCredentials=te.prototype.Ha,pu=te}).apply(typeof Wr!="undefined"?Wr:typeof self!="undefined"?self:typeof window!="undefined"?window:{});const Lc="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class H_{constructor(e,t,r,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=i}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next(i=>(r=i,this.remoteDocumentCache.getEntry(e,t))).next(i=>(r!==null&&er(r.mutation,i,ke.empty(),ae.now()),i))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.getLocalViewOfDocuments(e,r,j()).next(()=>r))}getLocalViewOfDocuments(e,t,r=j()){const i=Ot();return this.populateOverlays(e,i,t).next(()=>this.computeViews(e,t,i,r).next(s=>{let a=Gn();return s.forEach((l,h)=>{a=a.insert(l,h.overlayedDocument)}),a}))}getOverlayedDocuments(e,t){const r=Ot();return this.populateOverlays(e,r,t).next(()=>this.computeViews(e,t,r,j()))}populateOverlays(e,t,r){const i=[];return r.forEach(s=>{t.has(s)||i.push(s)}),this.documentOverlayCache.getOverlays(e,i).next(s=>{s.forEach((a,l)=>{t.set(a,l)})})}computeViews(e,t,r,i){let s=nt();const a=Zn(),l=function(){return Zn()}();return t.forEach((h,d)=>{const f=r.get(d.key);i.has(d.key)&&(f===void 0||f.mutation instanceof bt)?s=s.insert(d.key,d):f!==void 0?(a.set(d.key,f.mutation.getFieldMask()),er(f.mutation,d,f.mutation.getFieldMask(),ae.now())):a.set(d.key,ke.empty())}),this.recalculateAndSaveOverlays(e,s).next(h=>(h.forEach((d,f)=>a.set(d,f)),t.forEach((d,f)=>{var y;return l.set(d,new q_(f,(y=a.get(d))!==null&&y!==void 0?y:null))}),l))}recalculateAndSaveOverlays(e,t){const r=Zn();let i=new ee((a,l)=>a-l),s=j();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next(a=>{for(const l of a)l.keys().forEach(h=>{const d=t.get(h);if(d===null)return;let f=r.get(h)||ke.empty();f=l.applyToLocalView(d,f),r.set(h,f);const y=(i.get(l.batchId)||j()).add(h);i=i.insert(l.batchId,y)})}).next(()=>{const a=[],l=i.getReverseIterator();for(;l.hasNext();){const h=l.getNext(),d=h.key,f=h.value,y=Lu();f.forEach(T=>{if(!s.has(T)){const R=Bu(t.get(T),r.get(T));R!==null&&y.set(T,R),s=s.add(T)}}),a.push(this.documentOverlayCache.saveOverlays(e,d,y))}return P.waitFor(a)}).next(()=>r)}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next(r=>this.recalculateAndSaveOverlays(e,r))}getDocumentsMatchingQuery(e,t,r,i){return function(a){return M.isDocumentKey(a.path)&&a.collectionGroup===null&&a.filters.length===0}(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):ku(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,i):this.getDocumentsMatchingCollectionQuery(e,t,r,i)}getNextDocuments(e,t,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,i).next(s=>{const a=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,i-s.size):P.resolve(Ot());let l=-1,h=s;return a.next(d=>P.forEach(d,(f,y)=>(l<y.largestBatchId&&(l=y.largestBatchId),s.get(f)?P.resolve():this.remoteDocumentCache.getEntry(e,f).next(T=>{h=h.insert(f,T)}))).next(()=>this.populateOverlays(e,d,s)).next(()=>this.computeViews(e,h,d,j())).next(f=>({batchId:l,changes:Ou(f)})))})}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new M(t)).next(r=>{let i=Gn();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i})}getDocumentsMatchingCollectionGroupQuery(e,t,r,i){const s=t.collectionGroup;let a=Gn();return this.indexManager.getCollectionParents(e,s).next(l=>P.forEach(l,h=>{const d=function(y,T){return new wn(T,null,y.explicitOrderBy.slice(),y.filters.slice(),y.limit,y.limitType,y.startAt,y.endAt)}(t,h.child(s));return this.getDocumentsMatchingCollectionQuery(e,d,r,i).next(f=>{f.forEach((y,T)=>{a=a.insert(y,T)})})}).next(()=>a))}getDocumentsMatchingCollectionQuery(e,t,r,i){let s;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next(a=>(s=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,s,i))).next(a=>{s.forEach((h,d)=>{const f=d.getKey();a.get(f)===null&&(a=a.insert(f,Te.newInvalidDocument(f)))});let l=Gn();return a.forEach((h,d)=>{const f=s.get(h);f!==void 0&&er(f.mutation,d,ke.empty(),ae.now()),Vi(t,d)&&(l=l.insert(h,d))}),l})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee="WebChannelConnection";class py extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",i=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${i}/databases/${s}`,this.Co=this.databaseId.database==="(default)"?`project_id=${i}`:`project_id=${i}&database_id=${s}`}get Fo(){return!1}Mo(t,r,i,s,a){const l=Rs(),h=this.xo(t,r.toUriEncodedString());O("RestConnection",`Sending RPC '${t}' ${l}:`,h,i);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,s,a),this.No(t,h,d,i).then(f=>(O("RestConnection",`Received RPC '${t}' ${l}: `,f),f),f=>{throw un("RestConnection",`RPC '${t}' ${l} failed with error: `,f,"url: ",h,"request:",i),f})}Lo(t,r,i,s,a,l){return this.Mo(t,r,i,s,a)}Oo(t,r,i){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+En}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((s,a)=>t[a]=s),i&&i.headers.forEach((s,a)=>t[a]=s)}xo(t,r){const i=dy[t];return`${this.Do}/v1/${r}:${i}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,i){const s=Rs();return new Promise((a,l)=>{const h=new pu;h.setWithCredentials(!0),h.listenOnce(mu.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case ni.NO_ERROR:const f=h.getResponseJson();O(Ee,`XHR for RPC '${e}' ${s} received:`,JSON.stringify(f)),a(f);break;case ni.TIMEOUT:O(Ee,`RPC '${e}' ${s} timed out`),l(new N(S.DEADLINE_EXCEEDED,"Request time out"));break;case ni.HTTP_ERROR:const y=h.getStatus();if(O(Ee,`RPC '${e}' ${s} failed with status:`,y,"response text:",h.getResponseText()),y>0){let T=h.getResponseJson();Array.isArray(T)&&(T=T[0]);const R=T==null?void 0:T.error;if(R&&R.status&&R.message){const k=function(D){const G=D.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(G)>=0?G:S.UNKNOWN}(R.status);l(new N(k,R.message))}else l(new N(S.UNKNOWN,"Server responded with status "+h.getStatus()))}else l(new N(S.UNAVAILABLE,"Connection failed."));break;default:F()}}finally{O(Ee,`RPC '${e}' ${s} completed.`)}});const d=JSON.stringify(i);O(Ee,`RPC '${e}' ${s} sending request:`,i),h.send(t,"POST",d,r,15)})}Bo(e,t,r){const i=Rs(),s=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=yu(),l=_u(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.Oo(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const f=s.join("");O(Ee,`Creating RPC '${e}' stream ${i}: ${f}`,h);const y=a.createWebChannel(f,h);let T=!1,R=!1;const k=new fy({Io:D=>{R?O(Ee,`Not sending because RPC '${e}' stream ${i} is closed:`,D):(T||(O(Ee,`Opening RPC '${e}' stream ${i} transport.`),y.open(),T=!0),O(Ee,`RPC '${e}' stream ${i} sending:`,D),y.send(D))},To:()=>y.close()}),L=(D,G,K)=>{D.listen(G,Q=>{try{K(Q)}catch(ne){setTimeout(()=>{throw ne},0)}})};return L(y,zn.EventType.OPEN,()=>{R||(O(Ee,`RPC '${e}' stream ${i} transport opened.`),k.yo())}),L(y,zn.EventType.CLOSE,()=>{R||(R=!0,O(Ee,`RPC '${e}' stream ${i} transport closed`),k.So())}),L(y,zn.EventType.ERROR,D=>{R||(R=!0,un(Ee,`RPC '${e}' stream ${i} transport errored:`,D),k.So(new N(S.UNAVAILABLE,"The operation could not be completed")))}),L(y,zn.EventType.MESSAGE,D=>{var G;if(!R){const K=D.data[0];J(!!K);const Q=K,ne=Q.error||((G=Q[0])===null||G===void 0?void 0:G.error);if(ne){O(Ee,`RPC '${e}' stream ${i} received error:`,ne);const De=ne.status;let re=function(_){const v=se[_];if(v!==void 0)return qu(v)}(De),E=ne.message;re===void 0&&(re=S.INTERNAL,E="Unknown error status: "+De+" with message "+ne.message),R=!0,k.So(new N(re,E)),y.close()}else O(Ee,`RPC '${e}' stream ${i} received:`,K),k.bo(K)}}),L(l,gu.STAT_EVENT,D=>{D.stat===Fs.PROXY?O(Ee,`RPC '${e}' stream ${i} detected buffering proxy`):D.stat===Fs.NOPROXY&&O(Ee,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{k.wo()},0),k}}function Ss(){return typeof document!="undefined"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
