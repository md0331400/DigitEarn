 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ld=()=>Vd().__FIREBASE_DEFAULTS__,Od=()=>{if(typeof process=="undefined"||typeof sc=="undefined")return;const n=sc.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},Md=()=>{if(typeof document=="undefined")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=n&&Al(n[1]);return e&&JSON.parse(e)},Si=()=>{try{return Ld()||Od()||Md()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},bl=n=>{var e,t;return(t=(e=Si())===null||e===void 0?void 0:e.emulatorHosts)===null||t===void 0?void 0:t[n]},xd=n=>{const e=bl(n);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const r=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),r]:[e.substring(0,t),r]},Rl=()=>{var n;return(n=Si())===null||n===void 0?void 0:n.config},Sl=n=>{var e;return(e=Si())===null||e===void 0?void 0:e[`_${n}`]};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var q;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(q||(q={}));const af={debug:q.DEBUG,verbose:q.VERBOSE,info:q.INFO,warn:q.WARN,error:q.ERROR,silent:q.SILENT},cf=q.INFO,lf={[q.DEBUG]:"log",[q.VERBOSE]:"log",[q.INFO]:"info",[q.WARN]:"warn",[q.ERROR]:"error"},uf=(n,e,...t)=>{if(e<n.logLevel)return;const r=new Date().toISOString(),i=lf[e];if(i)console[i](`[${r}]  ${n.name}:`,...t);else throw new Error(`Attempted to log a message with an invalid logType (value: ${e})`)};class no{constructor(e){this.name=e,this._logLevel=cf,this._logHandler=uf,this._userLogHandler=null}get logLevel(){return this._logLevel}set logLevel(e){if(!(e in q))throw new TypeError(`Invalid value "${e}" assigned to \`logLevel\``);this._logLevel=e}setLogLevel(e){this._logLevel=typeof e=="string"?af[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if(typeof e!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}debug(...e){this._userLogHandler&&this._userLogHandler(this,q.DEBUG,...e),this._logHandler(this,q.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,q.VERBOSE,...e),this._logHandler(this,q.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,q.INFO,...e),this._logHandler(this,q.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,q.WARN,...e),this._logHandler(this,q.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,q.ERROR,...e),this._logHandler(this,q.ERROR,...e)}}const hf=(n,e)=>e.some(t=>n instanceof t);let ac,cc;function df(){return ac||(ac=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function ff(){return cc||(cc=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const Pl=new WeakMap,ks=new WeakMap,Cl=new WeakMap,vs=new WeakMap,ro=new WeakMap;function pf(n){const e=new Promise((t,r)=>{const i=()=>{n.removeEventListener("success",s),n.removeEventListener("error",a)},s=()=>{t(_t(n.result)),i()},a=()=>{r(n.error),i()};n.addEventListener("success",s),n.addEventListener("error",a)});return e.then(t=>{t instanceof IDBCursor&&Pl.set(t,n)}).catch(()=>{}),ro.set(e,n),e}function mf(n){if(ks.has(n))return;const e=new Promise((t,r)=>{const i=()=>{n.removeEventListener("complete",s),n.removeEventListener("error",a),n.removeEventListener("abort",a)},s=()=>{t(),i()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),i()};n.addEventListener("complete",s),n.addEventListener("error",a),n.addEventListener("abort",a)});ks.set(n,e)}let Ds={get(n,e,t){if(n instanceof IDBTransaction){if(e==="done")return ks.get(n);if(e==="objectStoreNames")return n.objectStoreNames||Cl.get(n);if(e==="store")return t.objectStoreNames[1]?void 0:t.objectStore(t.objectStoreNames[0])}return _t(n[e])},set(n,e,t){return n[e]=t,!0},has(n,e){return n instanceof IDBTransaction&&(e==="done"||e==="store")?!0:e in n}};function gf(n){Ds=n(Ds)}function _f(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(e,...t){const r=n.call(Es(this),e,...t);return Cl.set(r,e.sort?e.sort():[e]),_t(r)}:ff().includes(n)?function(...e){return n.apply(Es(this),e),_t(Pl.get(this))}:function(...e){return _t(n.apply(Es(this),e))}}function yf(n){return typeof n=="function"?_f(n):(n instanceof IDBTransaction&&mf(n),hf(n,df())?new Proxy(n,Ds):n)}function _t(n){if(n instanceof IDBRequest)return pf(n);if(vs.has(n))return vs.get(n);const e=yf(n);return e!==n&&(vs.set(n,e),ro.set(e,n)),e}const Es=n=>ro.get(n);function vf(n,e,{blocked:t,upgrade:r,blocking:i,terminated:s}={}){const a=indexedDB.open(n,e),c=_t(a);return r&&a.addEventListener("upgradeneeded",u=>{r(_t(a.result),u.oldVersion,u.newVersion,_t(a.transaction),u)}),t&&a.addEventListener("blocked",u=>t(u.oldVersion,u.newVersion,u)),c.then(u=>{s&&u.addEventListener("close",()=>s()),i&&u.addEventListener("versionchange",d=>i(d.oldVersion,d.newVersion,d))}).catch(()=>{}),c}const Ef=["get","getKey","getAll","getAllKeys","count"],wf=["put","add","delete","clear"],ws=new Map;function lc(n,e){if(!(n instanceof IDBDatabase&&!(e in n)&&typeof e=="string"))return;if(ws.get(e))return ws.get(e);const t=e.replace(/FromIndex$/,""),r=e!==t,i=wf.includes(t);if(!(t in(r?IDBIndex:IDBObjectStore).prototype)||!(i||Ef.includes(t)))return;const s=async function(a,...c){const u=this.transaction(a,i?"readwrite":"readonly");let d=u.store;return r&&(d=d.index(c.shift())),(await Promise.all([d[t](...c),i&&u.done]))[0]};return ws.set(e,s),s}gf(n=>({...n,get:(e,t,r)=>lc(e,t)||n.get(e,t,r),has:(e,t)=>!!lc(e,t)||n.has(e,t)}));/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tf{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(If(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function If(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const Ns="@firebase/app",uc="0.10.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tp="firebase-heartbeat-database",np=1,er="firebase-heartbeat-store";let Ts=null;function Nl(){return Ts||(Ts=vf(tp,np,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(er)}catch(t){console.warn(t)}}}}).catch(n=>{throw yt.create("idb-open",{originalErrorMessage:n.message})})),Ts}async function rp(n){try{const t=(await Nl()).transaction(er),r=await t.objectStore(er).get(Vl(n));return await t.done,r}catch(e){if(e instanceof st)tt.warn(e.message);else{const t=yt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});tt.warn(t.message)}}}async function dc(n,e){try{const r=(await Nl()).transaction(er,"readwrite");await r.objectStore(er).put(e,Vl(n)),await r.done}catch(t){if(t instanceof st)tt.warn(t.message);else{const r=yt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});tt.warn(r.message)}}}function Vl(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ip=1024,sp=30*24*60*60*1e3;class op{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new cp(t),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var e,t;try{const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),s=fc();return((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===s||this._heartbeatsCache.heartbeats.some(a=>a.date===s)?void 0:(this._heartbeatsCache.heartbeats.push({date:s,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(a=>{const c=new Date(a.date).valueOf();return Date.now()-c<=sp}),this._storage.overwrite(this._heartbeatsCache))}catch(r){tt.warn(r)}}async getHeartbeatsHeader(){var e;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=fc(),{heartbeatsToSend:r,unsentEntries:i}=ap(this._heartbeatsCache.heartbeats),s=hi(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(t){return tt.warn(t),""}}}function fc(){return new Date().toISOString().substring(0,10)}function ap(n,e=ip){const t=[];let r=n.slice();for(const i of n){const s=t.find(a=>a.agent===i.agent);if(s){if(s.dates.push(i.date),pc(t)>e){s.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),pc(t)>e){t.pop();break}r=r.slice(1)}return{heartbeatsToSend:t,unsentEntries:r}}class cp{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return Gd()?Kd().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await rp(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return dc(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return dc(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function pc(n){return hi(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lp(n){cn(new xt("platform-logger",e=>new Tf(e),"PRIVATE")),cn(new xt("heartbeat",e=>new op(e),"PRIVATE")),vt(Ns,uc,n),vt(Ns,uc,"esm2017"),vt("fire-js","")}lp("");var up="firebase",hp="10.14.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */vt(up,hp,"app");function so(n,e){var t={};for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&e.indexOf(r)<0&&(t[r]=n[r]);if(n!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,r=Object.getOwnPropertySymbols(n);i<r.length;i++)e.indexOf(r[i])<0&&Object.prototype.propertyIsEnumerable.call(n,r[i])&&(t[r[i]]=n[r[i]]);return t}function Ll(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const dp=Ll,Ol=new hr("auth","Firebase",Ll());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pi=new no("@firebase/auth");function fp(n,...e){pi.logLevel<=q.WARN&&pi.warn(`Auth (${_n}): ${n}`,...e)}function Zr(n,...e){pi.logLevel<=q.ERROR&&pi.error(`Auth (${_n}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Os(){var n;return typeof self!="undefined"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function pp(){return mc()==="http:"||mc()==="https:"}function mc(){var n;return typeof self!="undefined"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yp=new fr(3e4,6e4);function jt(n,e){return n.tenantId&&!e.tenantId?Object.assign(Object.assign({},e),{tenantId:n.tenantId}):e}async function bt(n,e,t,r,i={}){return Fl(n,i,async()=>{let s={},a={};r&&(e==="GET"?a=r:s={body:JSON.stringify(r)});const c=dr(Object.assign({key:n.config.apiKey},a)).slice(1),u=await n._getAdditionalHeaders();u["Content-Type"]="application/json",n.languageCode&&(u["X-Firebase-Locale"]=n.languageCode);const d=Object.assign({method:e,headers:u},s);return jd()||(d.referrerPolicy="no-referrer"),xl.fetch()(Ul(n,n.config.apiHost,t,c),d)})}async function Fl(n,e,t){n._canInitEmulator=!1;const r=Object.assign(Object.assign({},_p),e);try{const i=new Ep(n),s=await Promise.race([t(),i.promise]);i.clearNetworkTimeout();const a=await s.json();if("needConfirmation"in a)throw Wr(n,"account-exists-with-different-credential",a);if(s.ok&&!("errorMessage"in a))return a;{const c=s.ok?a.errorMessage:a.error.message,[u,d]=c.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw Wr(n,"credential-already-in-use",a);if(u==="EMAIL_EXISTS")throw Wr(n,"email-already-in-use",a);if(u==="USER_DISABLED")throw Wr(n,"user-disabled",a);const f=r[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw Ml(n,f,d);xe(n,f)}}catch(i){if(i instanceof st)throw i;xe(n,"network-request-failed",{message:String(i)})}}async function Pi(n,e,t,r,i={}){const s=await bt(n,e,t,r,i);return"mfaPendingCredential"in s&&xe(n,"multi-factor-auth-required",{_serverResponse:s}),s}function Ul(n,e,t,r){const i=`${e}${t}?${r}`;return n.config.emulator?ao(n.config,i):`${n.config.apiScheme}://${i}`}function vp(n){switch(n){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class Ep{constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,r)=>{this.timer=setTimeout(()=>r($e(this.auth,"network-request-failed")),yp.get())})}clearNetworkTimeout(){clearTimeout(this.timer)}}function Wr(n,e,t){const r={appName:n.name};t.email&&(r.email=t.email),t.phoneNumber&&(r.phoneNumber=t.phoneNumber);const i=$e(n,e,r);return i.customData._tokenResponse=t,i}function gc(n){return n!==void 0&&n.enterprise!==void 0}class wp{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const t of this.recaptchaEnforcementState)if(t.provider&&t.provider===e)return vp(t.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}}async function Tp(n,e){return bt(n,"GET","/v2/recaptchaConfig",jt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ip(n,e){return bt(n,"POST","/v1/accounts:delete",e)}async function $l(n,e){return bt(n,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mi(n){var e;const t=n.auth,r=await n.getIdToken(),i=await tr(n,$l(t,{idToken:r}));x(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const a=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Bl(s.providerUserInfo):[],c=Pp(n.providerData,a),u=n.isAnonymous,d=!(n.email&&s.passwordHash)&&!(c!=null&&c.length),f=u?d:!1,y={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:c,metadata:new Ms(s.createdAt,s.lastLoginAt),isAnonymous:f};Object.assign(n,y)}async function Sp(n){const e=ue(n);await mi(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Pp(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Bl(n){return n.map(e=>{var{providerId:t}=e,r=so(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cp(n,e){const t=await Fl(n,{},async()=>{const r=dr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:i,apiKey:s}=n.config,a=Ul(n,i,"/v1/token",`key=${s}`),c=await n._getAdditionalHeaders();return c["Content-Type"]="application/x-www-form-urlencoded",xl.fetch()(a,{method:"POST",headers:c,body:r})});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function kp(n,e){return bt(n,"POST","/v2/accounts:revokeToken",jt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yc=new Map;function Ze(n){nt(n instanceof Function,"Expected a class definition");let e=yc.get(n);return e?(nt(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,yc.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ec(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(zl(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(ql(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(Kl(e))return"Blackberry";if(Ql(e))return"Webos";if(Hl(e))return"Safari";if((e.includes("chrome/")||Wl(e))&&!e.includes("edge/"))return"Chrome";if(Gl(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function ql(n=Ie()){return/firefox\//i.test(n)}function Hl(n=Ie()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function Wl(n=Ie()){return/crios\//i.test(n)}function zl(n=Ie()){return/iemobile/i.test(n)}function Gl(n=Ie()){return/android/i.test(n)}function Kl(n=Ie()){return/blackberry/i.test(n)}function Ql(n=Ie()){return/webos/i.test(n)}function lo(n=Ie()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Dp(n=Ie()){var e;return lo(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Np(){return Wd()&&document.documentMode===10}function Jl(n=Ie()){return lo(n)||Gl(n)||Ql(n)||Kl(n)||/windows phone/i.test(n)||zl(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yl(n,e=[]){let t;switch(n){case"Browser":t=Ec(Ie());break;case"Worker":t=`${Ec(Ie())}-${n}`;break;default:t=n}const r=e.length?e.join(","):"FirebaseCore-web";return`${t}/JsCore/${_n}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wp(n,e){const t=io(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(di(s,e!=null?e:{}))return i;xe(i,"already-initialized")}return t.initialize({options:e})}function zp(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Ze);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Gp(n,e,t){const r=yn(n);x(r._canInitEmulator,r,"emulator-config-failed"),x(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=Zl(e),{host:a,port:c}=Kp(e),u=c===null?"":`:${c}`;r.config.emulator={url:`${s}//${a}${u}/`},r.settings.appVerificationDisabledForTesting=!0,r.emulatorConfig=Object.freeze({host:a,port:c,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})}),Qp()}function Zl(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Kp(n){const e=Zl(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:Ac(r.substr(s.length+1))}}else{const[s,a]=r.split(":");return{host:s,port:Ac(a)}}}function Ac(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Qp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console!="undefined"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window!="undefined"&&typeof document!="undefined"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function tm(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function nm(n){const e=qn(Hn(n)).link,t=e?qn(Hn(e)).deep_link_id:null,r=qn(Hn(n)).deep_link_id;return(r?qn(Hn(r)).link:null)||r||t||e||n}class ho{constructor(e){var t,r,i,s,a,c;const u=qn(Hn(e)),d=(t=u.apiKey)!==null&&t!==void 0?t:null,f=(r=u.oobCode)!==null&&r!==void 0?r:null,y=tm((i=u.mode)!==null&&i!==void 0?i:null);x(d&&f&&y,"argument-error"),this.apiKey=d,this.operation=y,this.code=f,this.continueUrl=(s=u.continueUrl)!==null&&s!==void 0?s:null,this.languageCode=(a=u.languageCode)!==null&&a!==void 0?a:null,this.tenantId=(c=u.tenantId)!==null&&c!==void 0?c:null}static parseLink(e){const t=nm(e);try{return new ho(t)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function nu(n,e,t=!1){if(Je(n.app))return Promise.reject(Et(n));const r="signIn",i=await tu(n,r,e),s=await ln._fromIdTokenResponse(n,r,i);return t||await n._updateCurrentUser(s.user),s}async function sm(n,e){return nu(yn(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iu{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(_i,"1"),this.storage.removeItem(_i),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class po extends uo{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return on(e,this._buildIdpRequest())}_linkToIdToken(e,t){return on(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return on(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Sm(n){return nu(n.auth,new po(n),n.bypassAuthState)}function Pm(n){const{auth:e,user:t}=n;return x(t,e,"internal-error"),im(t,new po(n),n.bypassAuthState)}async function Cm(n){const{auth:e,user:t}=n;return x(t,e,"internal-error"),rm(t,new po(n),n.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fm=10*60*1e3;class Um{constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}registerConsumer(e){this.consumers.add(e),this.queuedRedirectEvent&&this.isEventForConsumer(this.queuedRedirectEvent,e)&&(this.sendToConsumer(this.queuedRedirectEvent,e),this.saveEventToCache(this.queuedRedirectEvent),this.queuedRedirectEvent=null)}unregisterConsumer(e){this.consumers.delete(e)}onEvent(e){if(this.hasEventBeenHandled(e))return!1;let t=!1;return this.consumers.forEach(r=>{this.isEventForConsumer(e,r)&&(t=!0,this.sendToConsumer(e,r),this.saveEventToCache(e))}),this.hasHandledPotentialRedirect||!$m(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var r;if(e.error&&!fu(e)){const i=((r=e.error.code)===null||r===void 0?void 0:r.split("auth/")[1])||"internal-error";t.onError($e(this.auth,i))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const r=t.eventId===null||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&r}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=Fm&&this.cachedEventUids.clear(),this.cachedEventUids.has(Pc(e))}saveEventToCache(e){this.cachedEventUids.add(Pc(e)),this.lastProcessedEventTime=Date.now()}}function Pc(n){return[n.type,n.eventId,n.sessionId,n.tenantId].filter(e=>e).join("-")}function fu({type:n,error:e}){return n==="unknown"&&(e==null?void 0:e.code)==="auth/no-auth-event"}function $m(n){switch(n.type){case"signInViaRedirect":case"linkViaRedirect":case"reauthViaRedirect":return!0;case"unknown":return fu(n);default:return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zm=new fr(3e4,6e4);function Cc(){const n=Be().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Gm(n){return new Promise((e,t)=>{var r,i,s;function a(){Cc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Cc(),t($e(n,"network-request-failed"))},timeout:zm.get()})}if(!((i=(r=Be().gapi)===null||r===void 0?void 0:r.iframes)===null||i===void 0)&&i.Iframe)e(gapi.iframes.getContext());else if(!((s=Be().gapi)===null||s===void 0)&&s.load)a();else{const c=Bp("iframefcb");return Be()[c]=()=>{gapi.load?a():t($e(n,"network-request-failed"))},Xl(`${$p()}?onload=${c}`).catch(u=>t(u))}}).catch(e=>{throw ni=null,e})}let ni=null;function Km(n){return ni=ni||Gm(n),ni}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ng={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},rg=500,ig=600,sg="_blank",og="http://localhost";class kc{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch{}}}function ag(n,e,t,r=rg,i=ig){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),a=Math.max((window.screen.availWidth-r)/2,0).toString();let c="";const u=Object.assign(Object.assign({},ng),{width:r.toString(),height:i.toString(),top:s,left:a}),d=Ie().toLowerCase();t&&(c=Wl(d)?sg:t),ql(d)&&(e=e||og,u.scrollbars="yes");const f=Object.entries(u).reduce((E,[R,k])=>`${E}${R}=${k},`,"");if(Dp(d)&&c!=="_self")return cg(e||"",c),new kc(null);const y=window.open(e||"",c,f);x(y,n,"popup-blocked");try{y.focus()}catch{}return new kc(y)}function cg(n,e){const t=document.createElement("a");t.href=n,t.target=e;const r=document.createEvent("MouseEvent");r.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),t.dispatchEvent(r)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lg="__/auth/handler",ug="emulator/auth/handler",hg=encodeURIComponent("fac");async function Dc(n,e,t,r,i,s){x(n.config.authDomain,n,"auth-domain-config-required"),x(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:_n,eventId:i};if(e instanceof eu){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",Xd(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,y]of Object.entries({}))a[f]=y}if(e instanceof pr){const f=e.getScopes().filter(y=>y!=="");f.length>0&&(a.scopes=f.join(","))}n.tenantId&&(a.tid=n.tenantId);const c=a;for(const f of Object.keys(c))c[f]===void 0&&delete c[f];const u=await n._getAppCheckToken(),d=u?`#${hg}=${encodeURIComponent(u)}`:"";return`${dg(n)}?${dr(c).slice(1)}${d}`}function dg({config:n}){return n.emulator?ao(n,ug):`https://${n.authDomain}/${lg}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gg(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function _g(n){cn(new xt("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:a,authDomain:c}=r.options;x(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const u={apiKey:a,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Yl(n)},d=new xp(r,i,s,u);return zp(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),cn(new xt("auth-internal",e=>{const t=yn(e.getProvider("auth").getImmediate());return(r=>new mg(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),vt(Nc,Vc,gg(n)),vt(Nc,Vc,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yg=5*60,vg=Sl("authIdTokenMaxAge")||yg;let Lc=null;const Eg=n=>async e=>{const t=e&&await e.getIdTokenResult(),r=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(r&&r>vg)return;const i=t==null?void 0:t.token;Lc!==i&&(Lc=i,await fetch(n,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function wg(n=Dl()){const e=io(n,"auth");if(e.isInitialized())return e.getImmediate();const t=Wp(n,{popupRedirectResolver:pg,persistence:[bm,fm,au]}),r=Sl("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(r,location.origin);if(location.origin===s.origin){const a=Eg(s.toString());lm(t,a,()=>a(t.currentUser)),cm(t,c=>a(c))}}const i=bl("auth");return i&&Gp(t,`http://${i}`),t}function Tg(){var n,e;return(e=(n=document.getElementsByTagName("head"))===null||n===void 0?void 0:n[0])!==null&&e!==void 0?e:document}Fp({loadJS(n){return new Promise((e,t)=>{const r=document.createElement("script");r.setAttribute("src",n),r.onload=e,r.onerror=i=>{const s=$e("internal-error");s.customData=i,t(s)},r.type="text/javascript",r.charset="UTF-8",Tg().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});_g("Browser");var Oc=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{};/** @license
...
*/var Mt,pu;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(w,m){function _(){}_.prototype=m.prototype,w.D=m.prototype,w.prototype=new _,w.prototype.constructor=w,w.C=function(v,T,A){for(var g=Array(arguments.length-2),Ge=2;Ge<arguments.length;Ge++)g[Ge-2]=arguments[Ge];return m.prototype[T].apply(v,g)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(w,m,_){_||(_=0);var v=Array(16);if(typeof m=="string")for(var T=0;16>T;++T)v[T]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(T=0;16>T;++T)v[T]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=w.g[0],_=w.g[1],T=w.g[2];var A=w.g[3],g=m+(A^_&(T^A))+v[0]+3614090360&4294967295;m=_+(g<<7&4294967295|g>>>25),g=A+(T^m&(_^T))+v[1]+3905402710&4294967295,A=m+(g<<12&4294967295|g>>>20),g=T+(_^A&(m^_))+v[2]+606105819&4294967295,T=A+(g<<17&4294967295|g>>>15),g=_+(m^T&(A^m))+v[3]+3250441966&4294967295,_=T+(g<<22&4294967295|g>>>10),g=m+(A^_&(T^A))+v[4]+4118548399&4294967295,m=_+(g<<7&4294967295|g>>>25),g=A+(T^m&(_^T))+v[5]+1200080426&4294967295,A=m+(g<<12&4294967295|g>>>20),g=T+(_^A&(m^_))+v[6]+2821735955&4294967295,T=A+(g<<17&4294967295|g>>>15),g=_+(m^T&(A^m))+v[7]+4249261313&4294967295,_=T+(g<<22&4294967295|g>>>10),g=m+(A^_&(T^A))+v[8]+1770035416&4294967295,m=_+(g<<7&4294967295|g>>>25),g=A+(T^m&(_^T))+v[9]+2336552879&4294967295,A=m+(g<<12&4294967295|g>>>20),g=T+(_^A&(m^_))+v[10]+4294925233&4294967295,T=A+(g<<17&4294967295|g>>>15),g=_+(m^T&(A^m))+v[11]+2304563134&4294967295,_=T+(g<<22&4294967295|g>>>10),g=m+(A^_&(T^A))+v[12]+1804603682&4294967295,m=_+(g<<7&4294967295|g>>>25),g=A+(T^m&(_^T))+v[13]+4254626195&4294967295,A=m+(g<<12&4294967295|g>>>20),g=T+(_^A&(m^_))+v[14]+2792965006&4294967295,T=A+(g<<17&4294967295|g>>>15),g=_+(m^T&(A^m))+v[15]+1236535329&4294967295,_=T+(g<<22&4294967295|g>>>10),g=m+(T^A&(_^T))+v[1]+4129170786&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^T&(m^_))+v[6]+3225465664&4294967295,A=m+(g<<9&4294967295|g>>>23),g=T+(m^_&(A^m))+v[11]+643717713&4294967295,T=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(T^A))+v[0]+3921069994&4294967295,_=T+(g<<20&4294967295|g>>>12),g=m+(T^A&(_^T))+v[5]+3593408605&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^T&(m^_))+v[10]+38016083&4294967295,A=m+(g<<9&4294967295|g>>>23),g=T+(m^_&(A^m))+v[15]+3634488961&4294967295,T=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(T^A))+v[4]+3889429448&4294967295,_=T+(g<<20&4294967295|g>>>12),g=m+(T^A&(_^T))+v[9]+568446438&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^T&(m^_))+v[14]+3275163606&4294967295,A=m+(g<<9&4294967295|g>>>23),g=T+(m^_&(A^m))+v[3]+4107603335&4294967295,T=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(T^A))+v[8]+1163531501&4294967295,_=T+(g<<20&4294967295|g>>>12),g=m+(T^A&(_^T))+v[13]+2850285829&4294967295,m=_+(g<<5&4294967295|g>>>27),g=A+(_^T&(m^_))+v[2]+4243563512&4294967295,A=m+(g<<9&4294967295|g>>>23),g=T+(m^_&(A^m))+v[7]+1735328473&4294967295,T=A+(g<<14&4294967295|g>>>18),g=_+(A^m&(T^A))+v[12]+2368359562&4294967295,_=T+(g<<20&4294967295|g>>>12),g=m+(_^T^A)+v[5]+4294588738&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^T)+v[8]+2272392833&4294967295,A=m+(g<<11&4294967295|g>>>21),g=T+(A^m^_)+v[11]+1839030562&4294967295,T=A+(g<<16&4294967295|g>>>16),g=_+(T^A^m)+v[14]+4259657740&4294967295,_=T+(g<<23&4294967295|g>>>9),g=m+(_^T^A)+v[1]+2763975236&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^T)+v[4]+1272893353&4294967295,A=m+(g<<11&4294967295|g>>>21),g=T+(A^m^_)+v[7]+4139469664&4294967295,T=A+(g<<16&4294967295|g>>>16),g=_+(T^A^m)+v[10]+3200236656&4294967295,_=T+(g<<23&4294967295|g>>>9),g=m+(_^T^A)+v[13]+681279174&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^T)+v[0]+3936430074&4294967295,A=m+(g<<11&4294967295|g>>>21),g=T+(A^m^_)+v[3]+3572445317&4294967295,T=A+(g<<16&4294967295|g>>>16),g=_+(T^A^m)+v[6]+76029189&4294967295,_=T+(g<<23&4294967295|g>>>9),g=m+(_^T^A)+v[9]+3654602809&4294967295,m=_+(g<<4&4294967295|g>>>28),g=A+(m^_^T)+v[12]+3873151461&4294967295,A=m+(g<<11&4294967295|g>>>21),g=T+(A^m^_)+v[15]+530742520&4294967295,T=A+(g<<16&4294967295|g>>>16),g=_+(T^A^m)+v[2]+3299628645&4294967295,_=T+(g<<23&4294967295|g>>>9),g=m+(T^(_|~A))+v[0]+4096336452&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~T))+v[7]+1126891415&4294967295,A=m+(g<<10&4294967295|g>>>22),g=T+(m^(A|~_))+v[14]+2878612391&4294967295,T=A+(g<<15&4294967295|g>>>17),g=_+(A^(T|~m))+v[5]+4237533241&4294967295,_=T+(g<<21&4294967295|g>>>11),g=m+(T^(_|~A))+v[12]+1700485571&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~T))+v[3]+2399980690&4294967295,A=m+(g<<10&4294967295|g>>>22),g=T+(m^(A|~_))+v[10]+4293915773&4294967295,T=A+(g<<15&4294967295|g>>>17),g=_+(A^(T|~m))+v[1]+2240044497&4294967295,_=T+(g<<21&4294967295|g>>>11),g=m+(T^(_|~A))+v[8]+1873313359&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~T))+v[15]+4264355552&4294967295,A=m+(g<<10&4294967295|g>>>22),g=T+(m^(A|~_))+v[6]+2734768916&4294967295,T=A+(g<<15&4294967295|g>>>17),g=_+(A^(T|~m))+v[13]+1309151649&4294967295,_=T+(g<<21&4294967295|g>>>11),g=m+(T^(_|~A))+v[4]+4149444226&4294967295,m=_+(g<<6&4294967295|g>>>26),g=A+(_^(m|~T))+v[11]+3174756917&4294967295,A=m+(g<<10&4294967295|g>>>22),g=T+(m^(A|~_))+v[2]+718787259&4294967295,T=A+(g<<15&4294967295|g>>>17),g=_+(A^(T|~m))+v[9]+3951481745&4294967295,w.g[0]=w.g[0]+m&4294967295,w.g[1]=w.g[1]+(T+(g<<21&4294967295|g>>>11))&4294967295,w.g[2]=w.g[2]+T&4294967295,w.g[3]=w.g[3]+A&4294967295}r.prototype.u=function(w,m){m===void 0&&(m=w.length);for(var _=m-this.blockSize,v=this.B,T=this.h,A=0;A<m;){if(T==0)for(;A<=_;)i(this,w,A),A+=this.blockSize;if(typeof w=="string"){for(;A<m;)if(v[T++]=w.charCodeAt(A++),T==this.blockSize){i(this,v),T=0;break}}else for(;A<m;)if(v[T++]=w[A++],T==this.blockSize){i(this,v),T=0;break}}this.h=T,this.o+=m},r.prototype.v=function(){var w=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);w[0]=128;for(var m=1;m<w.length-8;++m)w[m]=0;var _=8*this.o;for(m=w.length-8;m<w.length;++m)w[m]=_&255,_/=256;for(this.u(w),w=Array(16),m=_=0;4>m;++m)for(var v=0;32>v;v+=8)w[_++]=this.g[m]>>>v&255;return w};function s(w,m){var _=c;return Object.prototype.hasOwnProperty.call(_,w)?_[w]:_[w]=m(w)}function a(w,m){this.h=m;for(var _=[],v=!0,T=w.length-1;0<=T;T--){var A=w[T]|0;v&&A==m||(_[T]=A,v=!1)}this.g=_}var c={};function u(w){return-128<=w&&128>w?s(w,function(m){return new a([m|0],0>m?-1:0)}):new a([w|0],0>w?-1:0)}function d(w){if(isNaN(w)||!isFinite(w))return y;if(0>w)return N(d(-w));for(var m=[],_=1,v=0;w>=_;v++)m[v]=w/_|0,_*=4294967296;return new a(m,0)}function f(w,m){if(w.length==0)throw Error("number format error: empty string");if(m=m||10,2>m||36<m)throw Error("radix out of range: "+m);if(w.charAt(0)=="-")return N(f(w.substring(1),m));if(0<=w.indexOf("-"))throw Error('number format error: interior "-" character');for(var _=d(Math.pow(m,8)),v=y,T=0;T<w.length;T+=8){var A=Math.min(8,w.length-T),g=parseInt(w.substring(T,T+A),m);8>A?(A=d(Math.pow(m,A)),v=v.j(A).add(d(g))):(v=v.j(_),v=v.add(d(g)))}return v}var y=u(0),E=u(1),R=u(16777216);n=a.prototype,n.m=function(){if(O(this))return-N(this).m();for(var w=0,m=1,_=0;_<this.g.length;_++){var v=this.i(_);w+=(0<=v?v:4294967296+v)*m,m*=4294967296}return w},n.toString=function(w){if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(k(this))return"0";if(O(this))return"-"+N(this).toString(w);for(var m=d(Math.pow(w,6)),_=this,v="";;){var T=ne(_,m).g;_=G(_,T.j(m));var A=((0<_.g.length?_.g[0]:_.h)>>>0).toString(w);if(_=T,k(_))return A+v;for(;6>A.length;)A="0"+A;v=A+v}},n.i=function(w){return 0>w?0:w<this.g.length?this.g[w]:this.h};function k(w){if(w.h!=0)return!1;for(var m=0;m<w.g.length;m++)if(w.g[m]!=0)return!1;return!0}function O(w){return w.h==-1}n.l=function(w){return w=G(this,w),O(w)?-1:k(w)?0:1};function N(w){for(var m=w.g.length,_=[],v=0;v<m;v++)_[v]=~w.g[v];return new a(_,~w.h).add(E)}n.abs=function(){return O(this)?N(this):this},n.add=function(w){for(var m=Math.max(this.g.length,w.g.length),_=[],v=0,T=0;T<=m;T++){var A=v+(this.i(T)&65535)+(w.i(T)&65535),g=(A>>>16)+(this.i(T)>>>16)+(w.i(T)>>>16);v=g>>>16,A&=65535,g&=65535,_[T]=g<<16|A}return new a(_,_[_.length-1]&-2147483648?-1:0)};function G(w,m){return w.add(N(m))}n.j=function(w){if(k(this)||k(w))return y;if(O(this))return O(w)?N(this).j(N(w)):N(N(this).j(w));if(O(w))return N(this.j(N(w)));if(0>this.l(R)&&0>w.l(R))return d(this.m()*w.m());for(var m=this.g.length+w.g.length,_=[],v=0;v<2*m;v++)_[v]=0;for(v=0;v<this.g.length;v++)for(var T=0;T<w.g.length;T++){var A=this.i(v)>>>16,g=this.i(v)&65535,Ge=w.i(T)>>>16,bn=w.i(T)&65535;_[2*v+2*T]+=g*bn,K(_,2*v+2*T),_[2*v+2*T+1]+=A*bn,K(_,2*v+2*T+1),_[2*v+2*T+1]+=g*Ge,K(_,2*v+2*T+1),_[2*v+2*T+2]+=A*Ge,K(_,2*v+2*T+2)}for(v=0;v<m;v++)_[v]=_[2*v+1]<<16|_[2*v];for(v=m;v<2*m;v++)_[v]=0;return new a(_,0)};function K(w,m){for(;(w[m]&65535)!=w[m];)w[m+1]+=w[m]>>>16,w[m]&=65535,m++}function Q(w,m){this.g=w,this.h=m}function ne(w,m){if(k(m))throw Error("division by zero");if(k(w))return new Q(y,y);if(O(w))return m=ne(N(w),m),new Q(N(m.g),N(m.h));if(O(m))return m=ne(w,N(m)),new Q(N(m.g),m.h);if(30<w.g.length){if(O(w)||O(m))throw Error("slowDivide_ only works with positive integers.");for(var _=E,v=m;0>=v.l(w);)_=Ne(_),v=Ne(v);var T=re(_,1),A=re(v,1);for(v=re(v,2),_=re(_,2);!k(v);){var g=A.add(v);0>=g.l(w)&&(T=T.add(_),A=g),v=re(v,1),_=re(_,1)}return m=G(w,T.j(m)),new Q(T,m)}for(T=y;0<=w.l(m);){for(_=Math.max(1,Math.floor(w.m()/m.m())),v=Math.ceil(Math.log(_)/Math.LN2),v=48>=v?1:Math.pow(2,v-48),A=d(_),g=A.j(m);O(g)||0<g.l(w);)_-=v,A=d(_),g=A.j(m);k(A)&&(A=E),T=T.add(A),w=G(w,g)}return new Q(T,w)}n.A=function(w){return ne(this,w).h},n.and=function(w){for(var m=Math.max(this.g.length,w.g.length),_=[],v=0;v<m;v++)_[v]=this.i(v)&w.i(v);return new a(_,this.h&w.h)},n.or=function(w){for(var m=Math.max(this.g.length,w.g.length),_=[],v=0;v<m;v++)_[v]=this.i(v)|w.i(v);return new a(_,this.h|w.h)},n.xor=function(w){for(var m=Math.max(this.g.length,w.g.length),_=[],v=0;v<m;v++)_[v]=this.i(v)^w.i(v);return new a(_,this.h^w.h)};function Ne(w){for(var m=w.g.length+1,_=[],v=0;v<m;v++)_[v]=w.i(v)<<1|w.i(v-1)>>>31;return new a(_,w.h)}function re(w,m){var _=m>>5;m%=32;for(var v=w.g.length-_,T=[],A=0;A<v;A++)T[A]=0<m?w.i(A+_)>>>m|w.i(A+_+1)<<32-m:w.i(A+_);return new a(T,w.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,pu=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=f,Mt=a}).apply(typeof Oc!="undefined"?Oc:typeof self!="undefined"?self:typeof window!="undefined"?window:{});var zr=typeof globalThis!="undefined"?globalThis:typeof window!="undefined"?window:typeof global!="undefined"?global:typeof self!="undefined"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var mu,Wn,gu,ri,Fs,_u,yu,vu;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(o,l,h){return o==Array.prototype||o==Object.prototype||(o[l]=h.value),o};function t(o){o=[typeof globalThis=="object"&&globalThis,o,typeof window=="object"&&window,typeof self=="object"&&self,typeof zr=="object"&&zr];for(var l=0;l<o.length;++l){var h=o[l];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var r=t(this);function i(o,l){if(l)e:{var h=r;o=o.split(".");for(var p=0;p<o.length-1;p++){var I=o[p];if(!(I in h))break e;h=h[I]}o=o[o.length-1],p=h[o],l=l(p),l!=p&&l!=null&&e(h,o,{configurable:!0,writable:!0,value:l})}}function s(o,l){o instanceof String&&(o+="");var h=0,p=!1,I={next:function(){if(!p&&h<o.length){var b=h++;return{value:l(b,o[b]),done:!1}}return p=!0,{done:!0,value:void 0}}};return I[Symbol.iterator]=function(){return I},I}i("Array.prototype.values",function(o){return o||function(){return s(this,function(l,h){return h})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var a=a||{},c=this||self;function u(o){var l=typeof o;return l=l!="object"?l:o?Array.isArray(o)?"array":l:"null",l=="array"||l=="object"&&typeof o.length=="number"}function d(o){var l=typeof o;return l=="object"&&o!=null||l=="function"}function f(o,l,h){return o.call.apply(o.bind,arguments)}function y(o,l,h){if(!o)throw Error();if(2<arguments.length){var p=Array.prototype.slice.call(arguments,2);return function(){var I=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(I,p),o.apply(l,I)}}return function(){return o.apply(l,arguments)}}function E(o,l,h){return E=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:y,E.apply(null,arguments)}function R(o,l){var h=Array.prototype.slice.call(arguments,1);return function(){var p=h.slice();return p.push.apply(p,arguments),o.apply(this,p)}}function k(o,l){function h(){}h.prototype=l.prototype,o.aa=l.prototype,o.prototype=new h,o.prototype.constructor=o,o.Qb=function(p,I,b){for(var C=Array(arguments.length-2),Y=2;Y<arguments.length;Y++)C[Y-2]=arguments[Y];return l.prototype[I].apply(p,C)}}function O(o){const l=o.length;if(0<l){const h=Array(l);for(let p=0;p<l;p++)h[p]=o[p];return h}return[]}function N(o,l){for(let h=1;h<arguments.length;h++){const p=arguments[h];if(u(p)){const I=o.length||0,b=p.length||0;o.length=I+b;for(let C=0;C<b;C++)o[I+C]=p[C]}else o.push(p)}}class G{constructor(l,h){this.i=l,this.j=h,this.h=0,this.g=null}get(){let l;return 0<this.h?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function K(o){return/^[\s\xa0]*$/.test(o)}function Q(){var o=c.navigator;return o&&(o=o.userAgent)?o:""}function ne(o){return ne[" "](o),o}ne[" "]=function(){};var Ne=Q().indexOf("Gecko")!=-1&&!(Q().toLowerCase().indexOf("webkit")!=-1&&Q().indexOf("Edge")==-1)&&!(Q().indexOf("Trident")!=-1||Q().indexOf("MSIE")!=-1)&&Q().indexOf("Edge")==-1;function re(o,l,h){for(const p in o)l.call(h,o[p],p,o)}function w(o,l){for(const h in o)l.call(void 0,o[h],h,o)}function m(o){const l={};for(const h in o)l[h]=o[h];return l}const _="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function v(o,l){let h,p;for(let I=1;I<arguments.length;I++){p=arguments[I];for(h in p)o[h]=p[h];for(let b=0;b<_.length;b++)h=_[b],Object.prototype.hasOwnProperty.call(p,h)&&(o[h]=p[h])}}function T(o){var l=1;o=o.split(":");const h=[];for(;0<l&&o.length;)h.push(o.shift()),l--;return o.length&&h.push(o.join(":")),h}function A(o){c.setTimeout(()=>{throw o},0)}function g(){var o=Ki;let l=null;return o.g&&(l=o.g,o.g=o.g.next,o.g||(o.h=null),l.next=null),l}class Ge{constructor(){this.h=this.g=null}add(l,h){const p=bn.get();p.set(l,h),this.h?this.h.next=p:this.g=p,this.h=p}}var bn=new G(()=>new Qh,o=>o.reset());class Qh{constructor(){this.next=this.g=this.h=null}set(l,h){this.h=l,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let Rn,Sn=!1,Ki=new Ge,sa=()=>{const o=c.Promise.resolve(void 0);Rn=()=>{o.then(Jh)}};var Jh=()=>{for(var o;o=g();){try{o.h.call(o.g)}catch(h){A(h)}var l=bn;l.j(o),100>l.h&&(l.h++,o.next=l.g,l.g=o)}Sn=!1};function at(){this.s=this.s,this.C=this.C}at.prototype.s=!1,at.prototype.ma=function(){this.s||(this.s=!0,this.N())},at.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ge(o,l){this.type=o,this.g=this.target=l,this.defaultPrevented=!1}ge.prototype.h=function(){this.defaultPrevented=!0};var Yh=function(){if(!c.addEventListener||!Object.defineProperty)return!1;var o=!1,l=Object.defineProperty({},"passive",{get:function(){o=!0}});try{const h=()=>{};c.addEventListener("test",h,l),c.removeEventListener("test",h,l)}catch{}return o}();function Pn(o,l){if(ge.call(this,o?o.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,o){var h=this.type=o.type,p=o.changedTouches&&o.changedTouches.length?o.changedTouches[0]:null;if(this.target=o.target||o.srcElement,this.g=l,l=o.relatedTarget){if(Ne){e:{try{ne(l.nodeName);var I=!0;break e}catch{}I=!1}I||(l=null)}}else h=="mouseover"?l=o.fromElement:h=="mouseout"&&(l=o.toElement);this.relatedTarget=l,p?(this.clientX=p.clientX!==void 0?p.clientX:p.pageX,this.clientY=p.clientY!==void 0?p.clientY:p.pageY,this.screenX=p.screenX||0,this.screenY=p.screenY||0):(this.clientX=o.clientX!==void 0?o.clientX:o.pageX,this.clientY=o.clientY!==void 0?o.clientY:o.pageY,this.screenX=o.screenX||0,this.screenY=o.screenY||0),this.button=o.button,this.key=o.key||"",this.ctrlKey=o.ctrlKey,this.altKey=o.altKey,this.shiftKey=o.shiftKey,this.metaKey=o.metaKey,this.pointerId=o.pointerId||0,this.pointerType=typeof o.pointerType=="string"?o.pointerType:Xh[o.pointerType]||"",this.state=o.state,this.i=o,o.defaultPrevented&&Pn.aa.h.call(this)}}k(Pn,ge);var Xh={2:"touch",3:"pen",4:"mouse"};Pn.prototype.h=function(){Pn.aa.h.call(this);var o=this.i;o.preventDefault?o.preventDefault():o.returnValue=!1};var Rr="closure_listenable_"+(1e6*Math.random()|0),Zh=0;function ed(o,l,h,p,I){this.listener=o,this.proxy=null,this.src=l,this.type=h,this.capture=!!p,this.ha=I,this.key=++Zh,this.da=this.fa=!1}function Sr(o){o.da=!0,o.listener=null,o.proxy=null,o.src=null,o.ha=null}function Pr(o){this.src=o,this.g={},this.h=0}Pr.prototype.add=function(o,l,h,p,I){var b=o.toString();o=this.g[b],o||(o=this.g[b]=[],this.h++);var C=Ji(o,l,p,I);return-1<C?(l=o[C],h||(l.fa=!1)):(l=new ed(l,this.src,b,!!p,I),l.fa=h,o.push(l)),l};function Qi(o,l){var h=l.type;if(h in o.g){var p=o.g[h],I=Array.prototype.indexOf.call(p,l,void 0),b;(b=0<=I)&&Array.prototype.splice.call(p,I,1),b&&(Sr(l),o.g[h].length==0&&(delete o.g[h],o.h--))}}function Ji(o,l,h,p){for(var I=0;I<o.length;++I){var b=o[I];if(!b.da&&b.listener==l&&b.capture==!!h&&b.ha==p)return I}return-1}var Yi="closure_lm_"+(1e6*Math.random()|0),Xi={};function oa(o,l,h,p,I){if(Array.isArray(l)){for(var b=0;b<l.length;b++)oa(o,l[b],h,p,I);return null}return h=la(h),o&&o[Rr]?o.K(l,h,d(p)?!!p.capture:!1,I):td(o,l,h,!1,p,I)}function td(o,l,h,p,I,b){if(!l)throw Error("Invalid event type");var C=d(I)?!!I.capture:!!I,Y=es(o);if(Y||(o[Yi]=Y=new Pr(o)),h=Y.add(l,h,p,C,b),h.proxy)return h;if(p=nd(),h.proxy=p,p.src=o,p.listener=h,o.addEventListener)Yh||(I=C),I===void 0&&(I=!1),o.addEventListener(l.toString(),p,I);else if(o.attachEvent)o.attachEvent(ca(l.toString()),p);else if(o.addListener&&o.removeListener)o.addListener(p);else throw Error("addEventListener and attachEvent are unavailable.");return h}function nd(){function o(h){return l.call(o.src,o.listener,h)}const l=rd;return o}function aa(o,l,h,p,I){if(Array.isArray(l))for(var b=0;b<l.length;b++)aa(o,l[b],h,p,I);else p=d(p)?!!p.capture:!!p,h=la(h),o&&o[Rr]?(o=o.i,l=String(l).toString(),l in o.g&&(b=o.g[l],h=Ji(b,h,p,I),-1<h&&(Sr(b[h]),Array.prototype.splice.call(b,h,1),b.length==0&&(delete o.g[l],o.h--)))):o&&(o=es(o))&&(l=o.g[l.toString()],o=-1,l&&(o=Ji(l,h,p,I)),(h=-1<o?l[o]:null)&&Zi(h))}function Zi(o){if(typeof o!="number"&&o&&!o.da){var l=o.src;if(l&&l[Rr])Qi(l.i,o);else{var h=o.type,p=o.proxy;l.removeEventListener?l.removeEventListener(h,p,o.capture):l.detachEvent?l.detachEvent(ca(h),p):l.addListener&&l.removeListener&&l.removeListener(p),(h=es(l))?(Qi(h,o),h.h==0&&(h.src=null,l[Yi]=null)):Sr(o)}}}function ca(o){return o in Xi?Xi[o]:Xi[o]="on"+o}function rd(o,l){if(o.da)o=!0;else{l=new Pn(l,this);var h=o.listener,p=o.ha||o.src;o.fa&&Zi(o),o=h.call(p,l)}return o}function es(o){return o=o[Yi],o instanceof Pr?o:null}var ts="__closure_events_fn_"+(1e9*Math.random()>>>0);function la(o){return typeof o=="function"?o:(o[ts]||(o[ts]=function(l){return o.handleEvent(l)}),o[ts])}function _e(){at.call(this),this.i=new Pr(this),this.M=this,this.F=null}k(_e,at),_e.prototype[Rr]=!0,_e.prototype.removeEventListener=function(o,l,h,p){aa(this,o,l,h,p)};function Ae(o,l){var h,p=o.F;if(p)for(h=[];p;p=p.F)h.push(p);if(o=o.M,p=l.type||l,typeof l=="string")l=new ge(l,o);else if(l instanceof ge)l.target=l.target||o;else{var I=l;l=new ge(p,o),v(l,I)}if(I=!0,h)for(var b=h.length-1;0<=b;b--){var C=l.g=h[b];I=Cr(C,p,!0,l)&&I}if(C=l.g=o,I=Cr(C,p,!0,l)&&I,I=Cr(C,p,!1,l)&&I,h)for(b=0;b<h.length;b++)C=l.g=h[b],I=Cr(C,p,!1,l)&&I}_e.prototype.N=function(){if(_e.aa.N.call(this),this.i){var o=this.i,l;for(l in o.g){for(var h=o.g[l],p=0;p<h.length;p++)Sr(h[p]);delete o.g[l],o.h--}}this.F=null},_e.prototype.K=function(o,l,h,p){return this.i.add(String(o),l,!1,h,p)},_e.prototype.L=function(o,l,h,p){return this.i.add(String(o),l,!0,h,p)};function Cr(o,l,h,p){if(l=o.i.g[String(l)],!l)return!0;l=l.concat();for(var I=!0,b=0;b<l.length;++b){var C=l[b];if(C&&!C.da&&C.capture==h){var Y=C.listener,he=C.ha||C.src;C.fa&&Qi(o.i,C),I=Y.call(he,p)!==!1&&I}}return I&&!p.defaultPrevented}function ua(o,l,h){if(typeof o=="function")h&&(o=E(o,h));else if(o&&typeof o.handleEvent=="function")o=E(o.handleEvent,o);else throw Error("Invalid listener argument");return 2147483647<Number(l)?-1:c.setTimeout(o,l||0)}function ha(o){o.g=ua(()=>{o.g=null,o.i&&(o.i=!1,ha(o))},o.l);const l=o.h;o.h=null,o.m.apply(null,l)}class id extends at{constructor(l,h){super(),this.m=l,this.l=h,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:ha(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Cn(o){at.call(this),this.h=o,this.g={}}k(Cn,at);var da=[];function fa(o){re(o.g,function(l,h){this.g.hasOwnProperty(h)&&Zi(l)},o),o.g={}}Cn.prototype.N=function(){Cn.aa.N.call(this),fa(this)},Cn.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ns=c.JSON.stringify,sd=c.JSON.parse,od=class{stringify(o){return c.JSON.stringify(o,void 0)}parse(o){return c.JSON.parse(o,void 0)}};function rs(){}rs.prototype.h=null;function pa(o){return o.h||(o.h=o.i())}function ma(){}var kn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function is(){ge.call(this,"d")}k(is,ge);function ss(){ge.call(this,"c")}k(ss,ge);var kt={},ga=null;function kr(){return ga=ga||new _e}kt.La="serverreachability";function _a(o){ge.call(this,kt.La,o)}k(_a,ge);function Dn(o){const l=kr();Ae(l,new _a(l))}kt.STAT_EVENT="statevent";function ya(o,l){ge.call(this,kt.STAT_EVENT,o),this.stat=l}k(ya,ge);function be(o){const l=kr();Ae(l,new ya(l,o))}kt.Ma="timingevent";function va(o,l){ge.call(this,kt.Ma,o),this.size=l}k(va,ge);function Nn(o,l){if(typeof o!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){o()},l)}function Vn(){this.g=!0}Vn.prototype.xa=function(){this.g=!1};function ad(o,l,h,p,I,b){o.info(function(){if(o.g)if(b)for(var C="",Y=b.split("&"),he=0;he<Y.length;he++){var W=Y[he].split("=");if(1<W.length){var ye=W[0];W=W[1];var ve=ye.split("_");C=2<=ve.length&&ve[1]=="type"?C+(ye+"="+W+"&"):C+(ye+"=redacted&")}}else C=null;else C=b;return"XMLHTTP REQ ("+p+") [attempt "+I+"]: "+l+`
`+h+`
`+C})}function cd(o,l,h,p,I,b,C){o.info(function(){return"XMLHTTP RESP ("+p+") [ attempt "+I+"]: "+l+`
`+h+`
`+b+" "+C})}function Wt(o,l,h,p){o.info(function(){return"XMLHTTP TEXT ("+l+"): "+ud(o,h)+(p?" "+p:"")})}function ld(o,l){o.info(function(){return"TIMEOUT: "+l})}Vn.prototype.info=function(){};function ud(o,l){if(!o.g)return l;if(!l)return null;try{var h=JSON.parse(l);if(h){for(o=0;o<h.length;o++)if(Array.isArray(h[o])){var p=h[o];if(!(2>p.length)){var I=p[1];if(Array.isArray(I)&&!(1>I.length)){var b=I[0];if(b!="noop"&&b!="stop"&&b!="close")for(var C=1;C<I.length;C++)I[C]=""}}}}return ns(h)}catch{return l}}var Dr={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},Ea={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},os;function Nr(){}k(Nr,rs),Nr.prototype.g=function(){return new XMLHttpRequest},Nr.prototype.i=function(){return{}},os=new Nr;function ct(o,l,h,p){this.j=o,this.i=l,this.l=h,this.R=p||1,this.U=new Cn(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new wa}function wa(){this.i=null,this.g="",this.h=!1}var Ta={},as={};function cs(o,l,h){o.L=1,o.v=Mr(Ke(l)),o.m=h,o.P=!0,Ia(o,null)}function Ia(o,l){o.F=Date.now(),Vr(o),o.A=Ke(o.v);var h=o.A,p=o.R;Array.isArray(p)||(p=[String(p)]),xa(h.i,"t",p),o.C=0,h=o.j.J,o.h=new wa,o.g=tc(o.j,h?l:null,!o.m),0<o.O&&(o.M=new id(E(o.Y,o,o.g),o.O)),l=o.U,h=o.g,p=o.ca;var I="readystatechange";Array.isArray(I)||(I&&(da[0]=I.toString()),I=da);for(var b=0;b<I.length;b++){var C=oa(h,I[b],p||l.handleEvent,!1,l.h||l);if(!C)break;l.g[C.key]=C}l=o.H?m(o.H):{},o.m?(o.u||(o.u="POST"),l["Content-Type"]="application/x-www-form-urlencoded",o.g.ea(o.A,o.u,o.m,l)):(o.u="GET",o.g.ea(o.A,o.u,null,l)),Dn(),ad(o.i,o.u,o.A,o.l,o.R,o.m)}ct.prototype.ca=function(o){o=o.target;const l=this.M;l&&Qe(o)==3?l.j():this.Y(o)},ct.prototype.Y=function(o){try{if(o==this.g)e:{const ve=Qe(this.g);var l=this.g.Ba();const Kt=this.g.Z();if(!(3>ve)&&(ve!=3||this.g&&(this.h.h||this.g.oa()||Ha(this.g)))){this.J||ve!=4||l==7||(l==8||0>=Kt?Dn(3):Dn(2)),ls(this);var h=this.g.Z();this.X=h;t:if(Aa(this)){var p=Ha(this.g);o="";var I=p.length,b=Qe(this.g)==4;if(!this.h.i){if(typeof TextDecoder=="undefined"){Dt(this),Ln(this);var C="";break t}this.h.i=new c.TextDecoder}for(l=0;l<I;l++)this.h.h=!0,o+=this.h.i.decode(p[l],{stream:!(b&&l==I-1)});p.length=0,this.h.g+=o,this.C=0,C=this.h.g}else C=this.g.oa();if(this.o=h==200,cd(this.i,this.u,this.A,this.l,this.R,ve,h),this.o){if(this.T&&!this.K){t:{if(this.g){var Y,he=this.g;if((Y=he.g?he.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!K(Y)){var W=Y;break t}}W=null}if(h=W)Wt(this.i,this.l,h,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,us(this,h);else{this.o=!1,this.s=3,be(12),Dt(this),Ln(this);break e}}if(this.P){h=!0;let Le;for(;!this.J&&this.C<C.length;)if(Le=hd(this,C),Le==as){ve==4&&(this.s=4,be(14),h=!1),Wt(this.i,this.l,null,"[Incomplete Response]");break}else if(Le==Ta){this.s=4,be(15),Wt(this.i,this.l,C,"[Invalid Chunk]"),h=!1;break}else Wt(this.i,this.l,Le,null),us(this,Le);if(Aa(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),ve!=4||C.length!=0||this.h.h||(this.s=1,be(16),h=!1),this.o=this.o&&h,!h)Wt(this.i,this.l,C,"[Invalid Chunked Response]"),Dt(this),Ln(this);else if(0<C.length&&!this.W){this.W=!0;var ye=this.j;ye.g==this&&ye.ba&&!ye.M&&(ye.j.info("Great, no buffering proxy detected. Bytes received: "+C.length),gs(ye),ye.M=!0,be(11))}}else Wt(this.i,this.l,C,null),us(this,C);ve==4&&Dt(this),this.o&&!this.J&&(ve==4?Ya(this.j,this):(this.o=!1,Vr(this)))}else Pd(this.g),h==400&&0<C.indexOf("Unknown SID")?(this.s=3,be(12)):(this.s=0,be(13)),Dt(this),Ln(this)}}}catch{}finally{}};function Aa(o){return o.g?o.u=="GET"&&o.L!=2&&o.j.Ca:!1}function hd(o,l){var h=o.C,p=l.indexOf(`
`,h);return p==-1?as:(h=Number(l.substring(h,p)),isNaN(h)?Ta:(p+=1,p+h>l.length?as:(l=l.slice(p,p+h),o.C=p+h,l)))}ct.prototype.cancel=function(){this.J=!0,Dt(this)};function Vr(o){o.S=Date.now()+o.I,ba(o,o.I)}function ba(o,l){if(o.B!=null)throw Error("WatchDog timer not null");o.B=Nn(E(o.ba,o),l)}function ls(o){o.B&&(c.clearTimeout(o.B),o.B=null)}ct.prototype.ba=function(){this.B=null;const o=Date.now();0<=o-this.S?(ld(this.i,this.A),this.L!=2&&(Dn(),be(17)),Dt(this),this.s=2,Ln(this)):ba(this,this.S-o)};function Ln(o){o.j.G==0||o.J||Ya(o.j,o)}function Dt(o){ls(o);var l=o.M;l&&typeof l.ma=="function"&&l.ma(),o.M=null,fa(o.U),o.g&&(l=o.g,o.g=null,l.abort(),l.ma())}function us(o,l){try{var h=o.j;if(h.G!=0&&(h.g==o||hs(h.h,o))){if(!o.K&&hs(h.h,o)&&h.G==3){try{var p=h.Da.g.parse(l)}catch{p=null}if(Array.isArray(p)&&p.length==3){var I=p;if(I[0]==0){e:if(!h.u){if(h.g)if(h.g.F+3e3<o.F)jr(h),$r(h);else break e;ms(h),be(18)}}else h.za=I[1],0<h.za-h.T&&37500>I[2]&&h.F&&h.v==0&&!h.C&&(h.C=Nn(E(h.Za,h),6e3));if(1>=Pa(h.h)&&h.ca){try{h.ca()}catch{}h.ca=void 0}}else Vt(h,11)}else if((o.K||h.g==o)&&jr(h),!K(l))for(I=h.Da.g.parse(l),l=0;l<I.length;l++){let W=I[l];if(h.T=W[0],W=W[1],h.G==2)if(W[0]=="c"){h.K=W[1],h.ia=W[2];const ye=W[3];ye!=null&&(h.la=ye,h.j.info("VER="+h.la));const ve=W[4];ve!=null&&(h.Aa=ve,h.j.info("SVER="+h.Aa));const Kt=W[5];Kt!=null&&typeof Kt=="number"&&0<Kt&&(p=1.5*Kt,h.L=p,h.j.info("backChannelRequestTimeoutMs_="+p)),p=h;const Le=o.g;if(Le){const Hr=Le.g?Le.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Hr){var b=p.h;b.g||Hr.indexOf("spdy")==-1&&Hr.indexOf("quic")==-1&&Hr.indexOf("h2")==-1||(b.j=b.l,b.g=new Set,b.h&&(ds(b,b.h),b.h=null))}if(p.D){const _s=Le.g?Le.g.getResponseHeader("X-HTTP-Session-Id"):null;_s&&(p.ya=_s,X(p.I,p.D,_s))}}h.G=3,h.l&&h.l.ua(),h.ba&&(h.R=Date.now()-o.F,h.j.info("Handshake RTT: "+h.R+"ms")),p=h;var C=o;if(p.qa=ec(p,p.J?p.ia:null,p.W),C.K){Ca(p.h,C);var Y=C,he=p.L;he&&(Y.I=he),Y.B&&(ls(Y),Vr(Y)),p.g=C}else Qa(p);0<h.i.length&&Br(h)}else W[0]!="stop"&&W[0]!="close"||Vt(h,7);else h.G==3&&(W[0]=="stop"||W[0]=="close"?W[0]=="stop"?Vt(h,7):ps(h):W[0]!="noop"&&h.l&&h.l.ta(W),h.v=0)}}Dn(4)}catch{}}var dd=class{constructor(o,l){this.g=o,this.map=l}};function Ra(o){this.l=o||10,c.PerformanceNavigationTiming?(o=c.performance.getEntriesByType("navigation"),o=0<o.length&&(o[0].nextHopProtocol=="hq"||o[0].nextHopProtocol=="h2")):o=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=o?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function Sa(o){return o.h?!0:o.g?o.g.size>=o.j:!1}function Pa(o){return o.h?1:o.g?o.g.size:0}function hs(o,l){return o.h?o.h==l:o.g?o.g.has(l):!1}function ds(o,l){o.g?o.g.add(l):o.h=l}function Ca(o,l){o.h&&o.h==l?o.h=null:o.g&&o.g.has(l)&&o.g.delete(l)}Ra.prototype.cancel=function(){if(this.i=ka(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const o of this.g.values())o.cancel();this.g.clear()}};function ka(o){if(o.h!=null)return o.i.concat(o.h.D);if(o.g!=null&&o.g.size!==0){let l=o.i;for(const h of o.g.values())l=l.concat(h.D);return l}return O(o.i)}function fd(o){if(o.V&&typeof o.V=="function")return o.V();if(typeof Map!="undefined"&&o instanceof Map||typeof Set!="undefined"&&o instanceof Set)return Array.from(o.values());if(typeof o=="string")return o.split("");if(u(o)){for(var l=[],h=o.length,p=0;p<h;p++)l.push(o[p]);return l}l=[],h=0;for(p in o)l[h++]=o[p];return l}function pd(o){if(o.na&&typeof o.na=="function")return o.na();if(!o.V||typeof o.V!="function"){if(typeof Map!="undefined"&&o instanceof Map)return Array.from(o.keys());if(!(typeof Set!="undefined"&&o instanceof Set)){if(u(o)||typeof o=="string"){var l=[];o=o.length;for(var h=0;h<o;h++)l.push(h);return l}l=[],h=0;for(const p in o)l[h++]=p;return l}}}function Da(o,l){if(o.forEach&&typeof o.forEach=="function")o.forEach(l,void 0);else if(u(o)||typeof o=="string")Array.prototype.forEach.call(o,l,void 0);else for(var h=pd(o),p=fd(o),I=p.length,b=0;b<I;b++)l.call(void 0,p[b],h&&h[b],o)}var Na=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function md(o,l){if(o){o=o.split("&");for(var h=0;h<o.length;h++){var p=o[h].indexOf("="),I=null;if(0<=p){var b=o[h].substring(0,p);I=o[h].substring(p+1)}else b=o[h];l(b,I?decodeURIComponent(I.replace(/\+/g," ")):"")}}}function Nt(o){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,o instanceof Nt){this.h=o.h,Lr(this,o.j),this.o=o.o,this.g=o.g,Or(this,o.s),this.l=o.l;var l=o.i,h=new xn;h.i=l.i,l.g&&(h.g=new Map(l.g),h.h=l.h),Va(this,h),this.m=o.m}else o&&(l=String(o).match(Na))?(this.h=!1,Lr(this,l[1]||"",!0),this.o=On(l[2]||""),this.g=On(l[3]||"",!0),Or(this,l[4]),this.l=On(l[5]||"",!0),Va(this,l[6]||"",!0),this.m=On(l[7]||"")):(this.h=!1,this.i=new xn(null,this.h))}Nt.prototype.toString=function(){var o=[],l=this.j;l&&o.push(Mn(l,La,!0),":");var h=this.g;return(h||l=="file")&&(o.push("//"),(l=this.o)&&o.push(Mn(l,La,!0),"@"),o.push(encodeURIComponent(String(h)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.s,h!=null&&o.push(":",String(h))),(h=this.l)&&(this.g&&h.charAt(0)!="/"&&o.push("/"),o.push(Mn(h,h.charAt(0)=="/"?yd:_d,!0))),(h=this.i.toString())&&o.push("?",h),(h=this.m)&&o.push("#",Mn(h,Ed)),o.join("")};function Ke(o){return new Nt(o)}function Lr(o,l,h){o.j=h?On(l,!0):l,o.j&&(o.j=o.j.replace(/:$/,""))}function Or(o,l){if(l){if(l=Number(l),isNaN(l)||0>l)throw Error("Bad port number "+l);o.s=l}else o.s=null}function Va(o,l,h){l instanceof xn?(o.i=l,wd(o.i,o.h)):(h||(l=Mn(l,vd)),o.i=new xn(l,o.h))}function X(o,l,h){o.i.set(l,h)}function Mr(o){return X(o,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),o}function On(o,l){return o?l?decodeURI(o.replace(/%25/g,"%2525")):decodeURIComponent(o):""}function Mn(o,l,h){return typeof o=="string"?(o=encodeURI(o).replace(l,gd),h&&(o=o.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),o):null}function gd(o){return o=o.charCodeAt(0),"%"+(o>>4&15).toString(16)+(o&15).toString(16)}var La=/[#\/\?@]/g,_d=/[#\?:]/g,yd=/[#\?]/g,vd=/[#\?@]/g,Ed=/#/g;function xn(o,l){this.h=this.g=null,this.i=o||null,this.j=!!l}function lt(o){o.g||(o.g=new Map,o.h=0,o.i&&md(o.i,function(l,h){o.add(decodeURIComponent(l.replace(/\+/g," ")),h)}))}n=xn.prototype,n.add=function(o,l){lt(this),this.i=null,o=zt(this,o);var h=this.g.get(o);return h||this.g.set(o,h=[]),h.push(l),this.h+=1,this};function Oa(o,l){lt(o),l=zt(o,l),o.g.has(l)&&(o.i=null,o.h-=o.g.get(l).length,o.g.delete(l))}function Ma(o,l){return lt(o),l=zt(o,l),o.g.has(l)}n.forEach=function(o,l){lt(this),this.g.forEach(function(h,p){h.forEach(function(I){o.call(l,I,p,this)},this)},this)},n.na=function(){lt(this);const o=Array.from(this.g.values()),l=Array.from(this.g.keys()),h=[];for(let p=0;p<l.length;p++){const I=o[p];for(let b=0;b<I.length;b++)h.push(l[p])}return h},n.V=function(o){lt(this);let l=[];if(typeof o=="string")Ma(this,o)&&(l=l.concat(this.g.get(zt(this,o))));else{o=Array.from(this.g.values());for(let h=0;h<o.length;h++)l=l.concat(o[h])}return l},n.set=function(o,l){return lt(this),this.i=null,o=zt(this,o),Ma(this,o)&&(this.h-=this.g.get(o).length),this.g.set(o,[l]),this.h+=1,this},n.get=function(o,l){return o?(o=this.V(o),0<o.length?String(o[0]):l):l};function xa(o,l,h){Oa(o,l),0<h.length&&(o.i=null,o.g.set(zt(o,l),O(h)),o.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const o=[],l=Array.from(this.g.keys());for(var h=0;h<l.length;h++){var p=l[h];const b=encodeURIComponent(String(p)),C=this.V(p);for(p=0;p<C.length;p++){var I=b;C[p]!==""&&(I+="="+encodeURIComponent(String(C[p]))),o.push(I)}}return this.i=o.join("&")};function zt(o,l){return l=String(l),o.j&&(l=l.toLowerCase()),l}function wd(o,l){l&&!o.j&&(lt(o),o.i=null,o.g.forEach(function(h,p){var I=p.toLowerCase();p!=I&&(Oa(this,p),xa(this,I,h))},o)),o.j=l}function Td(o,l){const h=new Vn;if(c.Image){const p=new Image;p.onload=R(ut,h,"TestLoadImage: loaded",!0,l,p),p.onerror=R(ut,h,"TestLoadImage: error",!1,l,p),p.onabort=R(ut,h,"TestLoadImage: abort",!1,l,p),p.ontimeout=R(ut,h,"TestLoadImage: timeout",!1,l,p),c.setTimeout(function(){p.ontimeout&&p.ontimeout()},1e4),p.src=o}else l(!1)}function Id(o,l){const h=new Vn,p=new AbortController,I=setTimeout(()=>{p.abort(),ut(h,"TestPingServer: timeout",!1,l)},1e4);fetch(o,{signal:p.signal}).then(b=>{clearTimeout(I),b.ok?ut(h,"TestPingServer: ok",!0,l):ut(h,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(I),ut(h,"TestPingServer: error",!1,l)})}function ut(o,l,h,p,I){try{I&&(I.onload=null,I.onerror=null,I.onabort=null,I.ontimeout=null),p(h)}catch{}}function Ad(){this.g=new od}function bd(o,l,h){const p=h||"";try{Da(o,function(I,b){let C=I;d(I)&&(C=ns(I)),l.push(p+b+"="+encodeURIComponent(C))})}catch(I){throw l.push(p+"type="+encodeURIComponent("_badmap")),I}}function xr(o){this.l=o.Ub||null,this.j=o.eb||!1}k(xr,rs),xr.prototype.g=function(){return new Fr(this.l,this.j)},xr.prototype.i=function(o){return function(){return o}}({});function Fr(o,l){_e.call(this),this.D=o,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}k(Fr,_e),n=Fr.prototype,n.open=function(o,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=o,this.A=l,this.readyState=1,Un(this)},n.send=function(o){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const l={headers:this.u,method:this.B,credentials:this.m,cache:void 0};o&&(l.body=o),(this.D||c).fetch(new Request(this.A,l)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Fn(this)),this.readyState=0},n.Sa=function(o){if(this.g&&(this.l=o,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=o.headers,this.readyState=2,Un(this)),this.g&&(this.readyState=3,Un(this),this.g)))if(this.responseType==="arraybuffer")o.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream!="undefined"&&"body"in o){if(this.j=o.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Fa(this)}else o.text().then(this.Ra.bind(this),this.ga.bind(this))};function Fa(o){o.j.read().then(o.Pa.bind(o)).catch(o.ga.bind(o))}n.Pa=function(o){if(this.g){if(this.o&&o.value)this.response.push(o.value);else if(!this.o){var l=o.value?o.value:new Uint8Array(0);(l=this.v.decode(l,{stream:!o.done}))&&(this.response=this.responseText+=l)}o.done?Fn(this):Un(this),this.readyState==3&&Fa(this)}},n.Ra=function(o){this.g&&(this.response=this.responseText=o,Fn(this))},n.Qa=function(o){this.g&&(this.response=o,Fn(this))},n.ga=function(){this.g&&Fn(this)};function Fn(o){o.readyState=4,o.l=null,o.j=null,o.v=null,Un(o)}n.setRequestHeader=function(o,l){this.u.append(o,l)},n.getResponseHeader=function(o){return this.h&&this.h.get(o.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const o=[],l=this.h.entries();for(var h=l.next();!h.done;)h=h.value,o.push(h[0]+": "+h[1]),h=l.next();return o.join(`\r
`)};function Un(o){o.onreadystatechange&&o.onreadystatechange.call(o)}Object.defineProperty(Fr.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(o){this.m=o?"include":"same-origin"}});function Ua(o){let l="";return re(o,function(h,p){l+=p,l+=":",l+=h,l+=`\r
`}),l}function fs(o,l,h){e:{for(p in h){var p=!1;break e}p=!0}p||(h=Ua(h),typeof o=="string"?h!=null&&encodeURIComponent(String(h)):X(o,l,h))}function te(o){_e.call(this),this.headers=new Map,this.o=o||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}k(te,_e);var Rd=/^https?$/i,Sd=["POST","PUT"];n=te.prototype,n.Ha=function(o){this.J=o},n.ea=function(o,l,h,p){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+o);l=l?l.toUpperCase():"GET",this.D=o,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():os.g(),this.v=this.o?pa(this.o):pa(os),this.g.onreadystatechange=E(this.Ea,this);try{this.B=!0,this.g.open(l,String(o),!0),this.B=!1}catch(b){$a(this,b);return}if(o=h||"",h=new Map(this.headers),p)if(Object.getPrototypeOf(p)===Object.prototype)for(var I in p)h.set(I,p[I]);else if(typeof p.keys=="function"&&typeof p.get=="function")for(const b of p.keys())h.set(b,p.get(b));else throw Error("Unknown input type for opt_headers: "+String(p));p=Array.from(h.keys()).find(b=>b.toLowerCase()=="content-type"),I=c.FormData&&o instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Sd,l,void 0))||p||I||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[b,C]of h)this.g.setRequestHeader(b,C);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{qa(this),this.u=!0,this.g.send(o),this.u=!1}catch(b){$a(this,b)}};function $a(o,l){o.h=!1,o.g&&(o.j=!0,o.g.abort(),o.j=!1),o.l=l,o.m=5,Ba(o),Ur(o)}function Ba(o){o.A||(o.A=!0,Ae(o,"complete"),Ae(o,"error"))}n.abort=function(o){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=o||7,Ae(this,"complete"),Ae(this,"abort"),Ur(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Ur(this,!0)),te.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?ja(this):this.bb())},n.bb=function(){ja(this)};function ja(o){if(o.h&&typeof a!="undefined"&&(!o.v[1]||Qe(o)!=4||o.Z()!=2)){if(o.u&&Qe(o)==4)ua(o.Ea,0,o);else if(Ae(o,"readystatechange"),Qe(o)==4){o.h=!1;try{const C=o.Z();e:switch(C){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break e;default:l=!1}var h;if(!(h=l)){var p;if(p=C===0){var I=String(o.D).match(Na)[1]||null;!I&&c.self&&c.self.location&&(I=c.self.location.protocol.slice(0,-1)),p=!Rd.test(I?I.toLowerCase():"")}h=p}if(h)Ae(o,"complete"),Ae(o,"success");else{o.m=6;try{var b=2<Qe(o)?o.g.statusText:""}catch{b=""}o.l=b+" ["+o.Z()+"]",Ba(o)}}finally{Ur(o)}}}}function Ur(o,l){if(o.g){qa(o);const h=o.g,p=o.v[0]?()=>{}:null;o.g=null,o.v=null,l||Ae(o,"ready");try{h.onreadystatechange=p}catch{}}}function qa(o){o.I&&(c.clearTimeout(o.I),o.I=null)}n.isActive=function(){return!!this.g};function Qe(o){return o.g?o.g.readyState:0}n.Z=function(){try{return 2<Qe(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(o){if(this.g){var l=this.g.responseText;return o&&l.indexOf(o)==0&&(l=l.substring(o.length)),sd(l)}};function Ha(o){try{if(!o.g)return null;if("response"in o.g)return o.g.response;switch(o.H){case"":case"text":return o.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in o.g)return o.g.mozResponseArrayBuffer}return null}catch{return null}}function Pd(o){const l={};o=(o.g&&2<=Qe(o)&&o.g.getAllResponseHeaders()||"").split(`\r
`);for(let p=0;p<o.length;p++){if(K(o[p]))continue;var h=T(o[p]);const I=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const b=l[I]||[];l[I]=b,b.push(h)}w(l,function(p){return p.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function $n(o,l,h){return h&&h.internalChannelParams&&h.internalChannelParams[o]||l}function Wa(o){this.Aa=0,this.i=[],this.j=new Vn,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=$n("failFast",!1,o),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=$n("baseRetryDelayMs",5e3,o),this.cb=$n("retryDelaySeedMs",1e4,o),this.Wa=$n("forwardChannelMaxRetries",2,o),this.wa=$n("forwardChannelRequestTimeoutMs",2e4,o),this.pa=o&&o.xmlHttpFactory||void 0,this.Xa=o&&o.Tb||void 0,this.Ca=o&&o.useFetchStreams||!1,this.L=void 0,this.J=o&&o.supportsCrossDomainXhr||!1,this.K="",this.h=new Ra(o&&o.concurrentRequestLimit),this.Da=new Ad,this.P=o&&o.fastHandshake||!1,this.O=o&&o.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=o&&o.Rb||!1,o&&o.xa&&this.j.xa(),o&&o.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&o&&o.detectBufferingProxy||!1,this.ja=void 0,o&&o.longPollingTimeout&&0<o.longPollingTimeout&&(this.ja=o.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Wa.prototype,n.la=8,n.G=1,n.connect=function(o,l,h,p){be(0),this.W=o,this.H=l||{},h&&p!==void 0&&(this.H.OSID=h,this.H.OAID=p),this.F=this.X,this.I=ec(this,null,this.W),Br(this)};function ps(o){if(za(o),o.G==3){var l=o.U++,h=Ke(o.I);if(X(h,"SID",o.K),X(h,"RID",l),X(h,"TYPE","terminate"),Bn(o,h),l=new ct(o,o.j,l),l.L=2,l.v=Mr(Ke(h)),h=!1,c.navigator&&c.navigator.sendBeacon)try{h=c.navigator.sendBeacon(l.v.toString(),"")}catch{}!h&&c.Image&&(new Image().src=l.v,h=!0),h||(l.g=tc(l.j,null),l.g.ea(l.v)),l.F=Date.now(),Vr(l)}Za(o)}function $r(o){o.g&&(gs(o),o.g.cancel(),o.g=null)}function za(o){$r(o),o.u&&(c.clearTimeout(o.u),o.u=null),jr(o),o.h.cancel(),o.s&&(typeof o.s=="number"&&c.clearTimeout(o.s),o.s=null)}function Br(o){if(!Sa(o.h)&&!o.s){o.s=!0;var l=o.Ga;Rn||sa(),Sn||(Rn(),Sn=!0),Ki.add(l,o),o.B=0}}function Cd(o,l){return Pa(o.h)>=o.h.j-(o.s?1:0)?!1:o.s?(o.i=l.D.concat(o.i),!0):o.G==1||o.G==2||o.B>=(o.Va?0:o.Wa)?!1:(o.s=Nn(E(o.Ga,o,l),Xa(o,o.B)),o.B++,!0)}n.Ga=function(o){if(this.s)if(this.s=null,this.G==1){if(!o){this.U=Math.floor(1e5*Math.random()),o=this.U++;const I=new ct(this,this.j,o);let b=this.o;if(this.S&&(b?(b=m(b),v(b,this.S)):b=this.S),this.m!==null||this.O||(I.H=b,b=null),this.P)e:{for(var l=0,h=0;h<this.i.length;h++){t:{var p=this.i[h];if("__data__"in p.map&&(p=p.map.__data__,typeof p=="string")){p=p.length;break t}p=void 0}if(p===void 0)break;if(l+=p,4096<l){l=h;break e}if(l===4096||h===this.i.length-1){l=h+1;break e}}l=1e3}else l=1e3;l=Ka(this,I,l),h=Ke(this.I),X(h,"RID",o),X(h,"CVER",22),this.D&&X(h,"X-HTTP-Session-Id",this.D),Bn(this,h),b&&(this.O?l="headers="+encodeURIComponent(String(Ua(b)))+"&"+l:this.m&&fs(h,this.m,b)),ds(this.h,I),this.Ua&&X(h,"TYPE","init"),this.P?(X(h,"$req",l),X(h,"SID","null"),I.T=!0,cs(I,h,null)):cs(I,h,l),this.G=2}}else this.G==3&&(o?Ga(this,o):this.i.length==0||Sa(this.h)||Ga(this))};function Ga(o,l){var h;l?h=l.l:h=o.U++;const p=Ke(o.I);X(p,"SID",o.K),X(p,"RID",h),X(p,"AID",o.T),Bn(o,p),o.m&&o.o&&fs(p,o.m,o.o),h=new ct(o,o.j,h,o.B+1),o.m===null&&(h.H=o.o),l&&(o.i=l.D.concat(o.i)),l=Ka(o,h,1e3),h.I=Math.round(.5*o.wa)+Math.round(.5*o.wa*Math.random()),ds(o.h,h),cs(h,p,l)}function Bn(o,l){o.H&&re(o.H,function(h,p){X(l,p,h)}),o.l&&Da({},function(h,p){X(l,p,h)})}function Ka(o,l,h){h=Math.min(o.i.length,h);var p=o.l?E(o.l.Na,o.l,o):null;e:{var I=o.i;let b=-1;for(;;){const C=["count="+h];b==-1?0<h?(b=I[0].g,C.push("ofs="+b)):b=0:C.push("ofs="+b);let Y=!0;for(let he=0;he<h;he++){let W=I[he].g;const ye=I[he].map;if(W-=b,0>W)b=Math.max(0,I[he].g-100),Y=!1;else try{bd(ye,C,"req"+W+"_")}catch{p&&p(ye)}}if(Y){p=C.join("&");break e}}}return o=o.i.splice(0,h),l.D=o,p}function Qa(o){if(!o.g&&!o.u){o.Y=1;var l=o.Fa;Rn||sa(),Sn||(Rn(),Sn=!0),Ki.add(l,o),o.v=0}}function ms(o){return o.g||o.u||3<=o.v?!1:(o.Y++,o.u=Nn(E(o.Fa,o),Xa(o,o.v)),o.v++,!0)}n.Fa=function(){if(this.u=null,Ja(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var o=2*this.R;this.j.info("BP detection timer enabled: "+o),this.A=Nn(E(this.ab,this),o)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,be(10),$r(this),Ja(this))};function gs(o){o.A!=null&&(c.clearTimeout(o.A),o.A=null)}function Ja(o){o.g=new ct(o,o.j,"rpc",o.Y),o.m===null&&(o.g.H=o.o),o.g.O=0;var l=Ke(o.qa);X(l,"RID","rpc"),X(l,"SID",o.K),X(l,"AID",o.T),X(l,"CI",o.F?"0":"1"),!o.F&&o.ja&&X(l,"TO",o.ja),X(l,"TYPE","xmlhttp"),Bn(o,l),o.m&&o.o&&fs(l,o.m,o.o),o.L&&(o.g.I=o.L);var h=o.g;o=o.ia,h.L=1,h.v=Mr(Ke(l)),h.m=null,h.P=!0,Ia(h,o)}n.Za=function(){this.C!=null&&(this.C=null,$r(this),ms(this),be(19))};function jr(o){o.C!=null&&(c.clearTimeout(o.C),o.C=null)}function Ya(o,l){var h=null;if(o.g==l){jr(o),gs(o),o.g=null;var p=2}else if(hs(o.h,l))h=l.D,Ca(o.h,l),p=1;else return;if(o.G!=0){if(l.o)if(p==1){h=l.m?l.m.length:0,l=Date.now()-l.F;var I=o.B;p=kr(),Ae(p,new va(p,h)),Br(o)}else Qa(o);else if(I=l.s,I==3||I==0&&0<l.X||!(p==1&&Cd(o,l)||p==2&&ms(o)))switch(h&&0<h.length&&(l=o.h,l.i=l.i.concat(h)),I){case 1:Vt(o,5);break;case 4:Vt(o,10);break;case 3:Vt(o,6);break;default:Vt(o,2)}}}function Xa(o,l){let h=o.Ta+Math.floor(Math.random()*o.cb);return o.isActive()||(h*=2),h*l}function Vt(o,l){if(o.j.info("Error code "+l),l==2){var h=E(o.fb,o),p=o.Xa;const I=!p;p=new Nt(p||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||Lr(p,"https"),Mr(p),I?Td(p.toString(),h):Id(p.toString(),h)}else be(2);o.G=0,o.l&&o.l.sa(l),Za(o),za(o)}n.fb=function(o){o?(this.j.info("Successfully pinged google.com"),be(2)):(this.j.info("Failed to ping google.com"),be(1))};function Za(o){if(o.G=0,o.ka=[],o.l){const l=ka(o.h);(l.length!=0||o.i.length!=0)&&(N(o.ka,l),N(o.ka,o.i),o.h.i.length=0,O(o.i),o.i.length=0),o.l.ra()}}function ec(o,l,h){var p=h instanceof Nt?Ke(h):new Nt(h);if(p.g!="")l&&(p.g=l+"."+p.g),Or(p,p.s);else{var I=c.location;p=I.protocol,l=l?l+"."+I.hostname:I.hostname,I=+I.port;var b=new Nt(null);p&&Lr(b,p),l&&(b.g=l),I&&Or(b,I),h&&(b.l=h),p=b}return h=o.D,l=o.ya,h&&l&&X(p,h,l),X(p,"VER",o.la),Bn(o,p),p}function tc(o,l,h){if(l&&!o.J)throw Error("Can't create secondary domain capable XhrIo object.");return l=o.Ca&&!o.pa?new te(new xr({eb:h})):new te(o.pa),l.Ha(o.J),l}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function nc(){}n=nc.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function qr(){}qr.prototype.g=function(o,l){return new Pe(o,l)};function Pe(o,l){_e.call(this),this.g=new Wa(l),this.l=o,this.h=l&&l.messageUrlParams||null,o=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(o?o["X-Client-Protocol"]="webchannel":o={"X-Client-Protocol":"webchannel"}),this.g.o=o,o=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(o?o["X-WebChannel-Content-Type"]=l.messageContentType:o={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.va&&(o?o["X-WebChannel-Client-Profile"]=l.va:o={"X-WebChannel-Client-Profile":l.va}),this.g.S=o,(o=l&&l.Sb)&&!K(o)&&(this.g.m=o),this.v=l&&l.supportsCrossDomainXhr||!1,this.u=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!K(l)&&(this.g.D=l,o=this.h,o!==null&&l in o&&(o=this.h,l in o&&delete o[l])),this.j=new Gt(this)}k(Pe,_e),Pe.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},Pe.prototype.close=function(){ps(this.g)},Pe.prototype.o=function(o){var l=this.g;if(typeof o=="string"){var h={};h.__data__=o,o=h}else this.u&&(h={},h.__data__=ns(o),o=h);l.i.push(new dd(l.Ya++,o)),l.G==3&&Br(l)},Pe.prototype.N=function(){this.g.l=null,delete this.j,ps(this.g),delete this.g,Pe.aa.N.call(this)};function rc(o){is.call(this),o.__headers__&&(this.headers=o.__headers__,this.statusCode=o.__status__,delete o.__headers__,delete o.__status__);var l=o.__sm__;if(l){e:{for(const h in l){o=h;break e}o=void 0}(this.i=o)&&(o=this.i,l=l!==null&&o in l?l[o]:void 0),this.data=l}else this.data=o}k(rc,is);function ic(){ss.call(this),this.status=1}k(ic,ss);function Gt(o){this.g=o}k(Gt,nc),Gt.prototype.ua=function(){Ae(this.g,"a")},Gt.prototype.ta=function(o){Ae(this.g,new rc(o))},Gt.prototype.sa=function(o){Ae(this.g,new ic)},Gt.prototype.ra=function(){Ae(this.g,"b")},qr.prototype.createWebChannel=qr.prototype.g,Pe.prototype.send=Pe.prototype.o,Pe.prototype.open=Pe.prototype.m,Pe.prototype.close=Pe.prototype.close,vu=function(){return new qr},yu=function(){return kr()},_u=kt,Fs={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},Dr.NO_ERROR=0,Dr.TIMEOUT=8,Dr.HTTP_ERROR=6,ri=Dr,Ea.COMPLETE="complete",gu=Ea,ma.EventType=kn,kn.OPEN="a",kn.CLOSE="b",kn.ERROR="c",kn.MESSAGE="d",_e.prototype.listen=_e.prototype.K,Wn=ma,te.prototype.listenOnce=te.prototype.L,te.prototype.getLastError=te.prototype.Ka,te.prototype.getLastErrorCode=te.prototype.Ba,te.prototype.getStatus=te.prototype.Z,te.prototype.getResponseJson=te.prototype.Oa,te.prototype.getResponseText=te.prototype.oa,te.prototype.send=te.prototype.ea,te.prototype.setWithCredentials=te.prototype.Ha,mu=te}).apply(typeof zr!="undefined"?zr:typeof self!="undefined"?self:typeof window!="undefined"?window:{});const Mc="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ut=new no("@firebase/firestore");function jn(){return Ut.logLevel}function L(n,...e){if(Ut.logLevel<=q.DEBUG){const t=e.map(mo);Ut.debug(`Firestore (${En}): ${n}`,...t)}}function rt(n,...e){if(Ut.logLevel<=q.ERROR){const t=e.map(mo);Ut.error(`Firestore (${En}): ${n}`,...t)}}function un(n,...e){if(Ut.logLevel<=q.WARN){const t=e.map(mo);Ut.warn(`Firestore (${En}): ${n}`,...t)}}function mo(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(n="Unexpected state"){const e=`FIRESTORE (${En}) INTERNAL ASSERTION FAILED: `+n;throw rt(e),new Error(e)}function J(n,e){n||F()}function B(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class go{constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=r=>this.ie(r),this.se=r=>t.writeSequenceNumber(r))}ie(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){const e=++this.previousValue;return this.se&&this.se(e),e}}go.oe=-1;function Ni(n){return n==null}function vi(n){return n===0&&1/n==-1/0}function Fg(n){return typeof n=="number"&&Number.isInteger(n)&&!vi(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xc(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function qt(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function Tu(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _o(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function yo(n){const e=n.mapValue.fields.__previous_value__;return _o(e)?yo(e):e}function ir(n){const e=It(n.mapValue.fields.__local_write_time__.timestampValue);return new ae(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Te{constructor(e,t,r,i,s,a,c){this.key=e,this.documentType=t,this.version=r,this.readTime=i,this.createTime=s,this.data=a,this.documentState=c}static newInvalidDocument(e){return new Te(e,0,$.min(),$.min(),$.min(),Se.empty(),0)}static newFoundDocument(e,t,r,i){return new Te(e,1,t,$.min(),r,i,0)}static newNoDocument(e,t){return new Te(e,2,t,$.min(),$.min(),Se.empty(),0)}static newUnknownDocument(e,t){return new Te(e,3,t,$.min(),$.min(),Se.empty(),2)}convertToFoundDocument(e,t){return!this.createTime.isEqual($.min())||this.documentType!==2&&this.documentType!==0||(this.createTime=e),this.version=e,this.documentType=1,this.data=t,this.documentState=0,this}convertToNoDocument(e){return this.version=e,this.documentType=2,this.data=Se.empty(),this.documentState=0,this}convertToUnknownDocument(e){return this.version=e,this.documentType=3,this.data=Se.empty(),this.documentState=2,this}setHasCommittedMutations(){return this.documentState=2,this}setHasLocalMutations(){return this.documentState=1,this.version=$.min(),this}setReadTime(e){return this.readTime=e,this}get hasLocalMutations(){return this.documentState===1}get hasCommittedMutations(){return this.documentState===2}get hasPendingWrites(){return this.hasLocalMutations||this.hasCommittedMutations}isValidDocument(){return this.documentType!==0}isFoundDocument(){return this.documentType===1}isNoDocument(){return this.documentType===2}isUnknownDocument(){return this.documentType===3}isEqual(e){return e instanceof Te&&this.key.isEqual(e.key)&&this.version.isEqual(e.version)&&this.documentType===e.documentType&&this.documentState===e.documentState&&this.data.isEqual(e.data)}mutableCopy(){return new Te(this.key,this.documentType,this.version,this.readTime,this.createTime,this.data.clone(),this.documentState)}toString(){return`Document(${this.key}, ${this.version}, ${JSON.stringify(this.data.value)}, {createTime: ${this.createTime}}), {documentType: ${this.documentType}}), {documentState: ${this.documentState}})`}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ei{constructor(e,t){this.position=e,this.inclusive=t}}function Hc(n,e,t){let r=0;for(let i=0;i<n.position.length;i++){const s=e[i],a=n.position[i];if(s.field.isKeyField()?r=M.comparator(M.fromName(a.referenceValue),t.key):r=dn(a,t.data.field(s.field)),s.dir==="desc"&&(r*=-1),r!==0)break}return r}function Wc(n,e){if(n===null)return e===null;if(e===null||n.inclusive!==e.inclusive||n.position.length!==e.position.length)return!1;for(let t=0;t<n.position.length;t++)if(!He(n.position[t],e.position[t]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bu{}class oe extends bu{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,r):new Wg(e,t,r):t==="array-contains"?new Kg(e,r):t==="in"?new Qg(e,r):t==="not-in"?new Jg(e,r):t==="array-contains-any"?new Yg(e,r):new oe(e,t,r)}static createKeyFieldInFilter(e,t,r){return t==="in"?new zg(e,r):new Gg(e,r)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&this.matchesComparison(dn(t,this.value)):t!==null&&Bt(this.value)===Bt(t)&&this.matchesComparison(dn(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return F()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class Fe extends bu{constructor(e,t){super(),this.filters=e,this.op=t,this.ae=null}static create(e,t){return new Fe(e,t)}matches(e){return Ru(this)?this.filters.find(t=>!t.matches(e))===void 0:this.filters.find(t=>t.matches(e))!==void 0}getFlattenedFilters(){return this.ae!==null||(this.ae=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.ae}getFilters(){return Object.assign([],this.filters)}}function Ru(n){return n.op==="and"}function Su(n){return Hg(n)&&Ru(n)}function Hg(n){for(const e of n.filters)if(e instanceof Fe)return!1;return!0}function Bs(n){if(n instanceof oe)return n.field.canonicalString()+n.op.toString()+fn(n.value);if(Su(n))return n.filters.map(e=>Bs(e)).join(",");{const e=n.filters.map(t=>Bs(t)).join(",");return`${n.op}(${e})`}}function Pu(n,e){return n instanceof oe?function(r,i){return i instanceof oe&&r.op===i.op&&r.field.isEqual(i.field)&&He(r.value,i.value)}(n,e):n instanceof Fe?function(r,i){return i instanceof Fe&&r.op===i.op&&r.filters.length===i.filters.length?r.filters.reduce((s,a,c)=>s&&Pu(a,i.filters[c]),!0):!1}(n,e):void F()}function Cu(n){return n instanceof oe?function(t){return`${t.field.canonicalString()} ${t.op} ${fn(t.value)}`}(n):n instanceof Fe?function(t){return t.op.toString()+" {"+t.getFilters().map(Cu).join(" ,")+"}"}(n):"Filter"}class Wg extends oe{constructor(e,t,r){super(e,t,r),this.key=M.fromName(r.referenceValue)}matches(e){const t=M.comparator(e.key,this.key);return this.matchesComparison(t)}}class zg extends oe{constructor(e,t){super(e,"in",t),this.keys=ku("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class Gg extends oe{constructor(e,t){super(e,"not-in",t),this.keys=ku("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function ku(n,e){var t;return(((t=e.arrayValue)===null||t===void 0?void 0:t.values)||[]).map(r=>M.fromName(r.referenceValue))}class Kg extends oe{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return vo(t)&&or(t.arrayValue,this.value)}}class Qg extends oe{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&or(this.value.arrayValue,t)}}class Jg extends oe{constructor(e,t){super(e,"not-in",t)}matches(e){if(or(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&!or(this.value.arrayValue,t)}}class Yg extends oe{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!vo(t)||!t.arrayValue.values)&&t.arrayValue.values.some(r=>or(this.value.arrayValue,r))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xg{constructor(e,t=null,r=[],i=[],s=null,a=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=i,this.limit=s,this.startAt=a,this.endAt=c,this.ue=null}}function zc(n,e=null,t=[],r=[],i=null,s=null,a=null){return new Xg(n,e,t,r,i,s,a)}function Eo(n){const e=B(n);if(e.ue===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(r=>Bs(r)).join(","),t+="|ob:",t+=e.orderBy.map(r=>function(s){return s.field.canonicalString()+s.dir}(r)).join(","),Ni(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(r=>fn(r)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(r=>fn(r)).join(",")),e.ue=t}return e.ue}function wo(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!qg(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!Pu(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Wc(n.startAt,e.startAt)&&Wc(n.endAt,e.endAt)}function js(n){return M.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tn{constructor(e,t){this.mapKeyFn=e,this.equalsFn=t,this.inner={},this.innerSize=0}get(e){const t=this.mapKeyFn(e),r=this.inner[t];if(r!==void 0){for(const[i,s]of r)if(this.equalsFn(i,e))return s}}has(e){return this.get(e)!==void 0}set(e,t){const r=this.mapKeyFn(e),i=this.inner[r];if(i===void 0)return this.inner[r]=[[e,t]],void this.innerSize++;for(let s=0;s<i.length;s++)if(this.equalsFn(i[s][0],e))return void(i[s]=[e,t]);i.push([e,t]),this.innerSize++}delete(e){const t=this.mapKeyFn(e),r=this.inner[t];if(r===void 0)return!1;for(let i=0;i<r.length;i++)if(this.equalsFn(r[i][0],e))return r.length===1?delete this.inner[t]:r.splice(i,1),this.innerSize--,!0;return!1}forEach(e){qt(this.inner,(t,r)=>{for(const[i,s]of r)e(i,s)})}isEmpty(){return Tu(this.inner)}size(){return this.innerSize}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Io(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:vi(e)?"-0":e}}function xu(n){return{integerValue:""+n}}function c_(n,e){return Fg(e)?xu(e):Io(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oi{constructor(){this._=void 0}}function l_(n,e,t){return n instanceof cr?function(i,s){const a={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:i.seconds,nanos:i.nanoseconds}}}};return s&&_o(s)&&(s=yo(s)),s&&(a.fields.__previous_value__=s),{mapValue:a}}(t,e):n instanceof lr?Uu(n,e):n instanceof ur?$u(n,e):function(i,s){const a=Fu(i,s),c=Kc(a)+Kc(i.Pe);return $s(a)&&$s(i.Pe)?xu(c):Io(i.serializer,c)}(n,e)}function u_(n,e,t){return n instanceof lr?Uu(n,e):n instanceof ur?$u(n,e):t}function Fu(n,e){return n instanceof Ti?function(r){return $s(r)||function(s){return!!s&&"doubleValue"in s}(r)}(e)?e:{integerValue:0}:null}class cr extends Oi{}class lr extends Oi{constructor(e){super(),this.elements=e}}function Uu(n,e){const t=Bu(e);for(const r of n.elements)t.some(i=>He(i,r))||t.push(r);return{arrayValue:{values:t}}}class ur extends Oi{constructor(e){super(),this.elements=e}}function $u(n,e){let t=Bu(e);for(const r of n.elements)t=t.filter(i=>!He(i,r));return{arrayValue:{values:t}}}class Ti extends Oi{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Kc(n){return ie(n.integerValue||n.doubleValue)}function Bu(n){return vo(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class h_{constructor(e,t){this.field=e,this.transform=t}}function d_(n,e){return n.field.isEqual(e.field)&&function(r,i){return r instanceof lr&&i instanceof lr||r instanceof ur&&i instanceof ur?hn(r.elements,i.elements,He):r instanceof Ti&&i instanceof Ti?He(r.Pe,i.Pe):r instanceof cr&&i instanceof cr}(n.transform,e.transform)}class f_{constructor(e,t){this.version=e,this.transformResults=t}}class Me{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Me}static exists(e){return new Me(void 0,e)}static updateTime(e){return new Me(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function si(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Mi{}function ju(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Ao(n.key,Me.none()):new yr(n.key,n.data,Me.none());{const t=n.data,r=Se.empty();let i=new pe(fe.comparator);for(let s of e.fields)if(!i.has(s)){let a=t.field(s);a===null&&s.length>1&&(s=s.popLast(),a=t.field(s)),a===null?r.delete(s):r.set(s,a),i=i.add(s)}return new Rt(n.key,r,new ke(i.toArray()),Me.none())}}function p_(n,e,t){n instanceof yr?function(i,s,a){const c=i.value.clone(),u=Jc(i.fieldTransforms,s,a.transformResults);c.setAll(u),s.convertToFoundDocument(a.version,c).setHasCommittedMutations()}(n,e,t):n instanceof Rt?function(i,s,a){if(!si(i.precondition,s))return void s.convertToUnknownDocument(a.version);const c=Jc(i.fieldTransforms,s,a.transformResults),u=s.data;u.setAll(qu(i)),u.setAll(c),s.convertToFoundDocument(a.version,u).setHasCommittedMutations()}(n,e,t):function(i,s,a){s.convertToNoDocument(a.version).setHasCommittedMutations()}(0,e,t)}function Zn(n,e,t,r){return n instanceof yr?function(s,a,c,u){if(!si(s.precondition,a))return c;const d=s.value.clone(),f=Yc(s.fieldTransforms,u,a);return d.setAll(f),a.convertToFoundDocument(a.version,d).setHasLocalMutations(),null}(n,e,t,r):n instanceof Rt?function(s,a,c,u){if(!si(s.precondition,a))return c;const d=Yc(s.fieldTransforms,u,a),f=a.data;return f.setAll(qu(s)),f.setAll(d),a.convertToFoundDocument(a.version,f).setHasLocalMutations(),c===null?null:c.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map(y=>y.field))}(n,e,t,r):function(s,a,c){return si(s.precondition,a)?(a.convertToNoDocument(a.version).setHasLocalMutations(),null):c}(n,e,t)}function m_(n,e){let t=null;for(const r of n.fieldTransforms){const i=e.data.field(r.field),s=Fu(r.transform,i||null);s!=null&&(t===null&&(t=Se.empty()),t.set(r.field,s))}return t||null}function Qc(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!function(r,i){return r===void 0&&i===void 0||!(!r||!i)&&hn(r,i,(s,a)=>d_(s,a))}(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class yr extends Mi{constructor(e,t,r,i=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class Rt extends Mi{constructor(e,t,r,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=i,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function qu(n){const e=new Map;return n.fieldMask.fields.forEach(t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}}),e}function Jc(n,e,t){const r=new Map;J(n.length===t.length);for(let i=0;i<t.length;i++){const s=n[i],a=s.transform,c=e.data.field(s.field);r.set(s.field,u_(a,c,t[i]))}return r}function Yc(n,e,t){const r=new Map;for(const i of n){const s=i.transform,a=t.data.field(i.field);r.set(i.field,l_(s,a,e))}return r}class Ao extends Mi{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class g_ extends Mi{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class __{constructor(e,t,r,i){this.batchId=e,this.localWriteTime=t,this.baseMutations=r,this.mutations=i}applyToRemoteDocument(e,t){const r=t.mutationResults;for(let i=0;i<this.mutations.length;i++){const s=this.mutations[i];s.key.isEqual(e.key)&&p_(s,e,r[i])}}applyToLocalView(e,t){for(const r of this.baseMutations)r.key.isEqual(e.key)&&(t=Zn(r,e,t,this.localWriteTime));for(const r of this.mutations)r.key.isEqual(e.key)&&(t=Zn(r,e,t,this.localWriteTime));return t}applyToLocalDocumentSet(e,t){const r=Mu();return this.mutations.forEach(i=>{const s=e.get(i.key),a=s.overlayedDocument;let c=this.applyToLocalView(a,s.mutatedFields);c=t.has(i.key)?null:c;const u=ju(a,c);u!==null&&r.set(i.key,u),a.isValidDocument()||a.convertToNoDocument($.min())}),r}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),j())}isEqual(e){return this.batchId===e.batchId&&hn(this.mutations,e.mutations,(t,r)=>Qc(t,r))&&hn(this.baseMutations,e.baseMutations,(t,r)=>Qc(t,r))}}class bo{constructor(e,t,r,i){this.batch=e,this.commitVersion=t,this.mutationResults=r,this.docVersions=i}static from(e,t,r){J(e.mutations.length===r.length);let i=function(){return i_}();const s=e.mutations;for(let a=0;a<s.length;a++)i=i.insert(s[a].key,r[a].version);return new bo(e,t,r,i)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T_=new Mt([4294967295,4294967295],0);function Xc(n){const e=w_().encode(n),t=new pu;return t.update(e),new Uint8Array(t.digest())}function Zc(n){const e=new DataView(n.buffer),t=e.getUint32(0,!0),r=e.getUint32(4,!0),i=e.getUint32(8,!0),s=e.getUint32(12,!0);return[new Mt([t,r],0),new Mt([i,s],0)]}class Ro{constructor(e,t,r){if(this.bitmap=e,this.padding=t,this.hashCount=r,t<0||t>=8)throw new Gn(`Invalid padding: ${t}`);if(r<0)throw new Gn(`Invalid hash count: ${r}`);if(e.length>0&&this.hashCount===0)throw new Gn(`Invalid hash count: ${r}`);if(e.length===0&&t!==0)throw new Gn(`Invalid padding when bitmap length is 0: ${t}`);this.Ie=8*e.length-t,this.Te=Mt.fromNumber(this.Ie)}Ee(e,t,r){let i=e.add(t.multiply(Mt.fromNumber(r)));return i.compare(T_)===1&&(i=new Mt([i.getBits(0),i.getBits(1)],0)),i.modulo(this.Te).toNumber()}de(e){return(this.bitmap[Math.floor(e/8)]&1<<e%8)!=0}mightContain(e){if(this.Ie===0)return!1;const t=Xc(e),[r,i]=Zc(t);for(let s=0;s<this.hashCount;s++){const a=this.Ee(r,i,s);if(!this.de(a))return!1}return!0}static create(e,t,r){const i=e%8==0?0:8-e%8,s=new Uint8Array(Math.ceil(e/8)),a=new Ro(s,i,t);return r.forEach(c=>a.insert(c)),a}insert(e){if(this.Ie===0)return;const t=Xc(e),[r,i]=Zc(t);for(let s=0;s<this.hashCount;s++){const a=this.Ee(r,i,s);this.Ae(a)}}Ae(e){const t=Math.floor(e/8),r=e%8;this.bitmap[t]|=1<<r}}class Gn extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xi{constructor(e,t,r,i,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const i=new Map;return i.set(e,vr.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new xi($.min(),i,new ee(z),it(),j())}}class vr{constructor(e,t,r,i,s){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new vr(r,t,j(),j(),j())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi{constructor(e,t,r,i){this.Re=e,this.removedTargetIds=t,this.key=r,this.Ve=i}}class Wu{constructor(e,t){this.targetId=e,this.me=t}}class zu{constructor(e,t,r=me.EMPTY_BYTE_STRING,i=null){this.state=e,this.targetIds=t,this.resumeToken=r,this.cause=i}}class el{constructor(){this.fe=0,this.ge=nl(),this.pe=me.EMPTY_BYTE_STRING,this.ye=!1,this.we=!0}get current(){return this.ye}get resumeToken(){return this.pe}get Se(){return this.fe!==0}get be(){return this.we}De(e){e.approximateByteSize()>0&&(this.we=!0,this.pe=e)}ve(){let e=j(),t=j(),r=j();return this.ge.forEach((i,s)=>{switch(s){case 0:e=e.add(i);break;case 2:t=t.add(i);break;case 1:r=r.add(i);break;default:F()}}),new vr(this.pe,this.ye,e,t,r)}Ce(){this.we=!1,this.ge=nl()}Fe(e,t){this.we=!0,this.ge=this.ge.insert(e,t)}Me(e){this.we=!0,this.ge=this.ge.remove(e)}xe(){this.fe+=1}Oe(){this.fe-=1,J(this.fe>=0)}Ne(){this.we=!0,this.ye=!0}}class I_{constructor(e){this.Le=e,this.Be=new Map,this.ke=it(),this.qe=tl(),this.Qe=new ee(z)}Ke(e){for(const t of e.Re)e.Ve&&e.Ve.isFoundDocument()?this.$e(t,e.Ve):this.Ue(t,e.key,e.Ve);for(const t of e.removedTargetIds)this.Ue(t,e.key,e.Ve)}We(e){this.forEachTarget(e,t=>{const r=this.Ge(t);switch(e.state){case 0:this.ze(t)&&r.De(e.resumeToken);break;case 1:r.Oe(),r.Se||r.Ce(),r.De(e.resumeToken);break;case 2:r.Oe(),r.Se||this.removeTarget(t);break;case 3:this.ze(t)&&(r.Ne(),r.De(e.resumeToken));break;case 4:this.ze(t)&&(this.je(t),r.De(e.resumeToken));break;default:F()}})}forEachTarget(e,t){e.targetIds.length>0?e.targetIds.forEach(t):this.Be.forEach((r,i)=>{this.ze(i)&&t(i)})}He(e){const t=e.targetId,r=e.me.count,i=this.Je(t);if(i){const s=i.target;if(js(s))if(r===0){const a=new M(s.path);this.Ue(t,a,Te.newNoDocument(a,$.min()))}else J(r===1);else{const a=this.Ye(t);if(a!==r){const c=this.Ze(e),u=c?this.Xe(c,e,a):1;if(u!==0){this.je(t);const d=u===2?"TargetPurposeExistenceFilterMismatchBloom":"TargetPurposeExistenceFilterMismatch";this.Qe=this.Qe.insert(t,d)}}}}}Ze(e){const t=e.me.unchangedNames;if(!t||!t.bits)return null;const{bits:{bitmap:r="",padding:i=0},hashCount:s=0}=t;let a,c;try{a=$t(r).toUint8Array()}catch(u){if(u instanceof Iu)return un("Decoding the base64 bloom filter in existence filter failed ("+u.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw u}try{c=new Ro(a,i,s)}catch(u){return un(u instanceof Gn?"BloomFilter error: ":"Applying bloom filter failed: ",u),null}return c.Ie===0?null:c}Xe(e,t,r){return t.me.count===r-this.nt(e,t.targetId)?0:2}nt(e,t){const r=this.Le.getRemoteKeysForTarget(t);let i=0;return r.forEach(s=>{const a=this.Le.tt(),c=`projects/${a.projectId}/databases/${a.database}/documents/${s.path.canonicalString()}`;e.mightContain(c)||(this.Ue(t,s,null),i++)}),i}rt(e){const t=new Map;this.Be.forEach((s,a)=>{const c=this.Je(a);if(c){if(s.current&&js(c.target)){const u=new M(c.target.path);this.ke.get(u)!==null||this.it(a,u)||this.Ue(a,u,Te.newNoDocument(u,e))}s.be&&(t.set(a,s.ve()),s.Ce())}});let r=j();this.qe.forEach((s,a)=>{let c=!0;a.forEachWhile(u=>{const d=this.Je(u);return!d||d.purpose==="TargetPurposeLimboResolution"||(c=!1,!1)}),c&&(r=r.add(s))}),this.ke.forEach((s,a)=>a.setReadTime(e));const i=new xi(e,t,this.Qe,this.ke,r);return this.ke=it(),this.qe=tl(),this.Qe=new ee(z),i}$e(e,t){if(!this.ze(e))return;const r=this.it(e,t.key)?2:0;this.Ge(e).Fe(t.key,r),this.ke=this.ke.insert(t.key,t),this.qe=this.qe.insert(t.key,this.st(t.key).add(e))}Ue(e,t,r){if(!this.ze(e))return;const i=this.Ge(e);this.it(e,t)?i.Fe(t,1):i.Me(t),this.qe=this.qe.insert(t,this.st(t).delete(e)),r&&(this.ke=this.ke.insert(t,r))}removeTarget(e){this.Be.delete(e)}Ye(e){const t=this.Ge(e).ve();return this.Le.getRemoteKeysForTarget(e).size+t.addedDocuments.size-t.removedDocuments.size}xe(e){this.Ge(e).xe()}Ge(e){let t=this.Be.get(e);return t||(t=new el,this.Be.set(e,t)),t}st(e){let t=this.qe.get(e);return t||(t=new pe(z),this.qe=this.qe.insert(e,t)),t}ze(e){const t=this.Je(e)!==null;return t||L("WatchChangeAggregator","Detected inactive target",e),t}Je(e){const t=this.Be.get(e);return t&&t.Se?null:this.Le.ot(e)}je(e){this.Be.set(e,new el),this.Le.getRemoteKeysForTarget(e).forEach(t=>{this.Ue(e,t,null)})}it(e,t){return this.Le.getRemoteKeysForTarget(e).has(t)}}function tl(){return new ee(M.comparator)}function nl(){return new ee(M.comparator)}const A_={asc:"ASCENDING",desc:"DESCENDING"},b_={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},R_={and:"AND",or:"OR"};class S_{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}function Hs(n,e){return n.useProto3Json||Ni(e)?e:{value:e}}function Ii(n,e){return n.useProto3Json?`${new Date(1e3*e.seconds).toISOString().replace(/\.\d*/,"").replace("Z","")}.${("000000000"+e.nanoseconds).slice(-9)}Z`:{seconds:""+e.seconds,nanos:e.nanoseconds}}function Gu(n,e){return n.useProto3Json?e.toBase64():e.toUint8Array()}function P_(n,e){return Ii(n,e.toTimestamp())}function qe(n){return J(!!n),$.fromTimestamp(function(t){const r=It(t);return new ae(r.seconds,r.nanos)}(n))}function So(n,e){return Ws(n,e).canonicalString()}function Ws(n,e){const t=function(i){return new Z(["projects",i.projectId,"databases",i.database])}(n).child("documents");return e===void 0?t:t.child(e)}function Ku(n){const e=Z.fromString(n);return J(Zu(e)),e}function zs(n,e){return So(n.databaseId,e.path)}function bs(n,e){const t=Ku(e);if(t.get(1)!==n.databaseId.projectId)throw new V(S.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+t.get(1)+" vs "+n.databaseId.projectId);if(t.get(3)!==n.databaseId.database)throw new V(S.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+t.get(3)+" vs "+n.databaseId.database);return new M(Ju(t))}function Qu(n,e){return So(n.databaseId,e)}function C_(n){const e=Ku(n);return e.length===4?Z.emptyPath():Ju(e)}function Gs(n){return new Z(["projects",n.databaseId.projectId,"databases",n.databaseId.database]).canonicalString()}function Ju(n){return J(n.length>4&&n.get(4)==="documents"),n.popFirst(5)}function rl(n,e,t){return{name:zs(n,e),fields:t.value.mapValue.fields}}function k_(n,e){let t;if("targetChange"in e){e.targetChange;const r=function(d){return d==="NO_CHANGE"?0:d==="ADD"?1:d==="REMOVE"?2:d==="CURRENT"?3:d==="RESET"?4:F()}(e.targetChange.targetChangeType||"NO_CHANGE"),i=e.targetChange.targetIds||[],s=function(d,f){return d.useProto3Json?(J(f===void 0||typeof f=="string"),me.fromBase64String(f||"")):(J(f===void 0||f instanceof Buffer||f instanceof Uint8Array),me.fromUint8Array(f||new Uint8Array))}(n,e.targetChange.resumeToken),a=e.targetChange.cause,c=a&&function(d){const f=d.code===void 0?S.UNKNOWN:Hu(d.code);return new V(f,d.message||"")}(a);t=new zu(r,i,s,c||null)}else if("documentChange"in e){e.documentChange;const r=e.documentChange;r.document,r.document.name,r.document.updateTime;const i=bs(n,r.document.name),s=qe(r.document.updateTime),a=r.document.createTime?qe(r.document.createTime):$.min(),c=new Se({mapValue:{fields:r.document.fields}}),u=Te.newFoundDocument(i,s,a,c),d=r.targetIds||[],f=r.removedTargetIds||[];t=new oi(d,f,u.key,u)}else if("documentDelete"in e){e.documentDelete;const r=e.documentDelete;r.document;const i=bs(n,r.document),s=r.readTime?qe(r.readTime):$.min(),a=Te.newNoDocument(i,s),c=r.removedTargetIds||[];t=new oi([],c,a.key,a)}else if("documentRemove"in e){e.documentRemove;const r=e.documentRemove;r.document;const i=bs(n,r.document),s=r.removedTargetIds||[];t=new oi([],s,i,null)}else{if(!("filter"in e))return F();{e.filter;const r=e.filter;r.targetId;const{count:i=0,unchangedNames:s}=r,a=new v_(i,s),c=r.targetId;t=new Wu(c,a)}}return t}function D_(n,e){let t;if(e instanceof yr)t={update:rl(n,e.key,e.value)};else if(e instanceof Ao)t={delete:zs(n,e.key)};else if(e instanceof Rt)t={update:rl(n,e.key,e.data),updateMask:$_(e.fieldMask)};else{if(!(e instanceof g_))return F();t={verify:zs(n,e.key)}}return e.fieldTransforms.length>0&&(t.updateTransforms=e.fieldTransforms.map(r=>function(s,a){const c=a.transform;if(c instanceof cr)return{fieldPath:a.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(c instanceof lr)return{fieldPath:a.field.canonicalString(),appendMissingElements:{values:c.elements}};if(c instanceof ur)return{fieldPath:a.field.canonicalString(),removeAllFromArray:{values:c.elements}};if(c instanceof Ti)return{fieldPath:a.field.canonicalString(),increment:c.Pe};throw F()}(0,r))),e.precondition.isNone||(t.currentDocument=function(i,s){return s.updateTime!==void 0?{updateTime:P_(i,s.updateTime)}:s.exists!==void 0?{exists:s.exists}:F()}(n,e.precondition)),t}function N_(n,e){return n&&n.length>0?(J(e!==void 0),n.map(t=>function(i,s){let a=i.updateTime?qe(i.updateTime):qe(s);return a.isEqual($.min())&&(a=qe(s)),new f_(a,i.transformResults||[])}(t,e))):[]}function V_(n,e){return{documents:[Qu(n,e.path)]}}function L_(n,e){const t={structuredQuery:{}},r=e.path;let i;e.collectionGroup!==null?(i=r,t.structuredQuery.from=[{collectionId:e.collectionGroup,allDescendants:!0}]):(i=r.popLast(),t.structuredQuery.from=[{collectionId:r.lastSegment()}]),t.parent=Qu(n,i);const s=function(d){if(d.length!==0)return Xu(Fe.create(d,"and"))}(e.filters);s&&(t.structuredQuery.where=s);const a=function(d){if(d.length!==0)return d.map(f=>function(E){return{field:Zt(E.field),direction:x_(E.dir)}}(f))}(e.orderBy);a&&(t.structuredQuery.orderBy=a);const c=Hs(n,e.limit);return c!==null&&(t.structuredQuery.limit=c),e.startAt&&(t.structuredQuery.startAt=function(d){return{before:d.inclusive,values:d.position}}(e.startAt)),e.endAt&&(t.structuredQuery.endAt=function(d){return{before:!d.inclusive,values:d.position}}(e.endAt)),{_t:t,parent:i}}function O_(n){let e=C_(n.parent);const t=n.structuredQuery,r=t.from?t.from.length:0;let i=null;if(r>0){J(r===1);const f=t.from[0];f.allDescendants?i=f.collectionId:e=e.child(f.collectionId)}let s=[];t.where&&(s=function(y){const E=Yu(y);return E instanceof Fe&&Su(E)?E.getFilters():[E]}(t.where));let a=[];t.orderBy&&(a=function(y){return y.map(E=>function(k){return new ar(en(k.field),function(N){switch(N){case"ASCENDING":return"asc";case"DESCENDING":return"desc";default:return}}(k.direction))}(E))}(t.orderBy));let c=null;t.limit&&(c=function(y){let E;return E=typeof y=="object"?y.value:y,Ni(E)?null:E}(t.limit));let u=null;t.startAt&&(u=function(y){const E=!!y.before,R=y.values||[];return new Ei(R,E)}(t.startAt));let d=null;return t.endAt&&(d=function(y){const E=!y.before,R=y.values||[];return new Ei(R,E)}(t.endAt)),Zg(e,i,a,s,c,"F",u,d)}function M_(n,e){const t=function(i){switch(i){case"TargetPurposeListen":return null;case"TargetPurposeExistenceFilterMismatch":return"existence-filter-mismatch";case"TargetPurposeExistenceFilterMismatchBloom":return"existence-filter-mismatch-bloom";case"TargetPurposeLimboResolution":return"limbo-document";default:return F()}}(e.purpose);return t==null?null:{"goog-listen-tags":t}}function Yu(n){return n.unaryFilter!==void 0?function(t){switch(t.unaryFilter.op){case"IS_NAN":const r=en(t.unaryFilter.field);return oe.create(r,"==",{doubleValue:NaN});case"IS_NULL":const i=en(t.unaryFilter.field);return oe.create(i,"==",{nullValue:"NULL_VALUE"});case"IS_NOT_NAN":const s=en(t.unaryFilter.field);return oe.create(s,"!=",{doubleValue:NaN});case"IS_NOT_NULL":const a=en(t.unaryFilter.field);return oe.create(a,"!=",{nullValue:"NULL_VALUE"});default:return F()}}(n):n.fieldFilter!==void 0?function(t){return oe.create(en(t.fieldFilter.field),function(i){switch(i){case"EQUAL":return"==";case"NOT_EQUAL":return"!=";case"GREATER_THAN":return">";case"GREATER_THAN_OR_EQUAL":return">=";case"LESS_THAN":return"<";case"LESS_THAN_OR_EQUAL":return"<=";case"ARRAY_CONTAINS":return"array-contains";case"IN":return"in";case"NOT_IN":return"not-in";case"ARRAY_CONTAINS_ANY":return"array-contains-any";default:return F()}}(t.fieldFilter.op),t.fieldFilter.value)}(n):n.compositeFilter!==void 0?function(t){return Fe.create(t.compositeFilter.filters.map(r=>Yu(r)),function(i){switch(i){case"AND":return"and";case"OR":return"or";default:return F()}}(t.compositeFilter.op))}(n):F()}function x_(n){return A_[n]}function F_(n){return b_[n]}function U_(n){return R_[n]}function Zt(n){return{fieldPath:n.canonicalString()}}function en(n){return fe.fromServerFormat(n.fieldPath)}function Xu(n){return n instanceof oe?function(t){if(t.op==="=="){if(qc(t.value))return{unaryFilter:{field:Zt(t.field),op:"IS_NAN"}};if(jc(t.value))return{unaryFilter:{field:Zt(t.field),op:"IS_NULL"}}}else if(t.op==="!="){if(qc(t.value))return{unaryFilter:{field:Zt(t.field),op:"IS_NOT_NAN"}};if(jc(t.value))return{unaryFilter:{field:Zt(t.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:Zt(t.field),op:F_(t.op),value:t.value}}}(n):n instanceof Fe?function(t){const r=t.getFilters().map(i=>Xu(i));return r.length===1?r[0]:{compositeFilter:{op:U_(t.op),filters:r}}}(n):F()}function $_(n){const e=[];return n.fields.forEach(t=>e.push(t.canonicalString())),{fieldPaths:e}}function Zu(n){return n.length>=4&&n.get(0)==="projects"&&n.get(2)==="databases"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Po{constructor(){this.Tr=new pe(le.Er),this.dr=new pe(le.Ar)}isEmpty(){return this.Tr.isEmpty()}addReference(e,t){const r=new le(e,t);this.Tr=this.Tr.add(r),this.dr=this.dr.add(r)}Rr(e,t){e.forEach(r=>this.addReference(r,t))}removeReference(e,t){this.Vr(new le(e,t))}mr(e,t){e.forEach(r=>this.removeReference(r,t))}gr(e){const t=new M(new Z([])),r=new le(t,e),i=new le(t,e+1),s=[];return this.dr.forEachInRange([r,i],a=>{this.Vr(a),s.push(a.key)}),s}pr(){this.Tr.forEach(e=>this.Vr(e))}Vr(e){this.Tr=this.Tr.delete(e),this.dr=this.dr.delete(e)}yr(e){const t=new M(new Z([])),r=new le(t,e),i=new le(t,e+1);let s=j();return this.dr.forEachInRange([r,i],a=>{s=s.add(a.key)}),s}containsKey(e){const t=new le(e,0),r=this.Tr.firstAfterOrEqual(t);return r!==null&&e.isEqual(r.key)}}class le{constructor(e,t){this.key=e,this.wr=t}static Er(e,t){return M.comparator(e.key,t.key)||z(e.wr,t.wr)}static Ar(e,t){return z(e.wr,t.wr)||M.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ty{constructor(e,t){this.qr={},this.overlays={},this.Qr=new go(0),this.Kr=!1,this.Kr=!0,this.$r=new J_,this.referenceDelegate=e(this),this.Ur=new ey(this),this.indexManager=new q_,this.remoteDocumentCache=function(i){return new X_(i)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new B_(t),this.Gr=new K_(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new Q_,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new Y_(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){L("MemoryPersistence","Starting transaction:",e);const i=new ny(this.Qr.next());return this.referenceDelegate.zr(),r(i).next(s=>this.referenceDelegate.jr(i).next(()=>s)).toPromise().then(s=>(i.raiseOnCommittedEvent(),s))}Hr(e,t){return P.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class ny extends Mg{constructor(e){super(),this.currentSequenceNumber=e}}class Co{constructor(e){this.persistence=e,this.Jr=new Po,this.Yr=null}static Zr(e){return new Co(e)}get Xr(){if(this.Yr)return this.Yr;throw F()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),P.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),P.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),P.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(i=>this.Xr.add(i.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(i=>{i.forEach(s=>this.Xr.add(s.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return P.forEach(this.Xr,r=>{const i=M.fromPath(r);return this.ei(e,i).next(s=>{s||t.removeEntry(i,$.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return P.or([()=>P.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sy{constructor(e,t,r,i){this.persistence=e,this.ss=t,this.serializer=i,this.os=new ee(z),this._s=new Tn(s=>Eo(s),wo),this.us=new Map,this.cs=e.getRemoteDocumentCache(),this.Ur=e.getTargetCache(),this.Gr=e.getBundleCache(),this.ls(r)}ls(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new G_(this.cs,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.cs.setIndexManager(this.indexManager),this.ss.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",t=>e.collect(t,this.os))}}function oy(n,e,t,r){return new sy(n,e,t,r)}async function eh(n,e){const t=B(n);return await t.persistence.runTransaction("Handle user change","readonly",r=>{let i;return t.mutationQueue.getAllMutationBatches(r).next(s=>(i=s,t.ls(e),t.mutationQueue.getAllMutationBatches(r))).next(s=>{const a=[],c=[];let u=j();for(const d of i){a.push(d.batchId);for(const f of d.mutations)u=u.add(f.key)}for(const d of s){c.push(d.batchId);for(const f of d.mutations)u=u.add(f.key)}return t.localDocuments.getDocuments(r,u).next(d=>({hs:d,removedBatchIds:a,addedBatchIds:c}))})})}function ay(n,e){const t=B(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",r=>{const i=e.batch.keys(),s=t.cs.newChangeBuffer({trackRemovals:!0});return function(c,u,d,f){const y=d.batch,E=y.keys();let R=P.resolve();return E.forEach(k=>{R=R.next(()=>f.getEntry(u,k)).next(O=>{const N=d.docVersions.get(k);J(N!==null),O.version.compareTo(N)<0&&(y.applyToRemoteDocument(O,d),O.isValidDocument()&&(O.setReadTime(d.commitVersion),f.addEntry(O)))})}),R.next(()=>c.mutationQueue.removeMutationBatch(u,y))}(t,r,e,s).next(()=>s.apply(r)).next(()=>t.mutationQueue.performConsistencyCheck(r)).next(()=>t.documentOverlayCache.removeOverlaysForBatchId(r,i,e.batch.batchId)).next(()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,function(c){let u=j();for(let d=0;d<c.mutationResults.length;++d)c.mutationResults[d].transformResults.length>0&&(u=u.add(c.batch.mutations[d].key));return u}(e))).next(()=>t.localDocuments.getDocuments(r,i))})}function th(n){const e=B(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Ur.getLastRemoteSnapshotVersion(t))}function cy(n,e){const t=B(n),r=e.snapshotVersion;let i=t.os;return t.persistence.runTransaction("Apply remote event","readwrite-primary",s=>{const a=t.cs.newChangeBuffer({trackRemovals:!0});i=t.os;const c=[];e.targetChanges.forEach((f,y)=>{const E=i.get(y);if(!E)return;c.push(t.Ur.removeMatchingKeys(s,f.removedDocuments,y).next(()=>t.Ur.addMatchingKeys(s,f.addedDocuments,y)));let R=E.withSequenceNumber(s.currentSequenceNumber);e.targetMismatches.get(y)!==null?R=R.withResumeToken(me.EMPTY_BYTE_STRING,$.min()).withLastLimboFreeSnapshotVersion($.min()):f.resumeToken.approximateByteSize()>0&&(R=R.withResumeToken(f.resumeToken,r)),i=i.insert(y,R),function(O,N,G){return O.resumeToken.approximateByteSize()===0||N.snapshotVersion.toMicroseconds()-O.snapshotVersion.toMicroseconds()>=3e8?!0:G.addedDocuments.size+G.modifiedDocuments.size+G.removedDocuments.size>0}(E,R,f)&&c.push(t.Ur.updateTargetData(s,R))});let u=it(),d=j();if(e.documentUpdates.forEach(f=>{e.resolvedLimboDocuments.has(f)&&c.push(t.persistence.referenceDelegate.updateLimboDocument(s,f))}),c.push(ly(s,a,e.documentUpdates).next(f=>{u=f.Ps,d=f.Is})),!r.isEqual($.min())){const f=t.Ur.getLastRemoteSnapshotVersion(s).next(y=>t.Ur.setTargetsMetadata(s,s.currentSequenceNumber,r));c.push(f)}return P.waitFor(c).next(()=>a.apply(s)).next(()=>t.localDocuments.getLocalViewOfDocuments(s,u,d)).next(()=>u)}).then(s=>(t.os=i,s))}function ly(n,e,t){let r=j(),i=j();return t.forEach(s=>r=r.add(s)),e.getEntries(n,r).next(s=>{let a=it();return t.forEach((c,u)=>{const d=s.get(c);u.isFoundDocument()!==d.isFoundDocument()&&(i=i.add(c)),u.isNoDocument()&&u.version.isEqual($.min())?(e.removeEntry(c,u.readTime),a=a.insert(c,u)):!d.isValidDocument()||u.version.compareTo(d.version)>0||u.version.compareTo(d.version)===0&&d.hasPendingWrites?(e.addEntry(u),a=a.insert(c,u)):L("LocalStore","Ignoring outdated watch update for ",c,". Current version:",d.version," Watch version:",u.version)}),{Ps:a,Is:i}})}function uy(n,e){const t=B(n);return t.persistence.runTransaction("Get next mutation batch","readonly",r=>(e===void 0&&(e=-1),t.mutationQueue.getNextMutationBatchAfterBatchId(r,e)))}function hy(n,e){const t=B(n);return t.persistence.runTransaction("Allocate target","readwrite",r=>{let i;return t.Ur.getTargetData(r,e).next(s=>s?(i=s,P.resolve(i)):t.Ur.allocateTargetId(r).next(a=>(i=new gt(e,a,"TargetPurposeListen",r.currentSequenceNumber),t.Ur.addTargetData(r,i).next(()=>i))))}).then(r=>{const i=t.os.get(r.targetId);return(i===null||r.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(t.os=t.os.insert(r.targetId,r),t._s.set(e,r.targetId)),r})}async function Ks(n,e,t){const r=B(n),i=r.os.get(e),s=t?"readwrite":"readwrite-primary";try{t||await r.persistence.runTransaction("Release target",s,a=>r.persistence.referenceDelegate.removeTarget(a,i))}catch(a){if(!_r(a))throw a;L("LocalStore",`Failed to update sequence numbers for target ${e}: ${a}`)}r.os=r.os.remove(e),r._s.delete(i.target)}function il(n,e,t){const r=B(n);let i=$.min(),s=j();return r.persistence.runTransaction("Execute query","readwrite",a=>function(u,d,f){const y=B(u),E=y._s.get(f);return E!==void 0?P.resolve(y.os.get(E)):y.Ur.getTargetData(d,f)}(r,a,je(e)).next(c=>{if(c)return i=c.lastLimboFreeSnapshotVersion,r.Ur.getMatchingKeysForTargetId(a,c.targetId).next(u=>{s=u})}).next(()=>r.ss.getDocumentsMatchingQuery(a,e,t?i:$.min(),t?s:j())).next(c=>(dy(r,t_(e),c),{documents:c,Ts:s})))}function dy(n,e,t){let r=n.us.get(e)||$.min();t.forEach((i,s)=>{s.readTime.compareTo(r)>0&&(r=s.readTime)}),n.us.set(e,r)}class sl{constructor(){this.activeTargetIds=a_()}fs(e){this.activeTargetIds=this.activeTargetIds.add(e)}gs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Vs(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class fy{constructor(){this.so=new sl,this.oo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,r){}addLocalQueryTarget(e,t=!0){return t&&this.so.fs(e),this.oo[e]||"not-current"}updateQueryState(e,t,r){this.oo[e]=t}removeLocalQueryTarget(e){this.so.gs(e)}isLocalQueryTarget(e){return this.so.activeTargetIds.has(e)}clearQueryState(e){delete this.oo[e]}getAllActiveQueryTargets(){return this.so.activeTargetIds}isActiveQueryTarget(e){return this.so.activeTargetIds.has(e)}start(){return this.so=new sl,Promise.resolve()}handleUserChange(e,t,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ol{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){L("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){L("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return typeof window!="undefined"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rh{constructor(e,t,r,i,s,a,c,u){this.ui=e,this.Ho=r,this.Jo=i,this.connection=s,this.authCredentialsProvider=a,this.appCheckCredentialsProvider=c,this.listener=u,this.state=0,this.Yo=0,this.Zo=null,this.Xo=null,this.stream=null,this.e_=0,this.t_=new nh(e,t)}n_(){return this.state===1||this.state===5||this.r_()}r_(){return this.state===2||this.state===3}start(){this.e_=0,this.state!==4?this.auth():this.i_()}async stop(){this.n_()&&await this.close(0)}s_(){this.state=0,this.t_.reset()}o_(){this.r_()&&this.Zo===null&&(this.Zo=this.ui.enqueueAfterDelay(this.Ho,6e4,()=>this.__()))}a_(e){this.u_(),this.stream.send(e)}async __(){if(this.r_())return this.close(0)}u_(){this.Zo&&(this.Zo.cancel(),this.Zo=null)}c_(){this.Xo&&(this.Xo.cancel(),this.Xo=null)}async close(e,t){this.u_(),this.c_(),this.t_.cancel(),this.Yo++,e!==4?this.t_.reset():t&&t.code===S.RESOURCE_EXHAUSTED?(rt(t.toString()),rt("Using maximum backoff delay to prevent overloading the backend."),this.t_.Wo()):t&&t.code===S.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.l_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.mo(t)}l_(){}auth(){this.state=1;const e=this.h_(this.Yo),t=this.Yo;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then(([r,i])=>{this.Yo===t&&this.P_(r,i)},r=>{e(()=>{const i=new V(S.UNKNOWN,"Fetching auth token failed: "+r.message);return this.I_(i)})})}P_(e,t){const r=this.h_(this.Yo);this.stream=this.T_(e,t),this.stream.Eo(()=>{r(()=>this.listener.Eo())}),this.stream.Ro(()=>{r(()=>(this.state=2,this.Xo=this.ui.enqueueAfterDelay(this.Jo,1e4,()=>(this.r_()&&(this.state=3),Promise.resolve())),this.listener.Ro()))}),this.stream.mo(i=>{r(()=>this.I_(i))}),this.stream.onMessage(i=>{r(()=>++this.e_==1?this.E_(i):this.onNext(i))})}i_(){this.state=5,this.t_.Go(async()=>{this.state=0,this.start()})}I_(e){return L("PersistentStream",`close with error: ${e}`),this.stream=null,this.close(4,e)}h_(e){return t=>{this.ui.enqueueAndForget(()=>this.Yo===e?t():(L("PersistentStream","stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve()))}}}class yy extends rh{constructor(e,t,r,i,s,a){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,r,i,a),this.serializer=s}T_(e,t){return this.connection.Bo("Listen",e,t)}E_(e){return this.onNext(e)}onNext(e){this.t_.reset();const t=k_(this.serializer,e),r=function(s){if(!("targetChange"in s))return $.min();const a=s.targetChange;return a.targetIds&&a.targetIds.length?$.min():a.readTime?qe(a.readTime):$.min()}(e);return this.listener.d_(t,r)}A_(e){const t={};t.database=Gs(this.serializer),t.addTarget=function(s,a){let c;const u=a.target;if(c=js(u)?{documents:V_(s,u)}:{query:L_(s,u)._t},c.targetId=a.targetId,a.resumeToken.approximateByteSize()>0){c.resumeToken=Gu(s,a.resumeToken);const d=Hs(s,a.expectedCount);d!==null&&(c.expectedCount=d)}else if(a.snapshotVersion.compareTo($.min())>0){c.readTime=Ii(s,a.snapshotVersion.toTimestamp());const d=Hs(s,a.expectedCount);d!==null&&(c.expectedCount=d)}return c}(this.serializer,e);const r=M_(this.serializer,e);r&&(t.labels=r),this.a_(t)}R_(e){const t={};t.database=Gs(this.serializer),t.removeTarget=e,this.a_(t)}}class vy extends rh{constructor(e,t,r,i,s,a){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,r,i,a),this.serializer=s}get V_(){return this.e_>0}start(){this.lastStreamToken=void 0,super.start()}l_(){this.V_&&this.m_([])}T_(e,t){return this.connection.Bo("Write",e,t)}E_(e){return J(!!e.streamToken),this.lastStreamToken=e.streamToken,J(!e.writeResults||e.writeResults.length===0),this.listener.f_()}onNext(e){J(!!e.streamToken),this.lastStreamToken=e.streamToken,this.t_.reset();const t=N_(e.writeResults,e.commitTime),r=qe(e.commitTime);return this.listener.g_(r,t)}p_(){const e={};e.database=Gs(this.serializer),this.a_(e)}m_(e){const t={streamToken:this.lastStreamToken,writes:e.map(r=>D_(this.serializer,r))};this.a_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ty{constructor(e,t,r,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.O_=[],this.N_=new Map,this.L_=new Set,this.B_=[],this.k_=s,this.k_._o(a=>{r.enqueueAndForget(async()=>{Ht(this)&&(L("RemoteStore","Restarting streams for network reachability change."),await async function(u){const d=B(u);d.L_.add(4),await Er(d),d.q_.set("Unknown"),d.L_.delete(4),await Ui(d)}(this))})}),this.q_=new wy(r,i)}}async function Ui(n){if(Ht(n))for(const e of n.B_)await e(!0)}async function Er(n){for(const e of n.B_)await e(!1)}function ih(n,e){const t=B(n);t.N_.has(e.targetId)||(t.N_.set(e.targetId,e),Lo(t)?Vo(t):In(t).r_()&&No(t,e))}function Do(n,e){const t=B(n),r=In(t);t.N_.delete(e),r.r_()&&sh(t,e),t.N_.size===0&&(r.r_()?r.o_():Ht(t)&&t.q_.set("Unknown"))}function No(n,e){if(n.Q_.xe(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo($.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}In(n).A_(e)}function sh(n,e){n.Q_.xe(e),In(n).R_(e)}function Vo(n){n.Q_=new I_({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),ot:e=>n.N_.get(e)||null,tt:()=>n.datastore.serializer.databaseId}),In(n).start(),n.q_.v_()}function Lo(n){return Ht(n)&&!In(n).n_()&&n.N_.size>0}function Ht(n){return B(n).L_.size===0}function oh(n){n.Q_=void 0}async function Iy(n){n.q_.set("Online")}async function Ay(n){n.N_.forEach((e,t)=>{No(n,e)})}async function by(n,e){oh(n),Lo(n)?(n.q_.M_(e),Vo(n)):n.q_.set("Unknown")}async function Ry(n,e,t){if(n.q_.set("Online"),e instanceof zu&&e.state===2&&e.cause)try{await async function(i,s){const a=s.cause;for(const c of s.targetIds)i.N_.has(c)&&(await i.remoteSyncer.rejectListen(c,a),i.N_.delete(c),i.Q_.removeTarget(c))}(n,e)}catch(r){L("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Ai(n,r)}else if(e instanceof oi?n.Q_.Ke(e):e instanceof Wu?n.Q_.He(e):n.Q_.We(e),!t.isEqual($.min()))try{const r=await th(n.localStore);t.compareTo(r)>=0&&await function(s,a){const c=s.Q_.rt(a);return c.targetChanges.forEach((u,d)=>{if(u.resumeToken.approximateByteSize()>0){const f=s.N_.get(d);f&&s.N_.set(d,f.withResumeToken(u.resumeToken,a))}}),c.targetMismatches.forEach((u,d)=>{const f=s.N_.get(u);if(!f)return;s.N_.set(u,f.withResumeToken(me.EMPTY_BYTE_STRING,f.snapshotVersion)),sh(s,u);const y=new gt(f.target,u,d,f.sequenceNumber);No(s,y)}),s.remoteSyncer.applyRemoteEvent(c)}(n,t)}catch(r){L("RemoteStore","Failed to raise snapshot:",r),await Ai(n,r)}}async function Ai(n,e,t){if(!_r(e))throw e;n.L_.add(1),await Er(n),n.q_.set("Offline"),t||(t=()=>th(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{L("RemoteStore","Retrying IndexedDB access"),await t(),n.L_.delete(1),await Ui(n)})}function ah(n,e){return e().catch(t=>Ai(n,t,e))}async function $i(n){const e=B(n),t=At(e);let r=e.O_.length>0?e.O_[e.O_.length-1].batchId:-1;for(;Sy(e);)try{const i=await uy(e.localStore,r);if(i===null){e.O_.length===0&&t.o_();break}r=i.batchId,Py(e,i)}catch(i){await Ai(e,i)}ch(e)&&lh(e)}function Sy(n){return Ht(n)&&n.O_.length<10}function Py(n,e){n.O_.push(e);const t=At(n);t.r_()&&t.V_&&t.m_(e.mutations)}function ch(n){return Ht(n)&&!At(n).n_()&&n.O_.length>0}function lh(n){At(n).start()}async function Cy(n){At(n).p_()}async function ky(n){const e=At(n);for(const t of n.O_)e.m_(t.mutations)}async function Dy(n,e,t){const r=n.O_.shift(),i=bo.from(r,e,t);await ah(n,()=>n.remoteSyncer.applySuccessfulWrite(i)),await $i(n)}async function Ny(n,e){e&&At(n).V_&&await async function(r,i){if(function(a){return E_(a)&&a!==S.ABORTED}(i.code)){const s=r.O_.shift();At(r).s_(),await ah(r,()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i)),await $i(r)}}(n,e),ch(n)&&lh(n)}async function al(n,e){const t=B(n);t.asyncQueue.verifyOperationInProgress(),L("RemoteStore","RemoteStore received new credentials");const r=Ht(t);t.L_.add(3),await Er(t),r&&t.q_.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.L_.delete(3),await Ui(t)}async function Vy(n,e){const t=B(n);e?(t.L_.delete(2),await Ui(t)):e||(t.L_.add(2),await Er(t),t.q_.set("Unknown"))}function In(n){return n.K_||(n.K_=function(t,r,i){const s=B(t);return s.w_(),new yy(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(n.datastore,n.asyncQueue,{Eo:Iy.bind(null,n),Ro:Ay.bind(null,n),mo:by.bind(null,n),d_:Ry.bind(null,n)}),n.B_.push(async e=>{e?(n.K_.s_(),Lo(n)?Vo(n):n.q_.set("Unknown")):(await n.K_.stop(),oh(n))})),n.K_}function At(n){return n.U_||(n.U_=function(t,r,i){const s=B(t);return s.w_(),new vy(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)}(n.datastore,n.asyncQueue,{Eo:()=>Promise.resolve(),Ro:Cy.bind(null,n),mo:Ny.bind(null,n),f_:ky.bind(null,n),g_:Dy.bind(null,n)}),n.B_.push(async e=>{e?(n.U_.s_(),await $i(n)):(await n.U_.stop(),n.O_.length>0&&(L("RemoteStore",`Stopping write stream with ${n.O_.length} pending writes`),n.O_=[]))})),n.U_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oo{constructor(e,t,r,i,s){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=r,this.op=i,this.removalCallback=s,this.deferred=new et,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch(a=>{})}get promise(){return this.deferred.promise}static createAndSchedule(e,t,r,i,s){const a=Date.now()+r,c=new Oo(e,t,a,i,s);return c.start(r),c}start(e){this.timerHandle=setTimeout(()=>this.handleDelayElapsed(),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){this.timerHandle!==null&&(this.clearTimeout(),this.deferred.reject(new V(S.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget(()=>this.timerHandle!==null?(this.clearTimeout(),this.op().then(e=>this.deferred.resolve(e))):Promise.resolve())}clearTimeout(){this.timerHandle!==null&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function Mo(n,e){if(rt("AsyncQueue",`${e}: ${n}`),_r(n))return new V(S.UNAVAILABLE,`${e}: ${n}`);throw n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ly{constructor(){this.z_=void 0,this.j_=[]}H_(){return this.j_.some(e=>e.J_())}}class Oy{constructor(){this.queries=ll(),this.onlineState="Unknown",this.Y_=new Set}terminate(){(function(t,r){const i=B(t),s=i.queries;i.queries=ll(),s.forEach((a,c)=>{for(const u of c.j_)u.onError(r)})})(this,new V(S.ABORTED,"Firestore shutting down"))}}function ll(){return new Tn(n=>Nu(n),Vi)}async function uh(n,e){const t=B(n);let r=3;const i=e.query;let s=t.queries.get(i);s?!s.H_()&&e.J_()&&(r=2):(s=new Ly,r=e.J_()?0:1);try{switch(r){case 0:s.z_=await t.onListen(i,!0);break;case 1:s.z_=await t.onListen(i,!1);break;case 2:await t.onFirstRemoteStoreListen(i)}}catch(a){const c=Mo(a,`Initialization of query '${Xt(e.query)}' failed`);return void e.onError(c)}t.queries.set(i,s),s.j_.push(e),e.Z_(t.onlineState),s.z_&&e.X_(s.z_)&&xo(t)}async function hh(n,e){const t=B(n),r=e.query;let i=3;const s=t.queries.get(r);if(s){const a=s.j_.indexOf(e);a>=0&&(s.j_.splice(a,1),s.j_.length===0?i=e.J_()?0:1:!s.H_()&&e.J_()&&(i=2))}switch(i){case 0:return t.queries.delete(r),t.onUnlisten(r,!0);case 1:return t.queries.delete(r),t.onUnlisten(r,!1);case 2:return t.onLastRemoteStoreUnlisten(r);default:return}}function My(n,e){const t=B(n);let r=!1;for(const i of e){const s=i.query,a=t.queries.get(s);if(a){for(const c of a.j_)c.X_(i)&&(r=!0);a.z_=i}}r&&xo(t)}function xy(n,e,t){const r=B(n),i=r.queries.get(e);if(i)for(const s of i.j_)s.onError(t);r.queries.delete(e)}function xo(n){n.Y_.forEach(e=>{e.next()})}var Qs,ul;(ul=Qs||(Qs={})).ea="default",ul.Cache="cache";class dh{constructor(e,t,r){this.query=e,this.ta=t,this.na=!1,this.ra=null,this.onlineState="Unknown",this.options=r||{}}X_(e){if(!this.options.includeMetadataChanges){const r=[];for(const i of e.docChanges)i.type!==3&&r.push(i);e=new mn(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.na?this.ia(e)&&(this.ta.next(e),t=!0):this.sa(e,this.onlineState)&&(this.oa(e),t=!0),this.ra=e,t}onError(e){this.ta.error(e)}Z_(e){this.onlineState=e;let t=!1;return this.ra&&!this.na&&this.sa(this.ra,e)&&(this.oa(this.ra),t=!0),t}sa(e,t){if(!e.fromCache||!this.J_())return!0;const r=t!=="Offline";return(!this.options._a||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}ia(e){if(e.docChanges.length>0)return!0;const t=this.ra&&this.ra.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}oa(e){e=mn.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.na=!0,this.ta.next(e)}J_(){return this.options.source!==Qs.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fh{constructor(e){this.key=e}}class ph{constructor(e){this.key=e}}class Fy{constructor(e,t){this.query=e,this.Ta=t,this.Ea=null,this.hasCachedResults=!1,this.current=!1,this.da=j(),this.mutatedKeys=j(),this.Aa=Vu(e),this.Ra=new an(this.Aa)}get Va(){return this.Ta}ma(e,t){const r=t?t.fa:new cl,i=t?t.Ra:this.Ra;let s=t?t.mutatedKeys:this.mutatedKeys,a=i,c=!1;const u=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,d=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal((f,y)=>{const E=i.get(f),R=Li(this.query,y)?y:null,k=!!E&&this.mutatedKeys.has(E.key),O=!!R&&(R.hasLocalMutations||this.mutatedKeys.has(R.key)&&R.hasCommittedMutations);let N=!1;E&&R?E.data.isEqual(R.data)?k!==O&&(r.track({type:3,doc:R}),N=!0):this.ga(E,R)||(r.track({type:2,doc:R}),N=!0,(u&&this.Aa(R,u)>0||d&&this.Aa(R,d)<0)&&(c=!0)):!E&&R?(r.track({type:0,doc:R}),N=!0):E&&!R&&(r.track({type:1,doc:E}),N=!0,(u||d)&&(c=!0)),N&&(R?(a=a.add(R),s=O?s.add(f):s.delete(f)):(a=a.delete(f),s=s.delete(f)))}),this.query.limit!==null)for(;a.size>this.query.limit;){const f=this.query.limitType==="F"?a.last():a.first();a=a.delete(f.key),s=s.delete(f.key),r.track({type:1,doc:f})}return{Ra:a,fa:r,ns:c,mutatedKeys:s}}ga(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,i){const s=this.Ra;this.Ra=e.Ra,this.mutatedKeys=e.mutatedKeys;const a=e.fa.G_();a.sort((f,y)=>function(R,k){const O=N=>{switch(N){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return F()}};return O(R)-O(k)}(f.type,y.type)||this.Aa(f.doc,y.doc)),this.pa(r),i=i!=null&&i;const c=t&&!i?this.ya():[],u=this.da.size===0&&this.current&&!i?1:0,d=u!==this.Ea;return this.Ea=u,a.length!==0||d?{snapshot:new mn(this.query,e.Ra,s,a,e.mutatedKeys,u===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),wa:c}:{wa:c}}Z_(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ra:this.Ra,fa:new cl,mutatedKeys:this.mutatedKeys,ns:!1},!1)):{wa:[]}}Sa(e){return!this.Ta.has(e)&&!!this.Ra.has(e)&&!this.Ra.get(e).hasLocalMutations}pa(e){e&&(e.addedDocuments.forEach(t=>this.Ta=this.Ta.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ta=this.Ta.delete(t)),this.current=e.current)}ya(){if(!this.current)return[];const e=this.da;this.da=j(),this.Ra.forEach(r=>{this.Sa(r.key)&&(this.da=this.da.add(r.key))});const t=[];return e.forEach(r=>{this.da.has(r)||t.push(new ph(r))}),this.da.forEach(r=>{e.has(r)||t.push(new fh(r))}),t}ba(e){this.Ta=e.Ts,this.da=j();const t=this.ma(e.documents);return this.applyChanges(t,!0)}Da(){return mn.fromInitialDocuments(this.query,this.Ra,this.mutatedKeys,this.Ea===0,this.hasCachedResults)}}class Uy{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class $y{constructor(e){this.key=e,this.va=!1}}class By{constructor(e,t,r,i,s,a){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=i,this.currentUser=s,this.maxConcurrentLimboResolutions=a,this.Ca={},this.Fa=new Tn(c=>Nu(c),Vi),this.Ma=new Map,this.xa=new Set,this.Oa=new ee(M.comparator),this.Na=new Map,this.La=new Po,this.Ba={},this.ka=new Map,this.qa=pn.kn(),this.onlineState="Unknown",this.Qa=void 0}get isPrimaryClient(){return this.Qa===!0}}async function jy(n,e,t=!0){const r=Eh(n);let i;const s=r.Fa.get(e);return s?(r.sharedClientState.addLocalQueryTarget(s.targetId),i=s.view.Da()):i=await mh(r,e,t,!0),i}async function qy(n,e){const t=Eh(n);await mh(t,e,!0,!1)}async function mh(n,e,t,r){const i=await hy(n.localStore,je(e)),s=i.targetId,a=n.sharedClientState.addLocalQueryTarget(s,t);let c;return r&&(c=await Hy(n,e,s,a==="current",i.resumeToken)),n.isPrimaryClient&&t&&ih(n.remoteStore,i),c}async function Hy(n,e,t,r,i){n.Ka=(y,E,R)=>async function(O,N,G,K){let Q=N.view.ma(G);Q.ns&&(Q=await il(O.localStore,N.query,!1).then(({documents:w})=>N.view.ma(w,Q)));const ne=K&&K.targetChanges.get(N.targetId),Ne=K&&K.targetMismatches.get(N.targetId)!=null,re=N.view.applyChanges(Q,O.isPrimaryClient,ne,Ne);return dl(O,N.targetId,re.wa),re.snapshot}(n,y,E,R);const s=await il(n.localStore,e,!0),a=new Fy(e,s.Ts),c=a.ma(s.documents),u=vr.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",i),d=a.applyChanges(c,n.isPrimaryClient,u);dl(n,t,d.wa);const f=new Uy(e,t,a);return n.Fa.set(e,f),n.Ma.has(t)?n.Ma.get(t).push(e):n.Ma.set(t,[e]),d.snapshot}async function Wy(n,e,t){const r=B(n),i=r.Fa.get(e),s=r.Ma.get(i.targetId);if(s.length>1)return r.Ma.set(i.targetId,s.filter(a=>!Vi(a,e))),void r.Fa.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await Ks(r.localStore,i.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(i.targetId),t&&Do(r.remoteStore,i.targetId),Js(r,i.targetId)}).catch(gr)):(Js(r,i.targetId),await Ks(r.localStore,i.targetId,!0))}async function zy(n,e){const t=B(n),r=t.Fa.get(e),i=t.Ma.get(r.targetId);t.isPrimaryClient&&i.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),Do(t.remoteStore,r.targetId))}async function Gy(n,e,t){const r=ev(n);try{const i=await function(a,c){const u=B(a),d=ae.now(),f=c.reduce((R,k)=>R.add(k.key),j());let y,E;return u.persistence.runTransaction("Locally write mutations","readwrite",R=>{let k=it(),O=j();return u.cs.getEntries(R,f).next(N=>{k=N,k.forEach((G,K)=>{K.isValidDocument()||(O=O.add(G))})}).next(()=>u.localDocuments.getOverlayedDocuments(R,k)).next(N=>{y=N;const G=[];for(const K of c){const Q=m_(K,y.get(K.key).overlayedDocument);Q!=null&&G.push(new Rt(K.key,Q,Au(Q.value.mapValue),Me.exists(!0)))}return u.mutationQueue.addMutationBatch(R,d,G,c)}).next(N=>{E=N;const G=N.applyToLocalDocumentSet(y,O);return u.documentOverlayCache.saveOverlays(R,N.batchId,G)})}).then(()=>({batchId:E.batchId,changes:Ou(y)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(i.batchId),function(a,c,u){let d=a.Ba[a.currentUser.toKey()];d||(d=new ee(z)),d=d.insert(c,u),a.Ba[a.currentUser.toKey()]=d}(r,i.batchId,t),await wr(r,i.changes),await $i(r.remoteStore)}catch(i){const s=Mo(i,"Failed to persist write");t.reject(s)}}async function gh(n,e){const t=B(n);try{const r=await cy(t.localStore,e);e.targetChanges.forEach((i,s)=>{const a=t.Na.get(s);a&&(J(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1),i.addedDocuments.size>0?a.va=!0:i.modifiedDocuments.size>0?J(a.va):i.removedDocuments.size>0&&(J(a.va),a.va=!1))}),await wr(t,r,e)}catch(r){await gr(r)}}function hl(n,e,t){const r=B(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const i=[];r.Fa.forEach((s,a)=>{const c=a.view.Z_(e);c.snapshot&&i.push(c.snapshot)}),function(a,c){const u=B(a);u.onlineState=c;let d=!1;u.queries.forEach((f,y)=>{for(const E of y.j_)E.Z_(c)&&(d=!0)}),d&&xo(u)}(r.eventManager,e),i.length&&r.Ca.d_(i),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function Ky(n,e,t){const r=B(n);r.sharedClientState.updateQueryState(e,"rejected",t);const i=r.Na.get(e),s=i&&i.key;if(s){let a=new ee(M.comparator);a=a.insert(s,Te.newNoDocument(s,$.min()));const c=j().add(s),u=new xi($.min(),new Map,new ee(z),a,c);await gh(r,u),r.Oa=r.Oa.remove(s),r.Na.delete(e),Fo(r)}else await Ks(r.localStore,e,!1).then(()=>Js(r,e,t)).catch(gr)}async function Qy(n,e){const t=B(n),r=e.batch.batchId;try{const i=await ay(t.localStore,e);yh(t,r,null),_h(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await wr(t,i)}catch(i){await gr(i)}}async function Jy(n,e,t){const r=B(n);try{const i=await function(a,c){const u=B(a);return u.persistence.runTransaction("Reject batch","readwrite-primary",d=>{let f;return u.mutationQueue.lookupMutationBatch(d,c).next(y=>(J(y!==null),f=y.keys(),u.mutationQueue.removeMutationBatch(d,y))).next(()=>u.mutationQueue.performConsistencyCheck(d)).next(()=>u.documentOverlayCache.removeOverlaysForBatchId(d,f,c)).next(()=>u.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,f)).next(()=>u.localDocuments.getDocuments(d,f))})}(r.localStore,e);yh(r,e,t),_h(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await wr(r,i)}catch(i){await gr(i)}}function _h(n,e){(n.ka.get(e)||[]).forEach(t=>{t.resolve()}),n.ka.delete(e)}function yh(n,e,t){const r=B(n);let i=r.Ba[r.currentUser.toKey()];if(i){const s=i.get(e);s&&(t?s.reject(t):s.resolve(),i=i.remove(e)),r.Ba[r.currentUser.toKey()]=i}}function Js(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Ma.get(e))n.Fa.delete(r),t&&n.Ca.$a(r,t);n.Ma.delete(e),n.isPrimaryClient&&n.La.gr(e).forEach(r=>{n.La.containsKey(r)||vh(n,r)})}function vh(n,e){n.xa.delete(e.path.canonicalString());const t=n.Oa.get(e);t!==null&&(Do(n.remoteStore,t),n.Oa=n.Oa.remove(e),n.Na.delete(t),Fo(n))}function dl(n,e,t){for(const r of t)r instanceof fh?(n.La.addReference(r.key,e),Yy(n,r)):r instanceof ph?(L("SyncEngine","Document no longer in limbo: "+r.key),n.La.removeReference(r.key,e),n.La.containsKey(r.key)||vh(n,r.key)):F()}function Yy(n,e){const t=e.key,r=t.path.canonicalString();n.Oa.get(t)||n.xa.has(r)||(L("SyncEngine","New document in limbo: "+t),n.xa.add(r),Fo(n))}function Fo(n){for(;n.xa.size>0&&n.Oa.size<n.maxConcurrentLimboResolutions;){const e=n.xa.values().next().value;n.xa.delete(e);const t=new M(Z.fromString(e)),r=n.qa.next();n.Na.set(r,new $y(t)),n.Oa=n.Oa.insert(t,r),ih(n.remoteStore,new gt(je(To(t.path)),r,"TargetPurposeLimboResolution",go.oe))}}async function wr(n,e,t){const r=B(n),i=[],s=[],a=[];r.Fa.isEmpty()||(r.Fa.forEach((c,u)=>{a.push(r.Ka(u,e,t).then(d=>{var f;if((d||t)&&r.isPrimaryClient){const y=d?!d.fromCache:(f=t==null?void 0:t.targetChanges.get(u.targetId))===null||f===void 0?void 0:f.current;r.sharedClientState.updateQueryState(u.targetId,y?"current":"not-current")}if(d){i.push(d);const y=ko.Wi(u.targetId,d);s.push(y)}}))}),await Promise.all(a),r.Ca.d_(i),await async function(u,d){const f=B(u);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",y=>P.forEach(d,E=>P.forEach(E.$i,R=>f.persistence.referenceDelegate.addReference(y,E.targetId,R)).next(()=>P.forEach(E.Ui,R=>f.persistence.referenceDelegate.removeReference(y,E.targetId,R)))))}catch(y){if(!_r(y))throw y;L("LocalStore","Failed to update sequence numbers: "+y)}for(const y of d){const E=y.targetId;if(!y.fromCache){const R=f.os.get(E),k=R.snapshotVersion,O=R.withLastLimboFreeSnapshotVersion(k);f.os=f.os.insert(E,O)}}}(r.localStore,s))}async function Xy(n,e){const t=B(n);if(!t.currentUser.isEqual(e)){L("SyncEngine","User change. New user:",e.toKey());const r=await eh(t.localStore,e);t.currentUser=e,function(s,a){s.ka.forEach(c=>{c.forEach(u=>{u.reject(new V(S.CANCELLED,a))})}),s.ka.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await wr(t,r.hs)}}function Zy(n,e){const t=B(n),r=t.Na.get(e);if(r&&r.va)return j().add(r.key);{let i=j();const s=t.Ma.get(e);if(!s)return i;for(const a of s){const c=t.Fa.get(a);i=i.unionWith(c.view.Va)}return i}}function Eh(n){const e=B(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=gh.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=Zy.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=Ky.bind(null,e),e.Ca.d_=My.bind(null,e.eventManager),e.Ca.$a=xy.bind(null,e.eventManager),e}function ev(n){const e=B(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=Qy.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=Jy.bind(null,e),e}class bi{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Fi(e.databaseInfo.databaseId),this.sharedClientState=this.Wa(e),this.persistence=this.Ga(e),await this.persistence.start(),this.localStore=this.za(e),this.gcScheduler=this.ja(e,this.localStore),this.indexBackfillerScheduler=this.Ha(e,this.localStore)}ja(e,t){return null}Ha(e,t){return null}za(e){return oy(this.persistence,new iy,e.initialUser,this.serializer)}Ga(e){return new ty(Co.Zr,this.serializer)}Wa(e){return new fy}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}bi.provider={build:()=>new bi};class Ys{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>hl(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=Xy.bind(null,this.syncEngine),await Vy(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new Oy}()}createDatastore(e){const t=Fi(e.databaseInfo.databaseId),r=function(s){return new _y(s)}(e.databaseInfo);return function(s,a,c,u){return new Ey(s,a,c,u)}(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,i,s,a,c){return new Ty(r,i,s,a,c)}(this.localStore,this.datastore,e.asyncQueue,t=>hl(this.syncEngine,t,0),function(){return ol.D()?new ol:new py}())}createSyncEngine(e,t){return function(i,s,a,c,u,d,f){const y=new By(i,s,a,c,u,d);return f&&(y.Qa=!0),y}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(i){const s=B(i);L("RemoteStore","RemoteStore shutting down."),s.L_.add(5),await Er(s),s.k_.shutdown(),s.q_.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}Ys.provider={build:()=>new Ys};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wh{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ya(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ya(this.observer.error,e):rt("Uncaught Error in snapshot listener:",e.toString()))}Za(){this.muted=!0}Ya(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class St{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new St(this.firestore,e,this._query)}}class Re{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new wt(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new Re(this.firestore,e,this._key)}}class wt extends St{constructor(e,t,r){super(e,t,To(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new Re(this.firestore,null,new M(e))}withConverter(e){return new wt(this.firestore,e,this._path)}}function Ue(n,e,...t){if(n=ue(n),bh("collection","path",e),n instanceof ji){const r=Z.fromString(e,...t);return gl(r),new wt(n,null,r)}{if(!(n instanceof Re||n instanceof wt))throw new V(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Z.fromString(e,...t));return gl(r),new wt(n.firestore,null,r)}}function ze(n,e,...t){if(n=ue(n),arguments.length===1&&(e=wu.newId()),bh("doc","path",e),n instanceof ji){const r=Z.fromString(e,...t);return ml(r),new Re(n,null,new M(r))}{if(!(n instanceof Re||n instanceof wt))throw new V(S.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=n._path.child(Z.fromString(e,...t));return ml(r),new Re(n.firestore,n instanceof wt?n.converter:null,new M(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $o{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new V(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new V(S.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return z(this._lat,e._lat)||z(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hv=/^__.*__$/;class dv{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new Rt(e,this.data,this.fieldMask,t,this.fieldTransforms):new yr(e,this.data,t,this.fieldTransforms)}}class Rh{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new Rt(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Sh(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw F()}}class jo{constructor(e,t,r,i,s,a){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=i,s===void 0&&this.vu(),this.fieldTransforms=s||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Cu(){return this.settings.Cu}Fu(e){return new jo(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Mu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Fu({path:r,xu:!1});return i.Ou(e),i}Nu(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Fu({path:r,xu:!1});return i.vu(),i}Lu(e){return this.Fu({path:void 0,xu:!0})}Bu(e){return Ri(e,this.settings.methodName,this.settings.ku||!1,this.path,this.settings.qu)}contains(e){return this.fieldMask.find(t=>e.isPrefixOf(t))!==void 0||this.fieldTransforms.find(t=>e.isPrefixOf(t.field))!==void 0}vu(){if(this.path)for(let e=0;e<this.path.length;e++)this.Ou(this.path.get(e))}Ou(e){if(e.length===0)throw this.Bu("Document fields must not be empty");if(Sh(this.Cu)&&hv.test(e))throw this.Bu('Document fields cannot begin and end with "__"')}}class fv{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Fi(e)}Qu(e,t,r,i=!1){return new jo({Cu:e,methodName:t,qu:r,path:fe.emptyPath(),xu:!1,ku:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function qo(n){const e=n._freezeSettings(),t=Fi(n._databaseId);return new fv(n._databaseId,!!e.ignoreUndefinedProperties,t)}function pv(n,e,t,r,i,s={}){const a=n.Qu(s.merge||s.mergeFields?2:0,e,t,i);Wo("Data must be an object, but it was:",a,r);const c=Ph(r,a);let u,d;if(s.merge)u=new ke(a.fieldMask),d=a.fieldTransforms;else if(s.mergeFields){const f=[];for(const y of s.mergeFields){const E=Xs(e,y,t);if(!a.contains(E))throw new V(S.INVALID_ARGUMENT,`Field '${E}' is specified in your field mask but missing from your input data.`);kh(f,E)||f.push(E)}u=new ke(f),d=a.fieldTransforms.filter(y=>u.covers(y.field))}else u=null,d=a.fieldTransforms;return new dv(new Se(c),u,d)}class Wi extends Hi{_toFieldTransform(e){if(e.Cu!==2)throw e.Cu===1?e.Bu(`${this._methodName}() can only appear at the top level of your update data`):e.Bu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof Wi}}class Ho extends Hi{_toFieldTransform(e){return new h_(e.path,new cr)}isEqual(e){return e instanceof Ho}}function mv(n,e,t,r){const i=n.Qu(1,e,t);Wo("Data must be an object, but it was:",i,r);const s=[],a=Se.empty();qt(r,(u,d)=>{const f=zo(e,u,t);d=ue(d);const y=i.Nu(f);if(d instanceof Wi)s.push(f);else{const E=Tr(d,y);E!=null&&(s.push(f),a.set(f,E))}});const c=new ke(s);return new Rh(a,c,i.fieldTransforms)}function gv(n,e,t,r,i,s){const a=n.Qu(1,e,t),c=[Xs(e,r,t)],u=[i];if(s.length%2!=0)throw new V(S.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let E=0;E<s.length;E+=2)c.push(Xs(e,s[E])),u.push(s[E+1]);const d=[],f=Se.empty();for(let E=c.length-1;E>=0;--E)if(!kh(d,c[E])){const R=c[E];let k=u[E];k=ue(k);const O=a.Nu(R);if(k instanceof Wi)d.push(R);else{const N=Tr(k,O);N!=null&&(d.push(R),f.set(R,N))}}const y=new ke(d);return new Rh(f,y,a.fieldTransforms)}function _v(n,e,t,r=!1){return Tr(t,n.Qu(r?4:3,e))}function Tr(n,e){if(Ch(n=ue(n)))return Wo("Unsupported field value:",e,n),Ph(n,e);if(n instanceof Hi)return function(r,i){if(!Sh(i.Cu))throw i.Bu(`${r._methodName}() can only be used with update() and set()`);if(!i.path)throw i.Bu(`${r._methodName}() is not currently supported inside arrays`);const s=r._toFieldTransform(i);s&&i.fieldTransforms.push(s)}(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.xu&&e.Cu!==4)throw e.Bu("Nested arrays are not supported");return function(r,i){const s=[];let a=0;for(const c of r){let u=Tr(c,i.Lu(a));u==null&&(u={nullValue:"NULL_VALUE"}),s.push(u),a++}return{arrayValue:{values:s}}}(n,e)}return function(r,i){if((r=ue(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return c_(i.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const s=ae.fromDate(r);return{timestampValue:Ii(i.serializer,s)}}if(r instanceof ae){const s=new ae(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:Ii(i.serializer,s)}}if(r instanceof $o)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof gn)return{bytesValue:Gu(i.serializer,r._byteString)};if(r instanceof Re){const s=i.databaseId,a=r.firestore._databaseId;if(!a.isEqual(s))throw i.Bu(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:So(r.firestore._databaseId||i.databaseId,r._key.path)}}if(r instanceof Bo)return function(a,c){return{mapValue:{fields:{__type__:{stringValue:"__vector__"},value:{arrayValue:{values:a.toArray().map(u=>{if(typeof u!="number")throw c.Bu("VectorValues must only contain numeric values.");return Io(c.serializer,u)})}}}}}}(r,i);throw i.Bu(`Unsupported field value: ${Bi(r)}`)}(n,e)}function Ph(n,e){const t={};return Tu(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):qt(n,(r,i)=>{const s=Tr(i,e.Mu(r));s!=null&&(t[r]=s)}),{mapValue:{fields:t}}}function Ch(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ae||n instanceof $o||n instanceof gn||n instanceof Re||n instanceof Hi||n instanceof Bo)}function Wo(n,e,t){if(!Ch(t)||!function(i){return typeof i=="object"&&i!==null&&(Object.getPrototypeOf(i)===Object.prototype||Object.getPrototypeOf(i)===null)}(t)){const r=Bi(t);throw r==="an object"?e.Bu(n+" a custom object"):e.Bu(n+" "+r)}}function Xs(n,e,t){if((e=ue(e))instanceof qi)return e._internalPath;if(typeof e=="string")return zo(n,e);throw Ri("Field path arguments must be of type string or ",n,!1,void 0,t)}const yv=new RegExp("[~\\*/\\[\\]]");function zo(n,e,t){if(e.search(yv)>=0)throw Ri(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new qi(...e.split("."))._internalPath}catch{throw Ri(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function Ri(n,e,t,r,i){const s=r&&!r.isEmpty(),a=i!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let u="";return(s||a)&&(u+=" (found",s&&(u+=` in field ${r}`),a&&(u+=` in document ${i}`),u+=")"),new V(S.INVALID_ARGUMENT,c+n+u)}function kh(n,e){return n.some(t=>t.isEqual(e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ev(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new V(S.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}class Ko{}class Qo extends Ko{}function Pt(n,e,...t){let r=[];e instanceof Ko&&r.push(e),r=r.concat(t),function(s){const a=s.filter(u=>u instanceof Yo).length,c=s.filter(u=>u instanceof Jo).length;if(a>1||a>0&&c>0)throw new V(S.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(const i of r)n=i._apply(n);return n}class Jo extends Qo{constructor(e,t,r){super(),this._field=e,this._op=t,this._value=r,this.type="where"}static _create(e,t,r){return new Jo(e,t,r)}_apply(e){const t=this._parse(e);return Nh(e._query,t),new St(e.firestore,e.converter,qs(e._query,t))}_parse(e){const t=qo(e.firestore);return function(s,a,c,u,d,f,y){let E;if(d.isKeyField()){if(f==="array-contains"||f==="array-contains-any")throw new V(S.INVALID_ARGUMENT,`Invalid Query. You can't perform '${f}' queries on documentId().`);if(f==="in"||f==="not-in"){El(y,f);const R=[];for(const k of y)R.push(vl(u,s,k));E={arrayValue:{values:R}}}else E=vl(u,s,y)}else f!=="in"&&f!=="not-in"&&f!=="array-contains-any"||El(y,f),E=_v(c,a,y,f==="in"||f==="not-in");return oe.create(d,f,E)}(e._query,"where",t,e.firestore._databaseId,this._field,this._op,this._value)}}class Yo extends Ko{constructor(e,t){super(),this.type=e,this._queryConstraints=t}static _create(e,t){return new Yo(e,t)}_parse(e){const t=this._queryConstraints.map(r=>r._parse(e)).filter(r=>r.getFilters().length>0);return t.length===1?t[0]:Fe.create(t,this._getOperator())}_apply(e){const t=this._parse(e);return t.getFilters().length===0?e:(function(i,s){let a=i;const c=s.getFlattenedFilters();for(const u of c)Nh(a,u),a=qs(a,u)}(e._query,t),new St(e.firestore,e.converter,qs(e._query,t)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}}class Xo extends Qo{constructor(e,t){super(),this._field=e,this._direction=t,this.type="orderBy"}static _create(e,t){return new Xo(e,t)}_apply(e){const t=function(i,s,a){if(i.startAt!==null)throw new V(S.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(i.endAt!==null)throw new V(S.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new ar(s,a)}(e._query,this._field,this._direction);return new St(e.firestore,e.converter,function(i,s){const a=i.explicitOrderBy.concat([s]);return new wn(i.path,i.collectionGroup,a,i.filters.slice(),i.limit,i.limitType,i.startAt,i.endAt)}(e._query,t))}}function Ir(n,e="asc"){const t=e,r=Go("orderBy",n);return Xo._create(r,t)}class Zo extends Qo{constructor(e,t,r){super(),this.type=e,this._limit=t,this._limitType=r}static _create(e,t,r){return new Zo(e,t,r)}_apply(e){return new St(e.firestore,e.converter,wi(e._query,this._limit,this._limitType))}}function Ct(n){return av("limit",n),Zo._create("limit",n,"F")}function vl(n,e,t){if(typeof(t=ue(t))=="string"){if(t==="")throw new V(S.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!Du(e)&&t.indexOf("/")!==-1)throw new V(S.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${t}' contains a '/' character.`);const r=e.path.child(Z.fromString(t));if(!M.isDocumentKey(r))throw new V(S.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Bc(n,new M(r))}if(t instanceof Re)return Bc(n,t._key);throw new V(S.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Bi(t)}.`)}function El(n,e){if(!Array.isArray(n)||n.length===0)throw new V(S.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${e.toString()}' filters.`)}function Nh(n,e){const t=function(i,s){for(const a of i)for(const c of a.getFlattenedFilters())if(s.indexOf(c.op)>=0)return c.op;return null}(n.filters,function(i){switch(i){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(e.op));if(t!==null)throw t===e.op?new V(S.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${e.op.toString()}' filter.`):new V(S.INVALID_ARGUMENT,`Invalid query. You cannot use '${e.op.toString()}' filters with '${t.toString()}' filters.`)}class wv{convertValue(e,t="none"){switch(Bt(e)){case 0:return null;case 1:return e.booleanValue;case 2:return ie(e.integerValue||e.doubleValue);case 3:return this.convertTimestamp(e.timestampValue);case 4:return this.convertServerTimestamp(e,t);case 5:return e.stringValue;case 6:return this.convertBytes($t(e.bytesValue));case 7:return this.convertReference(e.referenceValue);case 8:return this.convertGeoPoint(e.geoPointValue);case 9:return this.convertArray(e.arrayValue,t);case 11:return this.convertObject(e.mapValue,t);case 10:return this.convertVectorValue(e.mapValue);default:throw F()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}convertObjectMap(e,t="none"){const r={};return qt(e,(i,s)=>{r[i]=this.convertValue(s,t)}),r}convertVectorValue(e){var t,r,i;const s=(i=(r=(t=e.fields)===null||t===void 0?void 0:t.value.arrayValue)===null||r===void 0?void 0:r.values)===null||i===void 0?void 0:i.map(a=>ie(a.doubleValue));return new Bo(s)}convertGeoPoint(e){return new $o(ie(e.latitude),ie(e.longitude))}convertArray(e,t){return(e.values||[]).map(r=>this.convertValue(r,t))}convertServerTimestamp(e,t){switch(t){case"previous":const r=yo(e);return r==null?null:this.convertValue(r,t);case"estimate":return this.convertTimestamp(ir(e));default:return null}}convertTimestamp(e){const t=It(e);return new ae(t.seconds,t.nanos)}convertDocumentKey(e,t){const r=Z.fromString(e);J(Zu(r));const i=new sr(r.get(1),r.get(3)),s=new M(r.popFirst(5));return i.isEqual(t)||rt(`Document ${s} contains a document reference within a different database (${i.projectId}/${i.database}) which is not supported. It will be treated as a reference in the current database (${t.projectId}/${t.database}) instead.`),s}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lh(n){n=We(n,Re);const e=We(n.firestore,An);return iv(Uo(e),n._key).then(t=>bv(e,n,t))}class Oh extends wv{constructor(e){super(),this.firestore=e}convertBytes(e){return new gn(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new Re(this.firestore,null,t)}}function ot(n){n=We(n,St);const e=We(n.firestore,An),t=Uo(e),r=new Oh(e);return Ev(n._query),sv(t,n._query).then(i=>new Iv(e,r,n,i))}function zi(n,e,t){n=We(n,Re);const r=We(n.firestore,An),i=Tv(n.converter,e,t);return ea(r,[pv(qo(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,Me.none())])}function Mh(n,e,t,...r){n=We(n,Re);const i=We(n.firestore,An),s=qo(i);let a;return a=typeof(e=ue(e))=="string"||e instanceof qi?gv(s,"updateDoc",n._key,e,t,r):mv(s,"updateDoc",n._key,e),ea(i,[a.toMutation(n._key,Me.exists(!0))])}function xh(n){return ea(We(n.firestore,An),[new Ao(n._key,Me.none())])}function ea(n,e){return function(r,i){const s=new et;return r.asyncQueue.enqueueAndForget(async()=>Gy(await rv(r),i,s)),s.promise}(Uo(n),e)}function bv(n,e,t){const r=t.docs.get(e._key),i=new Oh(n);return new Vh(n,i,e._key,r,new Kn(t.hasPendingWrites,t.fromCache),e.converter)}function ta(){return new Ho("serverTimestamp")}(function(e,t=!0){(function(i){En=i})(_n),cn(new xt("firestore",(r,{instanceIdentifier:i,options:s})=>{const a=r.getProvider("app").getImmediate(),c=new An(new bg(r.getProvider("auth-internal")),new Cg(r.getProvider("app-check-internal")),function(d,f){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new V(S.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new sr(d.options.projectId,f)}(a,i),a);return s=Object.assign({useFetchStreams:t},s),c._setSettings(s),c},"PUBLIC").setMultipleInstances(!0)),vt(Mc,"4.7.3",e),vt(Mc,"4.7.3","esm2017")})();function Rv(){try{const n=typeof window!="undefined"&&window.DigitEarnBridge;if(n&&typeof n.getFirebaseConfig=="function"){const e=String(n.getFirebaseConfig()||"");if(e.length>2)return JSON.parse(e)||{}}}catch{}return typeof window!="undefined"&&window.__DIGITEARN_FB_CONFIG__||{}}const Qt=Rv(),Jt={apiKey:void 0,authDomain:void 0,projectId:void 0,storageBucket:void 0,messagingSenderId:void 0,appId:void 0},ci={apiKey:Qt.apiKey||Jt.apiKey||"",authDomain:Qt.authDomain||Jt.authDomain||"",projectId:Qt.projectId||Jt.projectId||"",storageBucket:Qt.storageBucket||Jt.storageBucket||"",messagingSenderId:Qt.messagingSenderId||Jt.messagingSenderId||"",appId:Qt.appId||Jt.appId||""},Fh=!!(ci.apiKey&&ci.projectId&&ci.appId),Sv=typeof location!="undefined"&&/^https?:$/.test(location.protocol),Pv=Sv?"":"https://digitearn.vercel.app",Uh=kl(ci),Ar=wg(Uh),ce=lv(Uh),Ce=n=>"৳"+Number(n||0).toLocaleString("en-BD",{maximumFractionDigits:2}),Ve=n=>{const e=n!=null&&n.toDate?n.toDate():n?new Date(n):new Date(0);return e.getTime()?e.toLocaleString("en-BD",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}):"—"},D=n=>String(n!=null?n:"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e]);async function De(n,e={},t="POST"){if(!Fh)throw new Error("Firebase configure করা নেই");let r=n;const i=String(n).match(/^\/api\/admin\/([a-z0-9-]+)/);i&&(r="/api/admin/panel?op="+encodeURIComponent(i[1]));const s=async c=>{const u=Ar.currentUser;if(!u)throw new Error("Login required — আবার লগইন করুন");const d=await fetch(Pv+r,{method:t,headers:{"Content-Type":"application/json",Authorization:"Bearer "+await u.getIdToken(c)},body:t==="GET"?void 0:JSON.stringify(e)});let f="";try{f=await d.text()}catch{}let y=null;try{y=f?JSON.parse(f):{}}catch{}return{resp:d,data:y||{},isJson:!!y}};let a=await s(!1);if(!a.resp.ok&&(a.resp.status===401||a.data.sessionExpired===!0)&&(a=await s(!0)),!a.resp.ok){const c=a.data||{};if(c.protection||c.error&&typeof c.error=="object"&&String(c.error.code)==="401")throw new Error("Vercel Deployment Protection ব্লক করছে — এই deployment URL থেকে admin API চলে না। Production URL (digitearn.vercel.app) ব্যবহার করুন বা Vercel → Settings → Deployment Protection off করুন।");const u=typeof c.error=="string"?c.error:String(c.error&&(c.error.message||c.error.code)||c.message||"");throw new Error(u||(a.isJson?"":`সার্ভার JSON দেয়নি (HTTP ${a.resp.status})`)||`Operation fail হয়েছে (${a.resp.status}) — আবার চেষ্টা করুন`)}return a.data}async function Cv(){try{return await De("/api/admin/health",{})}catch(n){const e=String(n&&n.message||n);throw/Unknown admin endpoint|404/i.test(e)?new Error("সার্ভারের build পুরোনো — `?op=health` নেই, মানে নতুন api/ + lib/ এখনো deploy হয়নি। Push করে Vercel-এ Redeploy করুন।"):n}}async function kv(){try{const n=await De("/api/admin/verify",{});return{isAdmin:!!n.isAdmin,authenticated:!!n.authenticated,authState:n.authState||"",error:""}}catch(n){return{isAdmin:!1,authenticated:!1,error:String(n&&n.message||"Admin verify fail")}}}async function $h(n="pending",e=100){const t=Pt(Ue(ce,"proofs"),Ir("createdAt","desc"),Ct(e)),i=(await ot(t)).docs.map(s=>({id:s.id,...s.data()}));return n&&n!=="all"?i.filter(s=>s.status===n):i}async function Dv(n){await De("/api/admin/proof-review",{proofId:n,action:"approve"})}async function Nv(n,e=""){await De("/api/admin/proof-review",{proofId:n,action:"reject",note:e})}async function Bh(n="pending",e=100){const t=Pt(Ue(ce,"deposits"),Ir("createdAt","desc"),Ct(e)),i=(await ot(t)).docs.map(s=>({id:s.id,...s.data()}));return n&&n!=="all"?i.filter(s=>s.status===n):i}async function Vv(n){await De("/api/admin/deposit-review",{depositId:n,action:"approve"})}async function Lv(n,e=""){await De("/api/admin/deposit-review",{depositId:n,action:"reject",note:e})}async function na(n=300){const e=Pt(Ue(ce,"users"),Ct(n));return(await ot(e)).docs.map(r=>({uid:r.id,...r.data()}))}async function Gi(n){const e=await Lh(ze(ce,"users",n));return e.exists()?{uid:n,...e.data()}:null}async function Ov(n,e=20){const t=Pt(Ue(ce,"users",n,"withdrawals"),Ir("createdAt","desc"),Ct(e));return(await ot(t)).docs.map(i=>({id:i.id,...i.data()}))}async function Mv(n,e=25){const t=Pt(Ue(ce,"users",n,"transactions"),Ir("createdAt","desc"),Ct(e));return(await ot(t)).docs.map(i=>i.data())}async function wl(n,e){await De("/api/admin/set-active",{uid:n,active:e})}async function xv(){const e=(await ot(Ue(ce,"tasks"))).docs.map(t=>({slug:t.id,...t.data()}));return e.sort((t,r)=>(Number(t.sort)||99)-(Number(r.sort)||99)),e}async function Fv(n=[]){return await De("/api/admin/seed-tasks",{slugs:n})}async function Uv(n,e){if(e.url&&!/^https?:\/\/\S+$/i.test(e.url))throw new Error("Task URL শুধু http/https হতে পারে (javascript:/data: allowed না)");const t={...e,updatedAt:ta()};if(e.dailyLimit!==void 0&&(t.dailyLimit=Math.max(1,Math.min(200,Number(e.dailyLimit)||20))),Array.isArray(e.inputFields)){t.inputFields=e.inputFields.map(i=>({label:String(i.label||"").trim().slice(0,50),type:["text","email","password","tel","number","url","textarea"].includes(i.type)?i.type:"text",placeholder:String(i.placeholder||"").trim().slice(0,60),required:!!i.required})).filter(i=>i.label);const r=new Set;t.inputFields=t.inputFields.filter(i=>r.has(i.label)?!1:(r.add(i.label),!0))}await zi(ze(ce,"tasks",n),t,{merge:!0})}const jh=["giftCode"];async function $v(){const[n,e]=await Promise.all([Lh(ze(ce,"settings","site")),De("/api/admin/secret",{get:!0}).catch(()=>({}))]),t=n.exists()?n.data():{},r={},i=e&&typeof e.giftCode=="string";for(const s of jh)typeof e[s]=="string"&&(r[s]=e[s]);return{...t,...r,_secretLoaded:i}}async function Bv(n="pending",e=100){const t=Pt(Ue(ce,"withdrawals"),Ir("createdAt","desc"),Ct(e)),i=(await ot(t)).docs.map(s=>({id:s.id,...s.data()}));return n&&n!=="all"?i.filter(s=>s.status===n):i}async function Zs(n,e,t,r=""){await De("/api/admin/withdrawal-review",{userId:n,id:e,action:t,note:r})}async function jv(n){const e={...n},t={};for(const i of jh)i in e&&(t[i]=e[i],delete e[i]);await zi(ze(ce,"settings","site"),e,{merge:!0});const r={...t};for(const i of Object.keys(r))String(r[i]).trim()===""&&!r.__clear&&delete r[i];Object.keys(r).length&&await De("/api/admin/secret",r)}async function qv(){await De("/api/admin/secret",{giftCode:"",__clear:!0})}async function Hv(){return(await ot(Pt(Ue(ce,"notices"),Ct(100)))).docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>(Number(e.sort)||99)-(Number(t.sort)||99))}async function Wv({title:n,body:e,type:t="notice",expiresAt:r=null}){const i={title:String(n||"").trim().slice(0,60),body:String(e||"").trim().slice(0,300),type:t==="warning"?"warning":"notice",targetType:"all",enabled:!0,sort:10,createdAt:ta()};r&&(i.expiresAt=r),await zi(ze(Ue(ce,"notices")),i)}async function zv(n,{title:e,body:t,enabled:r,sort:i,type:s,expiresAt:a}){const c={title:String(e||"").trim().slice(0,60),body:String(t||"").trim().slice(0,300),enabled:!!r,sort:Number(i)||10};s&&(c.type=s==="warning"?"warning":"notice"),a&&(c.expiresAt=a),await Mh(ze(ce,"notices",n),c)}async function Gv(n){await xh(ze(ce,"notices",n))}async function Kv(n){return(await ot(Pt(Ue(ce,"users",n,"targetNotices"),Ct(50)))).docs.map(t=>({id:t.id,...t.data()}))}async function Qv(n,{title:e,body:t,type:r="warning",expiresAt:i=null}){const s={title:String(e||"").trim().slice(0,60),body:String(t||"").trim().slice(0,300),type:r==="warning"?"warning":"notice",targetType:"user",targetUserId:n,enabled:!0,sort:10,createdAt:ta(),createdBy:"admin"};i&&(s.expiresAt=i),await zi(ze(Ue(ce,"users",n,"targetNotices")),s)}async function qh(n,e,{enabled:t}){await Mh(ze(ce,"users",n,"targetNotices",e),{enabled:!!t})}async function Hh(n,e){await xh(ze(ce,"users",n,"targetNotices",e))}async function Jv(){return(await De("/api/admin/notice-targeted",{},"GET")).targeted||[]}async function Yv(){const[n,e,t]=await Promise.all([na(1e3),$h("pending",100),Bh("pending",100)]);return{totalUsers:n.length,activeUsers:n.filter(r=>r.isActive).length,pendingProofs:e.length,pendingDeposits:t.length,totalBalance:n.reduce((r,i)=>r+(Number(i.balance)||0),0),recentProofs:e.slice(0,3),recentDeposits:t.slice(0,3)}}const br=document.getElementById("app");let ra=null;function U(n,e="success"){const t=document.createElement("div");t.className="adm-toast "+e,t.innerHTML=`<i class="fa-solid ${e==="error"?"fa-circle-xmark":"fa-circle-check"}"></i> ${D(n)}`,br.appendChild(t),requestAnimationFrame(()=>t.classList.add("show")),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>t.remove(),300)},3200)}Fh||(br.innerHTML='<div class="loading-center"><p style="max-width:340px;text-align:center">Firebase env variables set নেই।<br>Vercel-এ ৬টা <b>VITE_FIREBASE_*</b> variable দিন।</p></div>');um(Ar,n=>{if(!n){ra=null,ia();return}Wh(n)});async function Wh(n){const e=await kv();if(e.error){br.innerHTML=`<div class="loading-center" style="display:block;text-align:center;padding:28px">
      ...
      <p class="muted" style="margin-top:12px;font-size:12px">লগইন ভাঙেনি — শুধু সার্ভার উত্তর দেয়নি।</p></div>`,document.getElementById("gateRetry").addEventListener("click",()=>Wh(n));return}if(!e.isAdmin){await ru(Ar),ia("এই email টা admin list-এ নেই — Firestore-এর admins collection-এ এই email-এর document আছে কিনা দেখুন।");return}ra={email:n.email},window.location.hash=window.location.hash||"#/overview",Zv(),window.addEventListener("hashchange",zh)}function ia(n=""){br.innerHTML=`
    ...
    </div>`,document.getElementById("loginForm").addEventListener("submit",async e=>{e.preventDefault();const t=e.target.querySelector("button");t.disabled=!0,t.innerHTML='<i class="fa-solid fa-spinner fa-spin"></i>';try{await am(Ar,document.getElementById("lgEmail").value.trim(),document.getElementById("lgPass").value)}catch{t.disabled=!1,t.innerHTML='<i class="fa-solid fa-right-to-bracket"></i> Login',ia("Login fail — email/password ঠিক আছে কিনা দেখুন (অথবা এই email-এ Firebase Auth-এ account নেই)।")}})}const Xv=[{id:"overview",label:"Overview",icon:"fa-gauge-high"},{id:"proofs",label:"Submissions",icon:"fa-clipboard-list"},{id:"deposits",label:"Deposits",icon:"fa-money-bill-wave"},{id:"withdrawals",label:"Withdrawals",icon:"fa-money-bill-transfer"},{id:"users",label:"Users",icon:"fa-users"},{id:"tasks",label:"Micro Jobs",icon:"fa-briefcase"},{id:"settings",label:"Settings",icon:"fa-gear"},{id:"notices",label:"Notices",icon:"fa-bullhorn"}];function Zv(){br.innerHTML=`
    <header class="adm-top">
      <div class="adm-logo"><i class="fa-solid fa-bolt"></i> DigitEarn <span>Admin</span></div>
      <div class="adm-top-right">
        <span class="adm-email"><i class="fa-solid fa-user-shield"></i> ${D(ra.email)}</span>
        <button class="adm-btn ghost sm" id="logoutBtn"><i class="fa-solid fa-right-from-bracket"></i></button>
      </div>
    </header>
    <nav class="adm-nav">${Xv.map(n=>`<a href="#/${n.id}" data-nav="${n.id}"><i class="fa-solid ${n.icon}"></i> ${n.label}</a>`).join("")}</nav>
    <main class="adm-main" id="admMain"><div class="loading-center"><i class="fa-solid fa-spinner fa-spin"></i></div></main>`,document.getElementById("logoutBtn").addEventListener("click",()=>ru(Ar)),zh()}async function zh(){const n=(window.location.hash||"#/overview").replace("#/",""),e=document.getElementById("admMain");if(e){document.querySelectorAll("[data-nav]").forEach(t=>t.classList.toggle("on",t.dataset.nav===n)),e.innerHTML='<div class="loading-center"><i class="fa-solid fa-spinner fa-spin"></i></div>';try{n==="proofs"?await li(e):n==="deposits"?await ui(e):n==="withdrawals"?await eo(e):n==="users"?await rE(e):n==="tasks"?await to(e):n==="settings"?await Kh(e):n==="notices"?await tn(e):await eE(e)}catch(t){e.innerHTML=`<div class="form-err"><i class="fa-solid fa-triangle-exclamation"></i> ${D(t.message)}</div>`}}}async function eE(n){const e=await Yv();n.innerHTML=`
    <div class="stat-grid">
    ...
    <div class="adm-card">
      ...
      ${e.recentProofs.map(t=>`<div class="mini-row"><b>${D(t.taskName||t.taskSlug)}</b> <span class="muted">${Ve(t.createdAt)}</span><span class="badge gold">+${Ce(t.reward)}</span></div>`).join("")}
    ...
    <div class="adm-card">
      ...
      ${e.recentDeposits.map(t=>`<div class="mini-row"><b>${D(t.method)}</b> <span class="muted">${Ve(t.createdAt)}</span><span class="badge gold">${Ce(t.amount)}</span></div>`).join("")}
    ...
    </div>`,document.getElementById("healthBtn").addEventListener("click",tE)}async function tE(){const n=document.getElementById("healthOut");n&&(n.innerHTML='<span class="muted"><i class="fa-solid fa-spinner fa-spin"></i> চেক হচ্ছে…</span>');let e;try{e=await Cv()}catch(s){n&&(n.innerHTML=`<div class="form-err">${D(String(s.message||s))}</div>`);return}const t=(s,a,c)=>`<div class="mini-row"><span class="badge ${s?"green":"red"}">${s?"✓":"✗"}</span> ${D(a)}${c?` <span class="muted">${D(c)}</span>`:""}</div>`,r=[t(!!e.ok,"সামগ্রিক",e.ok?"server ঠিক আছে — ইউজারের “Login required” হলে সেটা deployment-এর dosh নয়":"server-side সেটআপে সমস্যা"),t(!!e.firestore&&!!e.firestore.reachable,"Firestore পড়া",e.firestore&&e.firestore.settingsDoc?"settings/site পাওয়া গেছে":"পড়া যাচ্ছে না"),t(!e.sdk||e.sdk.cjsRequireSafe!==!1,"Admin SDK (firebase-admin)",`v${e.sdk&&e.sdk.version||"?"}${e.sdk&&e.sdk.jose?" · jose@"+e.sdk.jose:""}`+(e.sdk&&e.sdk.cjsRequireSafe===!1?" — CJS require() ভাঙে, functions 500 (Node 22.x বা ^13.10.0 pin লাগবে)":"")),t(!!e.privateKeyShape,"Private key ফরম্যাট",""),t(!!e.projectMatch,"Project match",`site: ${e.tokenProject||e.serverProject||"?"} / server: ${e.serverProject||"?"} / SA: ${e.serviceAccountProject||"?"}`),t(!!e.authed,"আপনার token verify",e.authed?"OK":`ব্যর্থ (${D(e.authState||"")} ${D(e.authCode||"")})`)].join(""),i=(e.notes||[]).map(s=>`<p class="muted" style="font-size:12px;margin-top:6px"><i class="fa-solid fa-circle-info"></i> ${D(s)}</p>`).join("");n&&(n.innerHTML=r+i)}let Jr="pending";function nE(n,e){const t=[];if(Array.isArray(e)&&e.length)for(const s of e){if(!s||typeof s!="object")continue;const a=String(s.label||"").slice(0,50)||"Field",c=String(s.type||"text"),u=s.value===void 0||s.value===null||s.value===""?"":String(s.value);t.push({label:a,type:c,value:u,required:!!s.required,secret:s.secret===!0})}else if(n&&typeof n=="object"&&!Array.isArray(n))for(const[s,a]of Object.entries(n))t.push({label:s,type:"text",value:String(a!=null?a:""),required:!1});if(!t.length)return"";const r=t.map(s=>{const a=/(password|passwd|pwd|passcode|otp|onetimecode|2fa|tfa|twofactor|authenticat|recovery|backupcode|secret|apikey|accesstoken|refreshtoken|privatetoken|privatekey|token|cookie|session|bearer)/,c=E=>String(E||"").toLowerCase().replace(/[^a-z0-9]/g,""),u=!!s.value&&(s.type==="password"||s.secret||a.test(c(s.label))),d=u?"•".repeat(Math.min(s.value.length,14)):s.value||"—",f=u?`<button type="button" class="adm-btn ghost sm" data-reveal data-raw="${D(s.value)}" style="margin-left:6px"><i class="fa-solid fa-eye"></i> দেখুন</button>`:"",y=[u?"sub-secret":"",s.type==="textarea"?"sub-multi":""].filter(Boolean).join(" ");return`<div class="sub-row"><span class="muted">${D(s.label)}:</span><b${y?` class="${y}"`:""}>${D(d)}</b>${f}${!s.value&&s.required?' <span class="muted">(required খালি)</span>':""}</div>`}).join(""),i=t.map(s=>`${s.label}: ${s.value}`).join(`
`);return`<div class="sub-fields">${r}</div>
    ...
    <div class="adm-item">
      ...
      <div class="ai-meta"><i class="fa-solid fa-briefcase"></i> ${D(i.taskName||i.taskSlug)} • <b class="gold-txt">${Ce(i.reward)}</b> • ${Ve(i.createdAt)}</div>
      ${nE(i.submittedData,i.submittedFields)}
      ...
      ${i.status!=="pending"&&i.reviewedAt?`<p class="ai-meta muted-sm">reviewed ${Ve(i.reviewedAt)}${i.approvedBy?" by "+D(i.approvedBy):""}${i.rejectedBy?" by "+D(i.rejectedBy):""}</p>`:""}
      ${i.status==="pending"?`
    ...
    </div>`).join(""),t.querySelectorAll("[data-approve]").forEach(i=>i.addEventListener("click",async()=>{i.disabled=!0;try{await Dv(i.dataset.approve),U("Proof approve — reward balance-এ যোগ হয়েছে"),li(n)}catch(s){U(s.message,"error"),i.disabled=!1}})),t.querySelectorAll("[data-reveal]").forEach(i=>i.addEventListener("click",()=>{const s=i.previousElementSibling;if(!s)return;const a=i.dataset.on==="1";s.textContent=a?"•".repeat(Math.min(String(i.dataset.raw).length,14)):i.dataset.raw,i.innerHTML=a?'<i class="fa-solid fa-eye"></i> দেখুন':'<i class="fa-solid fa-eye-slash"></i> লুকান',i.dataset.on=a?"":"1"})),t.querySelectorAll("[data-copyall]").forEach(i=>i.addEventListener("click",async()=>{const s=i.dataset.all||"";try{await navigator.clipboard.writeText(s),U("সব field data copy হয়েছে")}catch{prompt("Copy করুন:",s)}})),t.querySelectorAll("[data-reject]").forEach(i=>i.addEventListener("click",async()=>{const s=prompt("Reject reason (user দেখবে):")||"";try{await Nv(i.dataset.reject,s),U("Proof reject করা হয়েছে"),li(n)}catch(a){U(a.message,"error")}}))}let Yr="pending";async function ui(n){n.innerHTML=`
    ...
    <div class="adm-item">
      ...
      <div class="ai-meta muted-sm">${Ve(i.createdAt)}${i.status!=="pending"&&i.reviewedAt?" • reviewed "+Ve(i.reviewedAt):""}</div>
    ...
    </div>`).join(""),t.querySelectorAll("[data-dapprove]").forEach(i=>i.addEventListener("click",async()=>{if(confirm("Approve করলে account ACTIVE হবে + activation bonus যোগ হবে। নিশ্চিত?")){i.disabled=!0;try{await Vv(i.dataset.dapprove),U("Deposit approve — account active + bonus"),ui(n)}catch(s){U(s.message,"error"),i.disabled=!1}}})),t.querySelectorAll("[data-dreject]").forEach(i=>i.addEventListener("click",async()=>{const s=prompt("Reject reason (user দেখবে):")||"";try{await Lv(i.dataset.dreject,s),U("Deposit reject করা হয়েছে"),ui(n)}catch(a){U(a.message,"error")}}))}let Xr="pending";async function eo(n){n.innerHTML=`
    ...
    <div class="adm-item">
      ...
      <div class="ai-meta muted-sm">${Ve(s.createdAt)}${s.processedAt?" • processed "+Ve(s.processedAt):""}</div>
    ...
    </div>`).join("");const i=async(s,a)=>{if(!(a==="paid"&&!confirm("এটা Paid মার্ক করবেন? (টাকা send করে ফেলেছেন মানে)"))&&!(a==="rejected"&&!confirm("Reject করলে amount user-এর balance-এ ফেরত যাবে। নিশ্চিত?"))){s.disabled=!0;try{const c=e.find(u=>u.id===s.dataset[a==="paid"?"wpaid":"wrej"]);await Zs(c.userId,c.id,a),U(a==="paid"?"Withdrawal paid মার্ক হয়েছে":"Withdrawal reject — টাকা ফেরত হয়েছে"),eo(n)}catch(c){U(c.message,"error"),s.disabled=!1}}};t.querySelectorAll("[data-wpaid]").forEach(s=>s.addEventListener("click",()=>i(s,"paid"))),t.querySelectorAll("[data-wrej]").forEach(s=>s.addEventListener("click",()=>i(s,"rejected")))}let Cs="",Oe=null;async function rE(n){n.innerHTML=`
    <input type="search" id="userSearch" class="adm-input" placeholder="নাম বা মোবাইল দিয়ে খুঁজুন..." value="${D(Cs)}">
    <div id="userList" class="user-list"></div>
    <div id="userDetail"></div>`;const e=async()=>{const r=await na(300),i=Cs.trim().toLowerCase(),s=i?r.filter(c=>(c.name||"").toLowerCase().includes(i)||String(c.mobile||"").includes(i)):r,a=document.getElementById("userList");a.innerHTML=s.slice(0,100).map(c=>`
      ...
      <div class="adm-card detail-card">
        ...
        <div class="detail-grid">
          ...
          <div><span class="muted">Joined</span><b>${Ve(i.createdAt)}</b></div>
        </div>
        <div class="ai-actions">
        ...
        ${a.length?a.map(f=>`<div class="mini-row">
          ...
          <span class="muted">${D(f.accountNumber)} • ${Ve(f.createdAt)}</span>
        ...
        ${s.length?s.map(f=>`<div class="mini-row"><b>${D(f.note||f.type)}</b><span class="muted">${Ve(f.createdAt)}</span><span class="badge ${Number(f.amount)>=0?"green":"gray"}">${Number(f.amount)>=0?"+":""}${Ce(f.amount)}</span></div>`).join(""):'<p class="muted">কোনো transaction নেই।</p>'}
      </div>`;const u=r.querySelector("[data-act]");u&&u.addEventListener("click",async()=>{try{await wl(u.dataset.act,!0),U("User active করা হয়েছে"),e()}catch(f){U(f.message,"error")}});const d=r.querySelector("[data-deact]");d&&d.addEventListener("click",async()=>{if(confirm("User-কে inactive করবেন?"))try{await wl(d.dataset.deact,!1),U("User inactive করা হয়েছে"),e()}catch(f){U(f.message,"error")}}),r.querySelectorAll("[data-wd-paid]").forEach(f=>f.addEventListener("click",async()=>{if(confirm("Paid মার্ক করবেন?")){f.disabled=!0;try{await Zs(Oe,f.dataset.wdPaid,"paid"),U("Paid মার্ক হয়েছে"),t()}catch(y){U(y.message,"error"),f.disabled=!1}}})),r.querySelectorAll("[data-wd-rej]").forEach(f=>f.addEventListener("click",async()=>{if(confirm("Reject করলে টাকা user-এর balance-এ ফেরত যাবে। নিশ্চিত?")){f.disabled=!0;try{await Zs(Oe,f.dataset.wdRej,"rejected"),U("Reject — টাকা ফেরত"),t()}catch(y){U(y.message,"error"),f.disabled=!1}}})),r.querySelectorAll("[data-tn-tgl]").forEach(f=>f.addEventListener("click",async()=>{const y=c.find(E=>E.id===f.dataset.tnTgl);try{await qh(Oe,y.id,{enabled:!y.enabled}),U("Notice toggle"),t()}catch(E){U(E.message,"error")}})),r.querySelectorAll("[data-tn-del]").forEach(f=>f.addEventListener("click",async()=>{if(confirm("Notice মুছে ফেলবেন?"))try{await Hh(Oe,f.dataset.tnDel),U("Notice delete"),t()}catch(y){U(y.message,"error")}}))};document.getElementById("userSearch").addEventListener("input",r=>{Cs=r.target.value,e()}),await e()}const iE=["text","email","password","tel","number","url","textarea"];function Gh(n={}){return`<div class="if-row" data-if-row>
    <input class="adm-input if-label" placeholder="Field Title (যেমন: UID, Password, Cookies)" value="${D(n.label||"")}" maxlength="50">
    <select class="adm-input if-type">${iE.map(e=>`<option value="${e}" ${n.type===e?"selected":""}>${e}</option>`).join("")}</select>
    ...
    <div class="if-editor">
      ...
      <div class="if-rows" data-ifrows>${(Array.isArray(n.inputFields)?n.inputFields:[]).map(Gh).join("")||'<p class="muted if-empty">কোনো field নেই — task শুধু "link + submit" flow-এ থাকবে।</p>'}</div>
    </div>`}async function to(n){var r;const e=await xv(),t=`
    <div class="adm-card" style="display:flex;gap:10px;align-items:center;justify-content:space-between;flex-wrap:wrap">
      ...
      <button class="adm-btn sm" id="seedTasksBtn"><i class="fa-solid fa-database"></i> ${e.length?"বাকিগুলো তৈরি করুন":"এখনই তৈরি করুন"}</button>
    </div>`;n.innerHTML=`
    ...
    ${t}
    <div id="taskList">${e.map(i=>`
      <div class="adm-card task-card" data-slug="${D(i.slug)}">
        <div class="task-row">
          <div class="task-info">
            <b>${D(i.nameBn||i.slug)} ${i.enabled===!1?'<span class="badge gray">OFF</span>':""} ${i.locked?'<span class="badge gold">LOCKED</span>':""}</b>
            <span class="muted">/task/${D(i.slug)}.html • ${Ce(i.reward)}${Array.isArray(i.inputFields)&&i.inputFields.length?` • ${i.inputFields.length} field(s)`:""}</span>
          </div>
          <button class="adm-btn ghost sm" data-edit="${D(i.slug)}"><i class="fa-solid fa-pen"></i></button>
        </div>
        <div class="task-form" data-form="${D(i.slug)}" hidden>
          <label>নাম (বাংলা)</label><input class="adm-input" data-f="nameBn" value="${D(i.nameBn||"")}">
          <label>Task URL (user-এর জন্য Open Link) — শুধু http/https</label><input class="adm-input" data-f="url" value="${D(i.url||"")}" placeholder="https://...">
          <div class="two-col">
            <div><label>Amount / Reward (৳)</label><input type="number" step="0.5" class="adm-input" data-f="reward" value="${Number(i.reward)||0}"></div>
            <div><label>Sort order</label><input type="number" class="adm-input" data-f="sort" value="${Number(i.sort)||10}"></div>
          </div>
          <label>Account Password (seller যে পাসওয়ার্ড সেট করবে — খালি রাখলে hide)</label><input class="adm-input" data-f="password" value="${D(i.password||"")}" maxlength="60">
          <label>Description / Instructions (project page-এ description)</label><textarea class="adm-input" data-f="description" rows="3" maxlength="300">${D(i.description||"")}</textarea>
          <div class="two-col">
            <div><label>Submit বাটনের লেখা</label><input class="adm-input" data-f="submitLabel" value="${D(i.submitLabel||"")}" placeholder="SUBMIT GMAIL" maxlength="40"></div>
            <div><label>History বাটনের লেখা</label><input class="adm-input" data-f="historyLabel" value="${D(i.historyLabel||"")}" placeholder="View Gmail History" maxlength="40"></div>
          </div>
          <label>দৈনিক সর্বোচ্চ কয়টি account জমা দেওয়া যাবে (per seller)</label><input type="number" min="1" max="200" class="adm-input" data-f="dailyLimit" value="${Number(i.dailyLimit)||20}">
          ${sE(i)}
          <label>Video URL (YouTube link বা mp4) — task page-এ guide video</label><input class="adm-input" data-f="videoUrl" value="${D(i.videoUrl||"")}">
          <div class="two-col">
            <label class="chk"><input type="checkbox" data-f="enabled" ${i.enabled!==!1?"checked":""}> Task ON / Active</label>
            <label class="chk"><input type="checkbox" data-f="locked" ${i.locked?"checked":""}> Locked</label>
          </div>
          <div class="ai-actions">
            <button class="adm-btn gold sm" data-save="${D(i.slug)}"><i class="fa-solid fa-floppy-disk"></i> Save</button>
          </div>
        </div>
      </div>`).join("")}</div>`,n.querySelectorAll("[data-ifadd]").forEach(i=>i.addEventListener("click",()=>{var c;const s=i.closest(".if-editor").querySelector("[data-ifrows]");(c=s.querySelector(".if-empty"))==null||c.remove();const a=document.createElement("div");a.innerHTML=Gh(),s.appendChild(a.firstElementChild)})),n.querySelectorAll("[data-ifdel]").forEach(i=>i.addEventListener("click",()=>{i.closest("[data-if-row]").remove();const s=i.closest("[data-ifrows]");s.querySelector("[data-if-row]")||(s.innerHTML='<p class="muted if-empty">কোনো field নেই — task শুধু "link + submit" flow-এ থাকবে।</p>')})),n.querySelectorAll("[data-edit]").forEach(i=>i.addEventListener("click",()=>{const a=i.closest(".task-card").querySelector("[data-form]");a.hidden=!a.hidden})),(r=n.querySelector("#seedTasksBtn"))==null||r.addEventListener("click",async i=>{const s=i.currentTarget;s.disabled=!0;try{const a=await Fv();U(`তৈরি হয়েছে ${a.createdCount||0}টা, আগে থেকেই ছিল ${a.skippedCount||0}টা${a.invalid&&a.invalid.length?" · কিছু হয়নি: "+a.invalid.join(", "):""}`),to(n)}catch(a){U(a.message,"error"),s.disabled=!1}}),n.querySelectorAll("[data-save]").forEach(i=>i.addEventListener("click",async()=>{const s=i.closest(".task-card"),a=d=>s.querySelector(`[data-form] [data-f="${d}"]`),c=a("url").value.trim();if(c&&!/^https?:\/\//i.test(c)){U("Task URL শুধু http/https হতে পারে (javascript:/data: allowed না)","error");return}const u=[...s.querySelectorAll("[data-ifrows] [data-if-row]")].map(d=>{var f;return{label:d.querySelector(".if-label").value.trim(),type:d.querySelector(".if-type").value,placeholder:((f=d.querySelector(".if-ph"))==null?void 0:f.value.trim())||"",required:d.querySelector("[data-ifreq]").checked}}).filter(d=>d.label);i.disabled=!0;try{await Uv(i.dataset.save,{nameBn:a("nameBn").value.trim(),url:c,reward:Number(a("reward").value)||0,sort:Number(a("sort").value)||10,password:a("password").value.trim(),description:a("description").value.trim(),submitLabel:a("submitLabel").value.trim(),historyLabel:a("historyLabel").value.trim(),dailyLimit:Math.max(1,Math.min(200,Number(a("dailyLimit").value)||20)),inputFields:u,videoUrl:a("videoUrl").value.trim(),enabled:a("enabled").checked,locked:a("locked").checked}),U("Task save হয়েছে — user website-তে update হয়ে গেছে"),to(n)}catch(d){U(d.message,"error"),i.disabled=!1}}))}const oE=[{group:"General",fields:[["siteName","Site Name","text"],["telegramLink","Telegram Link","url"],["facebookLink","Facebook Link","url"],["youtubeLink","YouTube Link","url"],["videoUrl","Tutorial Video URL","url"]]},{group:"Money (৳)",fields:[["activationFee","Activation Deposit Fee","number"],["activationBonus","Activation Bonus","number"],["registerBonus","Registration Bonus","number"],["referralBonus","Referral Bonus","number"],["minWithdraw","Minimum Withdraw","number"],["giftReward","Daily Gift Reward","number"]]},{group:"Payment Numbers (Deposit-এর জন্য)",fields:[["bkashNumber","bKash Number","text"],["nagadNumber","Nagad Number","text"],["rocketNumber","Rocket Number","text"]]},{group:"Gift",fields:[["giftCode","Gift Code","text"]]},{group:"Admin Contact (Support page-এ দেখাবে)",fields:[["admin1Name","Admin 1 — Name","text"],["admin1Phone","Admin 1 — Phone","text"],["admin1Email","Admin 1 — Email","email"],["admin1Link","Admin 1 — Link","url"],["admin2Name","Admin 2 — Name","text"],["admin2Phone","Admin 2 — Phone","text"],["admin2Email","Admin 2 — Email","email"],["admin2Link","Admin 2 — Link","url"]]}];async function Kh(n){var r;const e=await $v(),t=e._secretLoaded!==!0;n.innerHTML=`
    ...
    </form>`,(r=document.getElementById("clearGiftBtn"))==null||r.addEventListener("click",async()=>{if(confirm("Gift code মুছে ফেলবেন? তাহলে কেউই আর gift claim করতে পারবে না।"))try{await qv(),U("Gift code cleared"),Kh(n)}catch(i){U(i.message,"error")}}),document.getElementById("settingsForm").addEventListener("submit",async i=>{i.preventDefault();const s={};n.querySelectorAll("[data-sf]").forEach(c=>{if(c.disabled)return;const u=c.dataset.sf;s[u]=c.type==="number"?Number(c.value)||0:c.value.trim()});const a=i.target.querySelector("button[type=submit]");a.disabled=!0;try{await jv(s),U("Settings save হয়েছে")}catch(c){U(c.message,"error"),a.disabled=!1}})}let Yt="";async function tn(n){const[e,t]=await Promise.all([Hv(),Jv().catch(()=>[])]),r=await na(300).catch(()=>[]);n.innerHTML=`
    <div class="adm-card">
    ...
    ${e.map(d=>`
      <div class="adm-card">
        <div class="task-row">
          <div class="task-info"><b>${d.type==="warning"?"⚠️ ":""}${D(d.title||"—")}</b><span class="muted">${d.enabled?"ON":"OFF"} • sort ${d.sort||0}${d.expiresAt?" • expire "+Ve(d.expiresAt):""}</span></div>
    ...
    ${t.length?"":'<p class="muted center-note">কোনো private warning নেই।</p>'}`;const i=document.getElementById("ntTarget"),s=document.getElementById("ntUserWrap"),a=document.getElementById("ntUserSearch"),c=document.getElementById("ntUserResults");i.addEventListener("change",()=>{s.hidden=i.value!=="user"});const u=(d="")=>{const f=d.trim().toLowerCase(),y=f?r.filter(E=>(E.name||"").toLowerCase().includes(f)||String(E.mobile||"").includes(f)):r;c.innerHTML=y.slice(0,30).map(E=>`
      ...
      </div>`).join("")||'<p class="muted">কোনো user পাওয়া যায়নি</p>',c.querySelectorAll("[data-ntu]").forEach(E=>E.addEventListener("click",()=>{Yt=E.dataset.ntu,u(a.value)}))};a.addEventListener("input",()=>u(a.value)),document.getElementById("ntAdd").addEventListener("click",async()=>{const d=document.getElementById("ntTitle").value.trim(),f=document.getElementById("ntBody").value.trim(),y=document.getElementById("ntType").value,E=i.value,R=document.getElementById("ntExpiry").value;if(!d&&!f){U("Title বা message লিখুন","error");return}if(E==="user"&&!Yt){U("একটা user select করুন","error");return}const k=R?new Date(R+"T23:59:59"):null;try{E==="user"?await Qv(Yt,{title:d,body:f,type:y,expiresAt:k}):await Wv({title:d,body:f,type:y,expiresAt:k}),U(E==="user"?"Private warning পাঠানো হয়েছে (শুধু সেই user দেখবে)":"Notice add হয়েছে (সব user দেখবে)"),Yt="",tn(n)}catch(O){U(O.message,"error")}}),n.querySelectorAll("[data-tgl]").forEach(d=>d.addEventListener("click",async()=>{const f=e.find(y=>y.id===d.dataset.tgl);try{await zv(f.id,{title:f.title,body:f.body,enabled:!f.enabled,sort:f.sort}),U("Notice toggle"),tn(n)}catch(y){U(y.message,"error")}})),n.querySelectorAll("[data-del]").forEach(d=>d.addEventListener("click",async()=>{if(confirm("Notice মুছে ফেলবেন?"))try{await Gv(d.dataset.del),U("Notice delete হয়েছে"),tn(n)}catch(f){U(f.message,"error")}})),n.querySelectorAll("[data-tn-tgl]").forEach(d=>d.addEventListener("click",async()=>{const[f,y]=d.dataset.tnTgl.split("::"),E=t.find(R=>R.uid===f&&R.id===y);try{await qh(f,y,{enabled:!E.enabled}),U("Warning toggle"),tn(n)}catch(R){U(R.message,"error")}})),n.querySelectorAll("[data-tn-del]").forEach(d=>d.addEventListener("click",async()=>{if(!confirm("Warning মুছে ফেলবেন?"))return;const[f,y]=d.dataset.tnDel.split("::");try{await Hh(f,y),U("Warning delete হয়েছে"),tn(n)}catch(E){U(E.message,"error")}}))}
