/* Resolves firebase-admin + _lib/firebase-admin.js to local in-memory fakes. */
...
export async function resolve(specifier, context, next) {
  ...
  if (res.url.endsWith('/api/_lib/firebase-admin.js') || res.url.endsWith('/admin/api/_lib/firebase-admin.js')) {
